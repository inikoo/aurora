...
trait OrderItems {
    ...
    function update_item($data) {
        ...
        if ($result = $this->db->query($sql)) {
			...
			`Product Key`,`Product ID`,`Product Code`,
...
VALUES (%s,%s,%f,%s,%f,%s,%s,%s,%s,%s,
	...
	%.2f,%.2f,%.2f,%s,%f,%s,%.4f,'{}')   ",
                        ...
                        prepare_mysql(gmdate('Y-m-d H:i:s')), $product->historic_id, $product->data['Product ID'], prepare_mysql($product->data['Product Code']),
