...
function update_branch_type_elements() {
    ...
    var request = 'tipo=get_branch_type_elements&subject=' + Dom.get('category_subject').value+'&store_key='+Dom.get('store_key').value;
...
function update_category_history_elements() {
    ...
    var request = 'tipo=get_category_history_elements&subject=Customer&parent=store&parent_key=' + Dom.get('store_key').value;
    YAHOO.util.Connect.asyncRequest('POST', ar_file, {
        success: function(o) {
...
request="ar_edit_categories.php?tipo=edit_customer_category_list&parent=store&parent_key="+Dom.get('store_key').value;
//alert(request)
...
this.table0.table_id=tableid;
	    ...
	    this.table0.filter={key:'<?php echo$_SESSION['state']['customer_categories']['edit_categories']['f_field']?>',value:'<?php echo$_SESSION['state']['customer_categories']['edit_categories']['f_value']?>'};
 ...
 var tableid=1; // Change if you have more the 1 table
		...
		request="ar_history.php?tipo=customer_categories&parent=store&parent_key="+Dom.get('store_id').value+"&tableid=1";
