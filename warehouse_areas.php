...
if($modify)
  $general_options_list[]=array('tipo'=>'url','url'=>'edit_warehouse_areas.php','label'=>_('Edit Areas'));
...
$smarty->assign('filter_value0',$_SESSION['state']['warehouse_areas']['table']['f_value']);
$filter_menu=array(
...
$smarty->display('warehouse_areas.tpl');
?>
