...
function reset_caption(o) {
    ...
    if (o.parentNode.parentNode.getAttribute('is_principal') == 'Yes') Dom.get('img_principal' + image_key).style.display = '';
    else Dom.get('img_set_principal' + image_key).style.display = '';
}
...
function save_caption(o) {
    ...
    image_key = o.parentNode.parentNode.getAttribute('image_id');
    if (Dom.get('img_save_caption' + image_key).src == 'art/icons/bullet_gray_disk.png') return;
