...
function change_view(_request, metadata) {
    ...
    */
    ...
    ajaxData.append("tipo", 'views')
    ajaxData.append("request",request )
    ajaxData.append("metadata", JSON.stringify(metadata))
    ajaxData.append("old_state", JSON.stringify(state))
    ...
    $.ajax({
        url: "/ar_views.php", type: 'POST', data: ajaxData, dataType: 'json', cache: false, contentType: false, processData: false, complete: function () {
