...
YAHOO.util.Event.addListener(window, "load", function() {
    ...
    tables = new function() {
        ...
        request = "ar_marketing.php?tipo=email_campaigns&parent=store&parent_key=" + Dom.get('store_key').value
        ...
        this.table0 = new YAHOO.widget.DataTable(tableDivEL, OrdersColumnDefs, this.dataSource0, {
            ...
            paginator: new YAHOO.widget.Paginator({
                rowsPerPage: state.marketing.email_campaigns.nr,
            ...
            ,
            sortedBy: {
                key: state.marketing.email_campaigns.order,
                dir: state.marketing.email_campaigns.order_dir
            },
            dynamicData: true
        ...
        this.table0.filter = {
            key: state.marketing.email_campaigns.f_field,
            value: state.marketing.email_campaigns.f_value
        };
        ...
        this.dataSource10.responseSchema = {
            ...
            fields: ["name", "key", "description", "duration", "orders", "code", "customers", "state", "from", "to"]
        };


        this.table10 = new YAHOO.widget.DataTable(tableDivEL, ColumnDefs, this.dataSource10, {
            renderLoopSize: 50,
            generateRequest: myRequestBuilder
            //,initialLoad:false
            ,
            paginator: new YAHOO.widget.Paginator({
                rowsPerPage: state.marketing.offers.nr,
            ...
            ,
            sortedBy: {
                key: state.marketing.offers.order,
                dir: state.marketing.offers.order_dir
            },
            dynamicData: true
        ...
        this.table10.filter = {
            key: state.marketing.offers.f_field,
            value: state.marketing.offers.f_value
        };
        ...
        //	,{key:"duration", label:labels.Duration,  width:220,sortable:true,className:"aright",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_ASC}}
        ,
        {
            key: "from",
            label: labels.From,
        ...
        //?tipo=products&tid=0"
        request = 'ar_deals.php?tipo=campaigns&parent=marketing&parent_key=' + Dom.get('store_key').value + '&tableid=' + tableid + '&referrer=marketing'
        //alert(request)
        ...
        this.dataSource11.responseSchema = {
            ...
            fields: ["name", "key", "code", "duration", "orders", "customers", "deals", "from", "to"]
        };
        ...
        this.table11 = new YAHOO.widget.DataTable(tableDivEL, productsColumnDefs, this.dataSource11, {
            ...
            ,
            paginator: new YAHOO.widget.Paginator({
                rowsPerPage: state.marketing.campaigns.nr,
            ...
            ,
            sortedBy: {
                key: state.marketing.campaigns.order,
                dir: state.marketing.campaigns.order_dir
            },
            dynamicData: true
        ...
        this.table11.filter = {
            key: state.marketing.campaigns.f_field,
            value: state.marketing.campaigns.f_value
        };
...
function init() {
    ...
    Event.addListener('clean_table_filter_show11', "click", show_filter, 11);
    Event.addListener('clean_table_filter_hide11', "click", hide_filter, 11);
  ...
  var oACDS11 = new YAHOO.util.FunctionDataSource(mygetTerms);
    ...
    Event.addListener(ids, "click", change_elements_campaign, {
        table_id: 11
    });
