    ...
    YAHOO.products.XHR_JSON = new function() {
		 ...
		 this.alarm=  function(el, oRecord, oColumn, oData) {
			 ...
			 if(oRecord.getData("s_sprice")==1)
			     el.innerHTML ='<img src="art/icons/error.png" alt="<?php echo_('Attention')?>"> '+oData;
			 else if (oRecord.getData("s_sprice")==0)
			     el.innerHTML ='<img src="art/icons/exclamation.png" alt="<?php echo_('Error')?>"> '+oData;
			 else
			     el.innerHTML =oData;
	    ...
	    var DepartmentsColumnDefs = [
					 ...
					 ,{key:"code", label:"<?php echo_('Code')?>", width:80,sortable:false,className:"aleft"}
					 ,{key:"name", label:"<?php echo_('Name')?>", sortable:false,className:"aleft"}
					 ];
	    ...
	    var FamiliesColumnDefs = [
				      {key:"status", label:"&nbsp;", width:16,formatter:this.flag,sortable:false,className:"aleft"}
				      ,{key:"department", label:"<?php echo_('Department')?>", width:80,sortable:false,className:"aleft"}
				      ,{key:"code", label:"<?php echo_('Code')?>", width:80,sortable:false,className:"aleft"}
				      ,{key:"description", label:"<?php echo_('Description')?>", sortable:false,className:"aleft"}
				      ];
	    ...
	    var ProductsColumnDefs = [
				      ...
				      ,{key:"family", label:"<?php echo_('Family')?>", sortable:false,className:"aleft"}
				      ,{key:"code", label:"<?php echo_('Code')?>", sortable:false,className:"aleft"}
				      ,{key:"description", label:"<?php echo_('Description')?>", sortable:false,className:"aleft"}
				      ,{key:"units", label:"<?php echo_('U/outer')?>", sortable:false,className:"aright"}
				      ,{key:"units_carton", label:"<?php echo_('U/c')?>", sortable:false,className:"aright"}
				      ,{key:"type_units", label:"<?php echo_('Unit Type')?>", sortable:false,className:"aleft"}
				      ,{key:"price", label:"<?php echo_('Price/o')?>", sortable:false,className:"aright"}
				      ,{key:"rrp", label:"<?php echo_('RRP')?>", sortable:false,className:"aright"}
				      ,{key:"export_code", label:"<?php echo_('Exp Code')?>", sortable:false,className:"aleft"}
	    ...
	    var ProductsdimColumnDefs = [
				      ...
				      ,{key:"code", label:"<?php echo_('Code')?>",width:60,  sortable:false,className:"aleft"}
				      ,{key:"w1", label:"<?php echo_('Wu')?>", sortable:false,className:"aright"}
				      ,{key:"d1", label:"<?php echo_('Du')?>", sortable:false,className:"aright"}
				      ,{key:"w2", label:"<?php echo_('Wo')?>", sortable:false,className:"aright"}
				      ,{key:"d2", label:"<?php echo_('Do')?>", sortable:false,className:"aright"}
				      ,{key:"w3", label:"<?php echo_('Wc')?>", sortable:false,className:"aright"}
				      ,{key:"d3", label:"<?php echo_('Dc')?>", sortable:false,className:"aright"}
	    ...
	    var ProductsupColumnDefs = [
					{key:"status", label:"&nbsp;", width:16,formatter:this.flag,sortable:false,className:"aleft"}
					,{key:"number", label:"&nbsp;",width:24, sortable:false,className:"aleft"}
					,{key:"code", label:"<?php echo_('Code')?>", width:60, formatter:this.alarm, width:76,sortable:false,className:"aleft"}
					,{key:"supplier", label:"<?php echo_('Supplier')?>",formatter:this.alarm, sortable:false,className:"aleft"}
					,{key:"scode", label:"<?php echo_('Supplier Code')?>", formatter:this.alarm,sortable:false,className:"aleft"}
					,{key:"sprice", label:"<?php echo_('Buying Price')?>", formatter:this.alarm,sortable:false,className:"aright"}
					];
...
function init(){
	...
	YAHOO.products.dialog2  = new YAHOO.widget.Dialog("upload_department_form",
							     { width : "30em",
							       ...
							       postmethod:"form",
							       buttons : [ { text:"<?php echo_('Upload')?>", handler:handleSubmit, isDefault:true },
