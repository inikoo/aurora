...
dialog_edit_items_charges = new YAHOO.widget.Dialog("dialog_edit_items_charges", {context:["edit_button_items_charges","tr","tl"]  ,visible : false,close:true,underlay: "none",draggable:false});
...
dialog_sending_to_warehouse = new YAHOO.widget.Dialog("dialog_sending_to_warehouse", {context:["done","tr","tr"]  ,visible : false,close:true,underlay: "none",draggable:false});
