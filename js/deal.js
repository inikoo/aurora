...
YAHOO.util.Event.addListener(window, "load", function() {
	...
	tables = new function() {
		...
		this.dataSource0.responseSchema = {
			...
			this.table0.filter={key:state.deal.orders.f_field,value:state.deal.orders.f_value};
			...
			{key:"name", label:labels.Customer,width:270, sortable:true,className:"aleft",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_ASC}},
	...
	this.dataSource1.responseSchema = {
		...
		this.table1.filter={key:state.deal.customers.f_field,value:state.deal.customers.f_value};
	    ...
	    ,{key:"name", label:labels.Name, width:150,sortable:true,className:"aleft",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_ASC}}
	    ,{key:"terms", label:labels.Terms, width:150,sortable:true,className:"aright",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_ASC}}

	    ,{key:"allowance", label:labels.Allowance, width:150,sortable:true,className:"aright",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_ASC}}

	    ,{key:"orders", label:labels.Orders,  width:90,sortable:true,className:"aright",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_ASC}}
	    ,{key:"customers", label:labels.Customers,  width:90,sortable:true,className:"aright",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_ASC}}
	    ,{key:"duration", label:labels.Interval,  width:150,sortable:true,className:"aleft",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_ASC}}
	    ];
...
this.dataSource2.responseSchema = {
	...
	this.table2.filter={key:state.deal.components.f_field,value:state.deal.components.f_value};
