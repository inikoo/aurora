...
var info_period_title='x';
var current_store_period;

function change_block() {
	ids = ['details', 'customers', 'orders', 'timeline', 'sales', 'web', 'history','pictures','availability','deals'];
	block_ids = ['block_details', 'block_customers', 'block_orders', 'block_timeline', 'block_sales', 'block_web', 'block_history','block_pictures','block_availability','block_deals'];
...
function change_info_period(period){
	...
	current_store_period=state.family.products.period;
...
YAHOO.util.Event.addListener(window, "load", function() {
	...
	tables = new function() {
		...
		{key:"dispatched", label:labels.Dispatched,width:80,sortable:true,className:"aright",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_DESC}},
		{key:"undispatched", label:labels.No_Send, width:80, sortable:true,className:"aright",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_DESC}},
		];
		...
		this.table0 = new YAHOO.widget.DataTable(tableDivEL, ColumnDefs,
			this.dataSource0, {
				...
				paginator : new YAHOO.widget.Paginator({
					rowsPerPage:state.product.orders.nr,
				...
				sortedBy : {
					key: state.product.orders.order,
					dir: state.product.orders.order_dir
				},
				dynamicData : true
		...
		this.table0.filter={key:state.product.orders.f_field,value:state.product.orders.f_value};
		...
		ColumnDefs = [
		{key:"customer", label:labels.Customer,width:320, sortable:true,className:"aleft",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_ASC}},
		...
		{key:"dispatched", label:labels.Disp,width:65, sortable:true,className:"aright",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_DESC}},
		{key:"to_dispatch", label:labels.To_Disp,width:65, sortable:true,className:"aright",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_DESC}},
		{key:"nodispatched", label:labels.No_Disp, width:65, sortable:true,className:"aright",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_DESC}},
		{key:"charged", label:labels.Charged, width:80, sortable:true,className:"aright",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_DESC}}
		];
		...
		this.table1 = new YAHOO.widget.DataTable(tableDivEL, ColumnDefs,
			this.dataSource1, {
				renderLoopSize: 50,generateRequest : myRequestBuilder,
				paginator : new YAHOO.widget.Paginator({
					rowsPerPage: state.product.customers.nr,
				...
				sortedBy : {
					key: state.product.customers.order,
					dir: state.product.customers.order_dir
				},
				dynamicData : true
		...
		this.table1.filter={key:state.product.customers.f_field,value:state.product.customers.f_value};
		...
		{key:"time", label:labels.Time,className:"aleft",width:90},
		...
		{key:"note", formatter:this.prepare_note,label:labels.Notes,className:"aleft",width:480},
		...
		this.table2 = new YAHOO.widget.DataTable(tableDivEL, ColumnDefs,
			this.dataSource2,{
				...
				paginator : new YAHOO.widget.Paginator({
					rowsPerPage: state.product.history.nr,
				...
				sortedBy : {
					key: state.product.history.order,
					dir: state.product.history.order_dir
				},
				dynamicData : true
		...
		this.table2.filter={key:state.product.history.f_field,value:state.product.history.f_value};
		...
		ColumnDefs = [
		{key:"pid", label:labels.Product_IDKey,width:100, sortable:true,className:"aleft",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_ASC}},
		{key:"from", label:labels.From,width:90, sortable:true,className:"aright",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_DESC}},
		{key:"to", label:labels.To,width:90, sortable:true,className:"aright",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_DESC}},
		{key:"description", label:labels.Description,width:330, sortable:true,className:"aleft",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_DESC}},
		{key:"parts", label:labels.Parts,width:75, sortable:true,className:"aleft",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_DESC}},
		{key:"sales", label:labels.Sales,width:75, sortable:true,className:"aright",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_DESC}}
		...
		this.table3 = new YAHOO.widget.DataTable(tableDivEL, ColumnDefs,
			this.dataSource3, {
				renderLoopSize: 50,generateRequest : myRequestBuilder,
				paginator : new YAHOO.widget.Paginator({
					rowsPerPage:state.product.code_timeline.nr,
				...
				sortedBy : {
					key: state.product.code_timeline.order,
					dir: state.product.code_timeline.order_dir
				},
				dynamicData : true
		...
		this.table4 = new YAHOO.widget.DataTable(tableDivEL, ColumnDefs,
			this.dataSource4, {
				...
				renderLoopSize: 50,generateRequest : myRequestBuilder,
				paginator : new YAHOO.widget.Paginator({
					rowsPerPage:state.product.sales_history.nr,
				...
				sortedBy : {
					key: state.product.sales_history.order,
					dir: state.product.sales_history.order_dir
				},
				dynamicData : true
		...
		this.table4.filter={key:state.product.sales_history.f_field,value:state.product.sales_history.f_value};
		...
		this.table5 = new YAHOO.widget.DataTable(tableDivEL, ColumnDefs,
			this.dataSource5, {
				...
				renderLoopSize: 50,generateRequest : myRequestBuilder,
				paginator : new YAHOO.widget.Paginator({
					rowsPerPage:state.product.pages.nr,
					containers : 'paginator4',
					pageReportTemplate : '('+labels.Page+' {currentPage} '+labels.of+' {totalPages})',
					previousPageLinkLabel : "<",
					nextPageLinkLabel : ">",
				...
				sortedBy : {
					key: state.product.pages.order,
					dir: state.product.pages.order_dir
				},
				dynamicData : true
		...
		this.table5.filter={key:state.product.pages.f_field,value:state.product.pages.f_value};
		...
		{key:"date", label:labels.Date,width:200,sortable:true,className:"aright",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_DESC}},
		{key:"duration", label:labels.Duration,width:120,sortable:true,className:"aright",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_ASC}},
		{key:"user", label:labels.User,width:120,sortable:true,className:"aleft",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_ASC}},
		{key:"availability", label:labels.Availability,width:120,sortable:true,className:"aright",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_ASC}},
		{key:"web_state", label:labels.Web_State,width:120,sortable:true,className:"aright",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_ASC}}
		...
		this.table6 = new YAHOO.widget.DataTable(tableDivEL, ColumnDefs,
			this.dataSource6, {
				renderLoopSize: 50,
				generateRequest : myRequestBuilder_page_thumbnails,
				paginator : new YAHOO.widget.Paginator({
					rowsPerPage:state.product.availability.nr,
				...
				sortedBy : {
					key: state.product.availability.order,
					dir: state.product.availability.order_dir
				},
				dynamicData : true
		...
		this.table6.filter={key:state.product.availability.f_field,value:state.product.availability.f_value};
		...
		this.table10 = new YAHOO.widget.DataTable(tableDivEL, productsColumnDefs,
			this.dataSource10,{
				renderLoopSize: 50,generateRequest : myRequestBuilder,
				paginator : new YAHOO.widget.Paginator({
					rowsPerPage:state.product.offers.nr,
				...
				sortedBy : {
					key: state.product.offers.order,
					dir: state.product.offers.order_dir
				},
				dynamicData : true
		...
		this.table10.filter={key:state.product.offers.f_field,value:state.product.offers.f_value};
...
function new_deal () {
  location.href = "new_deal.php?parent=product&parent_key="+Dom.get('product_pid').value;
}
