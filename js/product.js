...
function next_info_period() {
    ...
    if (current_store_period == 'all') change_info_period('week');
    else if (current_store_period == 'week') change_info_period('month');
    else if (current_store_period == 'month') change_info_period('quarter');
    else if (current_store_period == 'quarter') change_info_period('year');
    else if (current_store_period == 'year') change_info_period('all');
}

function previous_info_period() {
    if (current_store_period == 'all') change_info_period('year');
    else if (current_store_period == 'week') change_info_period('all');
    else if (current_store_period == 'month') change_info_period('week');
    else if (current_store_period == 'quarter') change_info_period('month');
    else if (current_store_period == 'year') change_info_period('quarter');
}
...
YAHOO.util.Event.addListener(window, "load", function() {
    ...
    tables = new function() {
        ...
        this.table0.filter = {
            key: state.product.orders.f_field,
            value: state.product.orders.f_value
        };
       ...
       // alert(request)
        ...
        this.table1.filter = {
            key: state.product.customers.f_field,
            value: state.product.customers.f_value
        };
        ...
        this.table2.filter = {
            key: state.product.history.f_field,
            value: state.product.history.f_value
        };
        ...
        this.table2.subscribe("cellClickEvent", onNotesCellClick);
        ...
        this.dataSource3.responseSchema = {
            ...
            fields: ["pid", "description", "parts", "from", "to", "sales"]
        };
        ...
        this.table4.filter = {
            key: state.product.sales_history.f_field,
            value: state.product.sales_history.f_value
        };
        ...
        this.table5.filter = {
            key: state.product.pages.f_field,
            value: state.product.pages.f_value
        };
        ...
        this.dataSource6.responseSchema = {
            ...
            fields: ['code', 'description', 'web_state', 'date', 'availability', 'user', 'duration'
        ...
        this.table6.filter = {
            key: state.product.availability.f_field,
        ...
        this.table10.filter = {
            key: state.product.offers.f_field,
            value: state.product.offers.f_value
        };
