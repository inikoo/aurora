...
!function (a) {
    ...
    b.DEFAULTS = {initOnClick: !1, pluginsEnabled: null}, b.MODULES = {}, b.PLUGINS = {}, b.VERSION = "2.7.6", b.INSTANCES = [], b.OPTS_MAPPING = {}, b.SHARED = {}, b.ID = 0, b.prototype._init = function () {
    ...
    a.FE.LinkRegExCommon = "[" + c + "]{1,}", a.FE.LinkRegExEnd = "((:[0-9]{1,5})|)(((\\/|\\?|#)[a-z\\u00a1-\\uffff0-9@?\\|!^=%&amp;/~+#-\\'*-_{}]*)|())", a.FE.LinkRegExTLD = "((" + a.FE.LinkRegExCommon + ")(\\.(com|net|org|edu|mil|gov|co|biz|info|me|dev)))", a.FE.LinkRegExHTTP = "((ftp|http|https):\\/\\/" + a.FE.LinkRegExCommon + ")", a.FE.LinkRegExAuth = "((ftp|http|https):\\/\\/[\\u0021-\\uffff]{1,}@" + a.FE.LinkRegExCommon + ")", a.FE.LinkRegExWWW = "(www\\." + a.FE.LinkRegExCommon + "\\.[a-z0-9-]{2,24})", a.FE.LinkRegEx = "(" + a.FE.LinkRegExTLD + "|" + a.FE.LinkRegExHTTP + "|" + a.FE.LinkRegExWWW + "|" + a.FE.LinkRegExAuth + ")" + a.FE.LinkRegExEnd, a.FE.LinkProtocols = ["mailto", "tel", "sms", "notes", "data"], a.FE.MAIL_REGEX = /.+@.+\..+/i, a.FE.MODULES.helpers = function (b) {
        ...
        function p(b) {
            ...
            return /^(https?:|ftps?:|)\/\//i.test(b) ? b : c.test(b) ? b : new RegExp("^(" + a.FE.LinkProtocols.join("|") + "):\\/\\/", "i").test(b) ? b : b = encodeURIComponent(b).replace(/%23/g, "#").replace(/%2F/g, "/").replace(/%25/g, "%").replace(/mailto%3A/gi, "mailto:").replace(/file%3A/gi, "file:").replace(/sms%3A/gi, "sms:").replace(/tel%3A/gi, "tel:").replace(/notes%3A/gi, "notes:").replace(/data%3Aimage/gi, "data:image").replace(/blob%3A/gi, "blob:").replace(/webkit-fake-url%3A/gi, "webkit-fake-url:").replace(/%3F/g, "?").replace(/%3D/g, "=").replace(/%26/g, "&").replace(/&amp;/g, "&").replace(/%2C/g, ",").replace(/%3B/g, ";").replace(/%2B/g, "+").replace(/%40/g, "@").replace(/%5B/g, "[").replace(/%5D/g, "]").replace(/%7B/g, "{").replace(/%7D/g, "}")
        }
        ...
        function i(c) {
            ...
            if (b.helpers.isIOS() && b.$win.get(0).focus(), b.core.hasFocus()) return !1;
            if (!b.core.hasFocus() && c) {
                var e = b.$win.scrollTop();
                if (b.browser.msie && b.$box && b.$box.css("position", "fixed"), b.browser.msie && b.$wp && b.$wp.css("overflow", "visible"), o(), b.$el.focus(), b.events.trigger("focus"), n(), b.browser.msie && b.$box && b.$box.css("position", ""), b.browser.msie && b.$wp && b.$wp.css("overflow", "auto"), e != b.$win.scrollTop() && b.$win.scrollTop(e), d = b.selection.info(b.el), !d.atStart) return !1
            }
        ...
        function n() {
            for (var c = b.$el.find(".fr-marker"), d = 0; d < c.length; d++) if (a(c[d]).parentsUntil('.fr-element, [contenteditable="true"]', '[contenteditable="false"]').length) return !1;
            return !0
        }
        ...
        function q() {
            if (o()) return !1;
            var c, d = b.el.querySelectorAll("td, th, img, br");
            for (c = 0; c < d.length; c++) d[c].nextSibling && (d[c].innerHTML = '<span class="fr-mk">' + a.FE.INVISIBLE_SPACE + "</span>" + d[c].innerHTML);
            var e = !1, f = p(b.el);
            for (f.atStart && f.atEnd && (e = !0), d = b.el.querySelectorAll(".fr-mk"), c = 0; c < d.length; c++) d[c].parentNode.removeChild(d[c]);
            return e
        }
        ...
        function j(a, c) {
            var e, f = document.implementation.createHTMLDocument("Froala DOC"), g = f.createElement("DIV");
            g.innerHTML = a;
            var h = "";
            if (g) {
                var i = b.node.contents(g);
                for (e = 0; e < i.length; e++) c(i[e]);
                for (i = b.node.contents(g), e = 0; e < i.length; e++) h += d(i[e])
            }
            return h
        }
        ...
        function r(c, d, e, f) {
            "undefined" == typeof d && (d = []), "undefined" == typeof e && (e = []), "undefined" == typeof f && (f = !1);
        ...
        function i(a, d) {
            ...
            if (d && (e = "div"), e) {
                for (var f = b.doc.createDocumentFragment(), g = null, h = !1, i = a.firstChild, j = !1; i;) {
                    var k = i.nextSibling;
                    if (i.nodeType == Node.ELEMENT_NODE && (b.node.isBlock(i) || b.opts.htmlDoNotWrapTags.indexOf(i.tagName.toLowerCase()) >= 0 && !b.node.hasClass(i, "fr-marker"))) g = null, f.appendChild(i.cloneNode(!0)); else if (i.nodeType != Node.ELEMENT_NODE && i.nodeType != Node.TEXT_NODE) g = null, f.appendChild(i.cloneNode(!0)); else if ("BR" == i.tagName) null == g ? (g = b.doc.createElement(e), j = !0, d && g.setAttribute("class", "fr-temp-div"), g.setAttribute("data-empty", !0), g.appendChild(i.cloneNode(!0)), f.appendChild(g)) : h === !1 && (g.appendChild(b.doc.createElement("br")), d && g.setAttribute("class", "fr-temp-div"), g.setAttribute("data-empty", !0)), g = null; else {
                        var l = i.textContent;
        ...
        function j(a, b) {
            for (var c = a.length - 1; c >= 0; c--) i(a[c], b)
        }
        ...
        function l() {
            b.$el.find("div.fr-temp-div").each(function () {
                this.previousSibling && this.previousSibling.nodeType === Node.TEXT_NODE && a(this).before("<br>"), a(this).attr("data-empty") || !this.nextSibling || b.node.isBlock(this.nextSibling) && !a(this.nextSibling).hasClass("fr-temp-div") ? a(this).replaceWith(a(this).html()) : a(this).replaceWith(a(this).html() + "<br>")
        ...
        function s(c) {
            ...
            } else !d || b.node.isBlock(d) || b.node.isElement(d) || c.previousSibling || c.nextSibling || !b.node.isDeletable(c.parentNode) || s(c.parentNode)
        }
        ...
        function u() {
            b.opts.htmlUntouched || (h(), k(), o(), b.spaces.normalize(null, !0), b.html.fillEmptyBlocks(), b.clean.lists(), b.clean.tables(), b.clean.toHTML5(), b.html.cleanBRs()), b.selection.restore(), v(), b.placeholder.refresh()
        }

        function v() {
            b.node.isEmpty(b.el) && (null != c() ? b.el.querySelector(g()) || b.el.querySelector(b.opts.htmlDoNotWrapTags.join(":not(.fr-marker),") + ":not(.fr-marker)") || (b.core.hasFocus() ? (b.$el.html("<" + c() + ">" + a.FE.MARKERS + "<br/></" + c() + ">"), b.selection.restore()) : b.$el.html("<" + c() + "><br/></" + c() + ">")) : b.el.querySelector("*:not(.fr-marker):not(br)") || (b.core.hasFocus() ? (b.$el.html(a.FE.MARKERS + "<br/>"), b.selection.restore()) : b.$el.html("<br/>")))
        }
        ...
        function A(c) {
            ...
            b.edit.on(), b.core.injectStyle(b.opts.iframeDefaultStyle + b.opts.iframeStyle), u(), b.opts.useClasses || (b.$el.find("[fr-original-class]").each(function () {
        ...
        function B(a) {
            var b = /(#[^\s\+>~\.\[:]+)/g, c = /(\[[^\]]+\])/g, d = /(\.[^\s\+>~\.\[:]+)/g, e = /(::[^\s\+>~\.\[:]+|:first-line|:first-letter|:before|:after)/gi, f = /(:[\w-]+\([^\)]*\))/gi, g = /(:[^\s\+>~\.\[:]+)/g,
                h = /([^\s\+>~\.\[:]+)/g;
            !function () {
                var b = /:not\(([^\)]*)\)/g;
        ...
        function E(a, c) {
            ...
            var e, f, g = [], h = {}, i = [], j = b.el.querySelectorAll("input, textarea");
            for (e = 0; e < j.length; e++) j[e].setAttribute("value", j[e].value);
            if (!b.opts.useClasses && !c) {
                var k = new RegExp("^" + b.opts.htmlIgnoreCSSProperties.join("$|^") + "$", "gi");
                for (e = 0; e < b.doc.styleSheets.length; e++) {
                    var l, m = 0;
                    try {
                        l = b.doc.styleSheets[e].cssRules, b.doc.styleSheets[e].ownerNode && "STYLE" == b.doc.styleSheets[e].ownerNode.nodeType && (m = 1)
                    } catch (n) {
                    }
                    if (l) for (var o = 0, p = l.length; o < p; o++) if (l[o].selectorText && l[o].style.cssText.length > 0) {
                        var q, s = l[o].selectorText.replace(/body |\.fr-view /g, "").replace(/::/g, ":");
                        try {
                            q = b.el.querySelectorAll(s)
                        } catch (n) {
                            q = []
                        }
                        for (f = 0; f < q.length; f++) {
                            !q[f].getAttribute("fr-original-style") && q[f].getAttribute("style") ? (q[f].setAttribute("fr-original-style", q[f].getAttribute("style")), g.push(q[f])) : q[f].getAttribute("fr-original-style") || (q[f].setAttribute("fr-original-style", ""), g.push(q[f])), h[q[f]] || (h[q[f]] = {});
                            for (var t = 1e3 * m + B(l[o].selectorText), u = l[o].style.cssText.split(";"), v = 0; v < u.length; v++) {
                                var w = u[v].trim().split(":")[0];
                                if (w && !w.match(k) && (h[q[f]][w] || (h[q[f]][w] = 0, (q[f].getAttribute("fr-original-style") || "").indexOf(w + ":") >= 0 && (h[q[f]][w] = 1e4)), t >= h[q[f]][w] && (h[q[f]][w] = t, u[v].trim().length))) {
                                    var x = u[v].trim().split(":");
                                    x.splice(0, 1), i.push([q[f], w.trim(), x.join(":").trim(), t])
                                }
                            }
                        }
                    }
                ...
                for (e = 0; e < g.length; e++) if (g[e].getAttribute("class") && (g[e].setAttribute("fr-original-class", g[e].getAttribute("class")), g[e].removeAttribute("class")), (g[e].getAttribute("fr-original-style") || "").trim().length > 0) {
                    var z = g[e].getAttribute("fr-original-style").split(";");
                    for (f = 0; f < z.length; f++) if (z[f].indexOf(":") > 0) {
                        var A = z[f].split(":"), E = A[0];
                        A.splice(0, 1), g[e].style[E.trim()] = A.join(":").trim()
                    }
                }
            }
            if (b.node.isEmpty(b.el)) b.opts.fullPage && (d = r(b.iframe_document), d += "<html" + b.node.attributes(b.$html.get(0)) + ">" + b.$html.find("head").get(0).outerHTML + "<body></body></html>"); else if ("undefined" == typeof a && (a = !1), b.opts.fullPage) {
                d = r(b.iframe_document), b.$el.removeClass("fr-view");
                var F = b.opts.heightMin;
                b.opts.heightMin = null, b.size.refresh(), d += "<html" + b.node.attributes(b.$html.get(0)) + ">" + b.$html.html() + "</html>", b.opts.heightMin = F, b.size.refresh(), b.$el.addClass("fr-view")
            } else d = b.$el.html();
            if (!b.opts.useClasses && !c) for (e = 0; e < g.length; e++) g[e].getAttribute("fr-original-class") && (g[e].setAttribute("class", g[e].getAttribute("fr-original-class")), g[e].removeAttribute("fr-original-class")), null != g[e].getAttribute("fr-original-style") && "undefined" != typeof g[e].getAttribute("fr-original-style") ? (0 !== g[e].getAttribute("fr-original-style").length ? g[e].setAttribute("style", g[e].getAttribute("fr-original-style")) : g[e].removeAttribute("style"), g[e].removeAttribute("fr-original-style")) : g[e].removeAttribute("style");
            ...
            var G = b.events.chainTrigger("html.get", d);
            return "string" == typeof G && (d = G), d = d.replace(/<pre(?:[\w\W]*?)>(?:[\w\W]*?)<\/pre>/g, function (a) {
        ...
        function F() {
            var c = function (c, d) {
                for (; d && (d.nodeType == Node.TEXT_NODE || !b.node.isBlock(d)) && !b.node.isElement(d) && !b.node.hasClass(d, "fr-inner");) d && d.nodeType != Node.TEXT_NODE && a(c).wrapInner(b.node.openTagString(d) + b.node.closeTagString(d)), d = d.parentNode;
        ...
        function K(c, d, e) {
            b.selection.isCollapsed() || b.selection.remove();
            var f;
            if (f = d ? c : b.clean.html(c), c.indexOf('class="fr-marker"') < 0 && (f = H(f)), b.node.isEmpty(b.el) && !b.opts.keepFormatOnDelete && G(f)) b.el.innerHTML = f; else {
        ...
        function c() {
            b.$placeholder || g();
            var c = b.opts.iframe ? b.$iframe.prev().outerHeight(!0) : b.$el.prev().outerHeight(!0), d = 0, e = 0, f = 0, h = 0, i = 0, j = 0, k = b.node.contents(b.el), l = a(b.selection.element()).css("text-align");
            ...
            b.$wp.addClass("show-placeholder"), b.$placeholder.css({
                marginTop: Math.max(b.helpers.getPX(b.$el.css("margin-top")), d) + (c ? c : 0),
        ...
        function c() {
            a.$wp ? (a.$el.attr("contenteditable", !0), a.$el.removeClass("fr-disabled").attr("aria-disabled", !1), a.$tb && a.$tb.removeClass("fr-disabled").removeAttr("aria-disabled"), b()) : a.$el.is("a") && a.$el.attr("contenteditable", !0), g = !1
        }
        ...
        function e() {
            if (b.$box.addClass("fr-box" + (b.opts.editorClass ? " " + b.opts.editorClass : "")), b.$box.attr("role", "application"), b.$wp.addClass("fr-wrapper"), d(), b.opts.iframe) {
        ...
        function i(a) {
            "TEXTAREA" == b.$oel.get(0).tagName && b.$oel.val(a), b.$box.removeAttr("role"), b.$wp && ("TEXTAREA" == b.$oel.get(0).tagName ? (b.$el.html(""), b.$wp.html(""), b.$box.replaceWith(b.$oel), b.$oel.show()) : (b.$wp.replaceWith(a), b.$el.html(""), b.$box.removeClass("fr-view fr-ltr fr-box " + (b.opts.editorClass || "")), b.opts.theme && b.$box.addClass(b.opts.theme + "-theme"))), this.$wp = null, this.$el = null, this.el = null, this.$box = null
        }
        ...
        function h(a, b) {
            var c = new RegExp((b ? "^" : "") + "([\\uD83C-\\uDBFF\\uDC00-\\uDFFF\\u200D]+)" + (b ? "" : "$"), "i"), d = a.match(c);
        ...
        function i(c) {
            ...
            if (null !== e) {
                ...
                if (b.node.isBlock(e) && b.node.isEditable(e) && i && a.FE.NO_DELETE_TAGS.indexOf(i.tagName) < 0) if (b.node.isDeletable(i)) a(i).remove(), a(c).replaceWith(a.FE.MARKERS); else if (b.node.isEditable(i)) if (b.node.isBlock(i)) if (b.node.isEmpty(i) && !b.node.isList(i)) a(i).remove(), a(c).after(b.opts.keepFormatOnDelete ? a.FE.INVISIBLE_SPACE : ""); else {
                    if (b.node.isList(i) && (i = a(i).find("li:last").get(0)), h = b.node.contents(i), h.length && "BR" == h[h.length - 1].tagName && a(h[h.length - 1]).remove(), "BLOCKQUOTE" == i.tagName && "BLOCKQUOTE" != e.tagName) for (h = b.node.contents(i); h.length && b.node.isBlock(h[h.length - 1]);) i = h[h.length - 1], h = b.node.contents(i); else if ("BLOCKQUOTE" != i.tagName && "BLOCKQUOTE" == e.tagName) for (h = b.node.contents(e); h.length && b.node.isBlock(h[0]);) e = h[0], h = b.node.contents(e);
                    if (b.node.isEmpty(e)) a(c).remove(), b.selection.setAtEnd(i, !0); else {
        ...
        function j(c) {
            ...
            if (!b.node.isBlock(d) && b.node.isEditable(d)) {
                ...
                if (d.nodeType == Node.TEXT_NODE) {
                    ...
                    if (f.length && "\n" === f[f.length - 1]) return d.textContent = f.substring(0, g - 2), 0 === d.textContent.length && d.parentNode.removeChild(d), j(c);
                    if (b.opts.tabSpaces && f.length >= b.opts.tabSpaces) {
                        var i = f.substr(f.length - b.opts.tabSpaces, f.length - 1);
                        0 === i.replace(/ /g, "").replace(new RegExp(a.FE.UNICODE_NBSP, "g"), "").length && (g = f.length - b.opts.tabSpaces + 1)
                    }
                    d.textContent = f.substring(0, g - h(f));
                    var k = f.length != d.textContent.length;
                    0 === d.textContent.length ? k && b.opts.keepFormatOnDelete ? a(d).after(a.FE.INVISIBLE_SPACE + a.FE.MARKERS) : (2 != d.parentNode.childNodes.length || d.parentNode != c.parentNode) && 1 != d.parentNode.childNodes.length || b.node.isBlock(d.parentNode) || b.node.isElement(d.parentNode) || !b.node.isDeletable(d.parentNode) ? (a(d).after(a.FE.MARKERS), b.node.isElement(d.parentNode) && !c.nextSibling && d.previousSibling && "BR" == d.previousSibling.tagName && a(c).after("<br>"), d.parentNode.removeChild(d)) : (a(d.parentNode).after(a.FE.MARKERS), a(d.parentNode).remove()) : a(d).after(a.FE.MARKERS)
                ...
                for (var l = c; !l.previousSibling;) l = l.parentNode;
                for (; l && "BR" !== l.tagName && !b.node.isBlock(l);) {
                    var m = l;
                    l = l.nextSibling, a(d).append(m)
                }
                l && "BR" == l.tagName && a(l).remove(), a(c).remove()
        ...
        function f(a) {
            if (b.selection.isCollapsed()) if (b.cursor.backspace(), b.helpers.isIOS()) {
                var c = b.selection.ranges(0);
                c.deleteContents(), c.insertNode(document.createTextNode("\u200b"));
                var d = b.selection.get();
                d.modify("move", "rtl" === b.opts.direction ? "left" : "right", "character")
            } else a.preventDefault(), a.stopPropagation(); else a.preventDefault(), a.stopPropagation(), b.selection.remove(), b.html.fillEmptyBlocks();
        ...
        function p(i) {
            var j = b.selection.element();
            if (j && ["INPUT", "TEXTAREA"].indexOf(j.tagName) >= 0) return !0;
            b.events.disableBlur(), I = null;
            var l = i.which;
            if (16 === l) return !0;
            if (E = l, l === a.FE.KEYCODE.IME) return H = !0, !0;
            H = !1;
            var m = v(l) && !t(i) && !i.altKey, n = l == a.FE.KEYCODE.BACKSPACE || l == a.FE.KEYCODE.DELETE;
            return (b.selection.isFull() && !b.opts.keepFormatOnDelete && !b.placeholder.isVisible() || n && b.placeholder.isVisible() && b.opts.keepFormatOnDelete) && (m || n) && (o(), !v(l)) ? (i.preventDefault(), !0) : (l == a.FE.KEYCODE.ENTER ? i.shiftKey ? d(i) : c(i) : l === a.FE.KEYCODE.BACKSPACE && (i.metaKey || i.ctrlKey) ? e() : l != a.FE.KEYCODE.BACKSPACE || t(i) || i.altKey ? l != a.FE.KEYCODE.DELETE || t(i) || i.altKey || i.shiftKey ? l == a.FE.KEYCODE.SPACE ? h(i) : l == a.FE.KEYCODE.TAB ? k(i) : t(i) || !v(i.which) || b.selection.isCollapsed() || i.ctrlKey || b.selection.remove() : b.placeholder.isVisible() ? (b.opts.keepFormatOnDelete || o(), i.preventDefault(), i.stopPropagation()) : g(i) : b.placeholder.isVisible() ? (b.opts.keepFormatOnDelete || o(), i.preventDefault(), i.stopPropagation()) : f(i), void b.events.enableBlur())
        }
        ...
        function w(c) {
            var d = c.which;
            return !!(t(c) || d >= 37 && d <= 40 || !v(d) && d != a.FE.KEYCODE.DELETE && d != a.FE.KEYCODE.BACKSPACE && d != a.FE.KEYCODE.ENTER && d != a.FE.KEYCODE.IME) || (F || (G = b.snapshot.get(), b.undo.canDo() || b.undo.saveStep()), clearTimeout(F), void(F = setTimeout(function () {
        ...
        function x(a) {
            var c = a.which;
            return !!(t(a) || c >= 37 && c <= 40) || void(G && F ? (b.undo.saveStep(G), G = null) : "undefined" != typeof c && 0 !== c || G || F || b.undo.saveStep())
        }
        ...
        function A(a) {
            ...
            try {
                return 0 === (a.textContent || "").length && a.querySelector && !a.querySelector(":scope > br") || a.childNodes && 1 == a.childNodes.length && a.childNodes[0].getAttribute && "false" == a.childNodes[0].getAttribute("contenteditable")
            } catch (b) {
                return !1
            }
        }
        ...
        function B(c) {
            ...
            return !(!c.target || c.target === b.el) || (0 === d.length || void(b.$el.outerHeight() - c.offsetY <= 10 ? A(d[d.length - 1]) && (e ? b.$el.append("<" + e + ">" + a.FE.MARKERS + "<br></" + e + ">") : b.$el.append(a.FE.MARKERS + "<br>"), b.selection.restore(), r()) : c.offsetY <= 10 && A(d[0]) && (e ? b.$el.prepend("<" + e + ">" + a.FE.MARKERS + "<br></" + e + ">") : b.$el.prepend(a.FE.MARKERS + "<br>"), b.selection.restore(), r())))
        }
        ...
        function D() {
            b.events.on("keydown", w), b.events.on("input", i), b.events.on("mousedown", m), b.events.on("keyup input", x), b.events.on("keypress", l), b.events.on("keydown", p), b.events.on("keyup", s), b.events.on("destroy", C), b.events.on("html.inserted", s), b.events.on("cut", j), b.events.on("click", B)
        }

        var E, F, G, H = !1, I = null;
        return {_init: D, ctrlKey: t, isCharacter: v, isArrow: u, forceUndo: y, isIME: n, isBrowserAction: z, positionCaret: r}
        ...
        function c(a) {
            if (a && a.length && !b.$el.find('[contenteditable="true"]').is(":focus")) {
                a.data("blur-event-set") || a.parents(".fr-popup").length || (b.events.$on(a, "blur", function () {
                    ...
                    c.events.blurActive() && c.events.trigger("blur"), setTimeout(function () {
                        c.events.enableBlur()
                    }, 100)
        ...
        function t() {
            b.shared.$f_el && (b.events.disableBlur(), b.shared.$f_el.blur(), b.shared.$f_el = null), b.events.trigger("toolbar.focusEditor") !== !1 && (b.events.disableBlur(), b.$el.focus(), b.events.focus())
        }
        ...
        function v(c, d) {
            ...
            return f != a.FE.KEYCODE.TAB || e || c.shiftKey || c.altKey ? f != a.FE.KEYCODE.ARROW_RIGHT || e || c.shiftKey || c.altKey ? f != a.FE.KEYCODE.TAB || e || !c.shiftKey || c.altKey ? f != a.FE.KEYCODE.ARROW_LEFT || e || c.shiftKey || c.altKey ? f != a.FE.KEYCODE.ARROW_UP || e || c.shiftKey || c.altKey ? f != a.FE.KEYCODE.ARROW_DOWN || e || c.shiftKey || c.altKey ? f != a.FE.KEYCODE.ENTER && f != a.FE.KEYCODE.SPACE || e || c.shiftKey || c.altKey ? f != a.FE.KEYCODE.ESC || e || c.shiftKey || c.altKey ? f != a.FE.KEYCODE.F10 || e || c.shiftKey || !c.altKey || (g = k()) : g = u(d) : g = s() : g = q() : g = r() : g = o(d) : g = o(d, !0) : g = n(d) : g = n(d, !0), b.shared.$f_el || void 0 !== g || (g = !0), !g && b.keys.isBrowserAction(c) && (g = !0), !!g || (c.preventDefault(), c.stopPropagation(), !1)
        }
        ...
        function g(d, e, f) {
            if (d) {
                ...
                if (i) (a(i).find(".fr-marker").length || "UL" == i.tagName || "OL" == i.tagName) && g(i.firstChild, e, f); else {
                    ...
                    if (k) {
                        var l = k.nextSibling;
                        l && (b.node.isBlock(l) ? "HR" === l.tagName ? g(l.nextSibling, e, f) : g(l.firstChild, e, f) : g(l, e, f))
                    }
                }
                h.is(":empty") && h.remove()
            }
        ...
        function j(c, d, g, h) {
            for (var i = b.node.contents(c.get(0)), k = 0; k < i.length; k++) {
                ...
                if (b.node.hasClass(l, "fr-marker")) d = (d + 1) % 2; else if (d) if (a(l).find(".fr-marker").length > 0) d = j(a(l), d, g, h); else {
                    ...
                    "undefined" == typeof g && l.nodeType == Node.ELEMENT_NODE && !b.node.isVoid(l) && !b.node.isBlock(l) && "A" !== l.tagName || f(l, e(g, h)) ? a(l).replaceWith(l.innerHTML) : "undefined" == typeof g && l.nodeType == Node.ELEMENT_NODE && b.node.isBlock(l) && "TABLE" != l.tagName && b.node.clearAttributes(l)
        ...
        function d(a) {
            if (!a) return a;
            for (var b = "", d = c("charCodeAt"), g = c("fromCharCode"), h = n.indexOf(a[0]), i = 1; i < a.length - 2; i++) {
                for (var j = e(++h), k = a[d](i), l = ""; /[0-9-]/.test(a[i + 1]);) l += a[++i];
        ...
        var l, m, n = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789", o = function () {
        ...
        function f(c) {
            if (c.originalEvent && (c = c.originalEvent), c && c.dataTransfer && c.dataTransfer.getData) {
                ...
                if (u = "", /text\/rtf/.test(d) && (v = c.dataTransfer.getData("text/rtf")), /text\/html/.test(d) ? u = c.dataTransfer.getData("text/html") : /text\/rtf/.test(d) && b.browser.safari ? u = v : /text\/plain/.test(d) && !this.browser.mozilla && (u = b.html.escapeEntities(c.dataTransfer.getData("text/plain")).replace(/\n/g, "<br>")), "" !== u) {
                    b.keys.forceUndo(), x = b.snapshot.get(), b.selection.remove();
        ...
        function g() {
            b.selection.save(), b.events.disableBlur(), u = null, w ? (w.html(""), b.browser.edge && b.opts.iframe && b.$el.append(w)) : (w = a('<div contenteditable="true" style="position: fixed; top: 0; left: -9999px; height: 100%; width: 0; word-break: break-all; overflow:hidden; z-index: 2147483647; line-height: 140%; -moz-user-select: text; -webkit-user-select: text; -ms-user-select: text; user-select: text;" tabIndex="-1"></div>'), b.browser.safari ? (w.css("top", b.$sc.scrollTop()), b.$el.after(w)) : b.browser.edge && b.opts.iframe ? b.$el.append(w) : b.$box.after(w), b.events.on("destroy", function () {
                w.remove()
            })), w.focus(), b.win.setTimeout(j, 1)
        }
        ...
        function j() {
            ...
            var a = u.match(/(class=\"?Mso|class=\'?Mso|class="?Xl|class='?Xl|class=Xl|style=\"[^\"]*\bmso\-|style=\'[^\']*\bmso\-|w:WordDocument)/gi), c = b.events.chainTrigger("paste.beforeCleanup", u);
        ...
        function l(c, d, e) {
            var f, g = null, j = null;
            if (c.toLowerCase().indexOf("<body") >= 0) {
                var l = "";
                c.indexOf("<style") >= 0 && (l = c.replace(/[.\s\S\w\W<>]*(<style[^>]*>[\s]*[.\s\S\w\W<>]*[\s]*<\/style>)[.\s\S\w\W<>]*/gi, "$1")), c = l + c.replace(/[.\s\S\w\W<>]*<body[^>]*>[\s]*([.\s\S\w\W<>]*)[\s]*<\/body>[.\s\S\w\W<>]*/gi, "$1"), c = c.replace(/ \n/g, " ").replace(/\n /g, " ").replace(/([^>])\n([^<])/g, "$1 $2")
            }
            var n = !1;
            c.indexOf('id="docs-internal-guid') >= 0 && (c = c.replace(/^[\w\W\s\S]* id="docs-internal-guid[^>]*>([\w\W\s\S]*)<\/b>[\w\W\s\S]*$/g, "$1"), n = !0);
            var o = !1;
            if (!d && (o = k(c), o && (c = b.win.localStorage.getItem("fr-copied-html")), !o)) {
                var r = b.opts.htmlAllowedStyleProps;
                if (b.opts.htmlAllowedStyleProps = b.opts.pasteAllowedStyleProps, b.opts.htmlAllowComments = !1, b.opts.tabSpaces) {
                    for (var s = "", t = 0; t++ < b.opts.tabSpaces;) s += "&nbsp;";
                    c = c.replace(/\t/g, s)
                } else c = c.replace(/\t/g, "");
                c = b.clean.html(c, b.opts.pasteDeniedTags, b.opts.pasteDeniedAttrs), b.opts.htmlAllowedStyleProps = r, b.opts.htmlAllowComments = !0, c = p(c), c = c.replace(/\r/g, ""), c = c.replace(/^ */g, "").replace(/ *$/g, "")
            }
            !d || b.wordPaste && e || (c = c.replace(/^\n*/g, "").replace(/^ /g, ""), 0 === c.indexOf("<colgroup>") && (c = "<table>" + c + "</table>"), c = h(c), c = p(c)), b.opts.pastePlain && !o && (c = i(c));
            var u = b.events.chainTrigger("paste.afterCleanup", c);
            if ("string" == typeof u && (c = u), "" !== c) {
                var v = b.o_doc.createElement("div");
                v.innerHTML = c, b.spaces.normalize(v);
                var w = v.getElementsByTagName("span");
                for (f = w.length - 1; f >= 0; f--) {
                    var y = w[f];
                    0 === y.attributes.length && (y.outerHTML = y.innerHTML)
                }
                var z = b.selection.element(), A = !1;
                if (z && a(z).parentsUntil(b.el, "ul, ol").length && (A = !0), A) {
                    var B = v.children;
                    1 == B.length && ["OL", "UL"].indexOf(B[0].tagName) >= 0 && (B[0].outerHTML = B[0].innerHTML)
                }
                if (!n) {
                    var C = v.getElementsByTagName("br");
                    for (f = C.length - 1; f >= 0; f--) {
                        var D = C[f];
                        b.node.isBlock(D.previousSibling) && D.parentNode.removeChild(D)
                    }
                }
                if (b.opts.enter == a.FE.ENTER_BR) for (g = v.querySelectorAll("p, div"), f = g.length - 1; f >= 0; f--) j = g[f], 0 === j.attributes.length && (j.outerHTML = j.innerHTML + (j.nextSibling && !b.node.isEmpty(j) ? "<br>" : "")); else if (b.opts.enter == a.FE.ENTER_DIV) for (g = v.getElementsByTagName("p"), f = g.length - 1; f >= 0; f--) j = g[f], 0 === j.attributes.length && (j.outerHTML = "<div>" + j.innerHTML + "</div>"); else b.opts.enter == a.FE.ENTER_P && 1 == v.childNodes.length && "P" == v.childNodes[0].tagName && 0 === v.childNodes[0].attributes.length && (v.childNodes[0].outerHTML = v.childNodes[0].innerHTML);
                c = v.innerHTML, o && (c = q(c)), b.html.insert(c, !0)
            }
        ...
        function o(a) {
            for (var b = a.length - 1; b >= 0; b--) a[b].attributes && a[b].attributes.length && a.splice(b, 1);
            return a
        }
        ...
        function p(a) {
            ...
            for (var e = o(Array.prototype.slice.call(d.querySelectorAll(":scope > div:not([style]), td > div:not([style]), th > div:not([style]), li > div:not([style])"))); e.length;) {
                var f = e[e.length - 1];
                if (b.html.defaultTag() && "div" != b.html.defaultTag()) f.querySelector(b.html.blockTagsQuery()) ? f.outerHTML = f.innerHTML : f.outerHTML = "<" + b.html.defaultTag() + ">" + f.innerHTML + "</" + b.html.defaultTag() + ">"; else {
                    var g = f.querySelectorAll("*");
                    !g.length || "BR" !== g[g.length - 1].tagName && 0 === f.innerText.length ? f.outerHTML = f.innerHTML + "<br>" : f.outerHTML = f.innerHTML
                }
            ...
            for (e = o(Array.prototype.slice.call(d.querySelectorAll("div:not([style])"))); e.length;) {
                for (c = 0; c < e.length; c++) {
                    var h = e[c], i = h.innerHTML.replace(/\u0009/gi, "").trim();
                    h.outerHTML = i
                }
        ...
        function q(c) {
            ...
            e.innerHTML = c;
            for (var f = e.querySelectorAll("*:empty:not(td):not(th):not(tr):not(iframe):not(svg):not(" + a.FE.VOID_ELEMENTS.join("):not(") + "):not(" + b.opts.htmlAllowedEmptyTags.join("):not(") + ")"); f.length;) {
                for (d = 0; d < f.length; d++) f[d].parentNode.removeChild(f[d]);
                f = e.querySelectorAll("*:empty:not(td):not(th):not(tr):not(iframe):not(svg):not(" + a.FE.VOID_ELEMENTS.join("):not(") + "):not(" + b.opts.htmlAllowedEmptyTags.join("):not(") + ")")
            }
            return e.innerHTML
        }
        ...
        function r() {
            ...
            }, !0), b.events.on("beforepaste", e)), b.events.on("destroy", s)
        }
        ...
        function d(c) {
            ...
            if (e && a.FE.SHORTCUTS_MAP[f]) {
                ...
                if (h && b.opts.shortcutsEnabled.indexOf(h) >= 0) {
                    ...
                    if (h && (b.commands[h] || a.FE.COMMANDS[h] && a.FE.COMMANDS[h].callback)) return c.preventDefault(), c.stopPropagation(), "keydown" == c.type && ((b.commands[h] || a.FE.COMMANDS[h].callback)(), g = !0), !1
                }
            }
        }
        ...
        a.FE.ICONS[b] = c
    }, a.extend(a.FE.DEFAULTS, {iconsTemplate: a.FE.ICON_DEFAULT_TEMPLATE || "font_awesome"}), a.FE.MODULES.icon = function (b) {
        function c(c) {
            var d = null, e = a.FE.ICONS[c];
            if ("undefined" != typeof e) {
                var f = e.template || b.opts.iconsTemplate;
                e.FA5NAME || (e.FA5NAME = e.NAME), f && (f = a.FE.ICON_TEMPLATES[f]) && (d = f.replace(/\[([a-zA-Z0-9]*)\]/g, function (a, b) {
                    return "NAME" == b ? e[b] || c : e[b]
                }))
            }
            return d || c
        }
        ...
        function d(c) {
            var d = a.FE.ICONS[c], e = b.opts.iconsTemplate;
            return "undefined" != typeof d ? e = d.template || b.opts.iconsTemplate : e
        }
        ...
        function e(c, e, f) {
            if (b.shared.$overlay || (b.shared.$overlay = a('<div class="fr-overlay">').appendTo("body:first")), m = b.shared.$overlay, b.opts.theme && m.addClass(b.opts.theme + "-theme"), !n[c]) {
                ...
                }, b.helpers.isMobile() || g.addClass("fr-desktop"), g.appendTo("body:first"), b.events.$on(g, "click", ".fr-modal-close", function () {
                    h(c)
        ...
        function i(c) {
            if (n[c]) {
                var d = n[c], e = d.$modal, f = d.$body, g = a(b.o_win).height(), h = e.find(".fr-modal-wrapper"), i = h.outerHeight(!0), j = h.height() - (f.outerHeight(!0) - f.height()), k = g - i + j,
        ...
        function c() {
            ...
            if (0 === c.top && 0 === c.left && 0 === c.width || 0 === c.height) {
                ...
                e.css("display", "none"), e.css("line-height", 0), c = {}, c.left = f.left, c.width = 0, c.height = g, c.top = f.top - (b.helpers.isMobile() && !b.helpers.isIOS() || b.opts.iframe ? 0 : b.helpers.scrollTop()), c.right = 1, c.bottom = 1, c.ok = !0, d && b.selection.restore()
            }
            return c
        }
        ...
        function d(a, c, d) {
            ...
            if (!b.helpers.isMobile() && b.$tb && a.parent().get(0) != b.$tb.get(0)) {
                ...
                f + c + e > b.$sc.offset().top + h && a.parent().offset().top + g > 0 && g > 0 ? g > b.$wp.scrollTop() && (c = g, a.addClass("fr-above")) : a.removeClass("fr-above")
            }
            return c
        }
        ...
        function i(c) {
            if (c.offsetWidth) {
                ...
                var t = h.top && r() && (b.helpers.isInViewPort(b.$sc.get(0)) || "body" == b.opts.scrollableContainer), u = h.bottom && s();
        ...
        function k() {
            if (!j()) if (b._stickyElements = [], b.helpers.isIOS()) {
                var c = function () {
                    if (b.helpers.requestAnimationFrame()(c), b.events.trigger("position.refresh") !== !1) for (var a = 0; a < b._stickyElements.length; a++) h(b._stickyElements[a])
                };
    ...
    }), a.FE.TOOLBAR_BUTTONS = ["fullscreen", "bold", "italic", "underline", "strikeThrough", "subscript", "superscript", "|", "fontFamily", "fontSize", "color", "inlineStyle", "paragraphStyle", "|", "paragraphFormat", "align", "formatOL", "formatUL", "outdent", "indent", "quote", "-", "insertLink", "insertImage", "insertVideo", "embedly", "insertFile", "insertTable", "|", "emoticons", "specialCharacters", "insertHR", "selectAll", "clearFormatting", "|", "print", "spellChecker", "help", "html", "|", "undo", "redo"], a.FE.TOOLBAR_BUTTONS_MD = null, a.FE.TOOLBAR_BUTTONS_SM = ["bold", "italic", "underline", "|", "fontFamily", "fontSize", "insertLink", "insertImage", "table", "|", "undo", "redo"], a.FE.TOOLBAR_BUTTONS_XS = ["bold", "italic", "fontFamily", "fontSize", "|", "undo", "redo"], a.FE.MODULES.toolbar = function (b) {
        function c(a, b) {
        ...
        function d() {
            var d = a.merge([], e());
            c(d, t[a.FE.XS]), c(d, t[a.FE.SM]), c(d, t[a.FE.MD]), c(d, t[a.FE.LG]);
        ...
        function k(c) {
            clearTimeout(u), c && c.which == a.FE.KEYCODE.ESC || (u = setTimeout(h, b.opts.typingTimer))
        }

        function l() {
            b.events.on("window.mousedown", i), b.events.on("keydown", i), b.events.on("blur", i), b.helpers.isMobile() || b.events.on("window.mouseup", h), b.helpers.isMobile() ? b.helpers.isIOS() || (b.events.on("window.touchend", h), b.browser.mozilla && setInterval(h, 200)) : b.events.on("window.keyup", k), b.events.on("keydown", function (b) {
