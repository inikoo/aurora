...
! function(a) {
    ...
    b.DEFAULTS = {
        initOnClick: !1,
        pluginsEnabled: null
    }, b.MODULES = {}, b.PLUGINS = {}, b.VERSION = "2.3.1", b.INSTANCES = [], b.OPTS_MAPPING = {}, b.SHARED = {}, b.ID = 0, b.prototype._init = function() {
        ...
        function e(a) {
            if (a.firstChild && "PRE" !== a.nodeName) {
                for (var e = null, f = null, g = d(f, a); g !== a;) {
        ...
        function f(c, d) {
            if ("undefined" != typeof c && c || (c = b.$el.get(0)), "undefined" == typeof d && (d = !1), d && e(c), !c.getAttribute || "false" != c.getAttribute("contenteditable"))
                ...
                (!c.nextSibling || b.node.isBlock(c.nextSibling) || c.nextSibling.nodeType == Node.ELEMENT_NODE && "block" == b.win.getComputedStyle(c.nextSibling).display) && (j = j.replace(/ $/, a.FE.UNICODE_NBSP)), !c.previousSibling || b.node.isVoid(c.previousSibling) || b.node.isBlock(c.previousSibling) || (j = j.replace(/^\u00A0([^ $])/, " $1")), j = j.replace(/([^ \u00A0])\u00A0([^ \u00A0])/g, "$1 $2"), c.textContent != j && (c.textContent = j)
            }
        }
        return {
            normalize: f
        ...
        function h(h, i) {
            if ("undefined" == typeof i && (i = {}), i.style && delete i.style, b.selection.isCollapsed()) {
                ...
                for (var m = b.$el.get(0).querySelectorAll(".fr-marker"), n = 0; n < m.length; n++) {
                    var o = a(m[n]);
                    1 == o.data("type") ? f(o.next().get(0), e(h, i)) && o.next().prepend(o) : f(o.prev().get(0), e(h, i)) && o.prev().append(o)
                }
                b.selection.restore()
            }
        }
        ...
        function i(a, c, d) {
            if (a.parents(c).length || "undefined" == typeof c) {
                var g = "",
                    h = "",
                    i = a.parent();
                if (i.is(b.$el) || b.node.isBlock(i.get(0))) return !1;
                for (;
                    "undefined" == typeof c && !b.node.isBlock(i.parent().get(0)) || "undefined" != typeof c && !f(i.get(0), e(c, d));) g += b.node.closeTagString(i.get(0)), h = b.node.openTagString(i.get(0)) + h, i = i.parent();
                var j = a.get(0).outerHTML;
                a.replaceWith('<span id="mark"></span>');
                var k = i.html().replace(/<span id="mark"><\/span>/, g + b.node.closeTagString(i.get(0)) + h + j + g + b.node.openTagString(i.get(0)) + h);
                return i.replaceWith(b.node.openTagString(i.get(0)) + k + b.node.closeTagString(i.get(0))), !0
            }
            return !1
        }
        ...
        function o(c, d) {
            if (b.selection.isCollapsed()) {
                ...
                b.selection.save();
                var h = b.$el.find('.fr-marker[data-type="true"]').get(0).nextSibling,
                    i = {
                        "class": "fr-unprocessed"
                    };
                for (d && (i.style = c + ": " + d + ";"), g(h, "span", i), b.$el.find(".fr-marker + .fr-unprocessed").each(function() {
                    ...
                    var j = b.$el.find("span.fr-unprocessed:first").removeClass("fr-unprocessed");
                    if (j.parent().get(0).normalize(), j.parent().is("span") && 1 == j.parent().get(0).childNodes.length) {
                        j.parent().css(c, d);
                        var k = j;
                        j = j.parent(), k.replaceWith(k.html())
                    }
                    for (var l = j.find("span"), o = l.length - 1; o >= 0; o--) m(l[o], c);
                    var p = j.parentsUntil(b.$el, "span[style]").filter(function() {
                        return n(this, c)
                    });
                    if (p.length) {
                        var q = "",
                            ...
                            t = "",
                            u = j.get(0);
                        do u = u.parentNode, q += b.node.closeTagString(u), r = b.node.openTagString(u) + r, p.get(0) != u && (s += b.node.closeTagString(u), t = b.node.openTagString(u) + t); while (p.get(0) != u);
                        var v = q + b.node.openTagString(p.clone().css(c, d || "").get(0)) + t + j.html() + s + "</span>" + r;
                        j.replaceWith('<span id="fr-break"></span>');
                        var w = p.get(0).outerHTML;
                        a(p.get(0)).replaceWith(w.replace(/<span id="fr-break"><\/span>/g, v))
                    }
                }
                b.html.cleanEmptyTags(), b.$el.find('span[style=""]').removeAttr("style"), b.$el.find('span[class=""]').removeAttr("class"), b.$el.find("span").each(function() {
                    this.attributes && 0 != this.attributes.length || a(this).replaceWith(this.innerHTML)
                });
                var x = b.$el.find("span[style] + span[style]");
                for (o = 0; o < x.length; o++) {
                    var y = a(x[o]),
                        z = a(x[o]).prev();
                    b.node.openTagString(y.get(0)) == b.node.openTagString(z.get(0)) && (y.prepend(z.html()), z.remove())
                }
        ...
        function c(c, d) {
            if (b.events.trigger("commands.before", a.merge([c], d || [])) !== !1) {
                var e = a.FE.COMMANDS[c] && a.FE.COMMANDS[c].callback || g[c],
                    f = !0;
        ...
        var g = {
            ...
            h = {};
        for (var i in g) g.hasOwnProperty(i) && (h[i] = f(i));
        return a.extend(h, {
            exec: c
        })
        ...
        function d(d, e, h, i) {
            ...
            l.is(b.$tb) && b.$tb.css("zIndex", (b.opts.zIndex || 1) + 4), b.opts.toolbarInline && l && b.$tb && l.get(0) == b.$tb.get(0) && (c(d, a(b.opts.scrollableContainer)), h = b.$tb.offset().top - b.helpers.getPX(b.$tb.css("margin-top")), e = b.$tb.offset().left + b.$tb.outerWidth() / 2 + (parseFloat(b.$tb.find(".fr-arrow").css("margin-left")) || 0) + b.$tb.find(".fr-arrow").outerWidth() / 2, b.$tb.hasClass("fr-above") && h && (h += b.$tb.outerHeight()), i = 0), l = x[d].data("container"), !b.opts.iframe || i || k || (e && (e -= b.$iframe.offset().left), h && (h -= b.$iframe.offset().top)), e && (e -= j / 2), b.opts.toolbarBottom && l && b.$tb && l.get(0) == b.$tb.get(0) && (x[d].addClass("fr-above"),
                h && (h -= x[d].outerHeight())), x[d].removeClass("fr-active"), b.position.at(e, h, x[d], i || 0), x[d].addClass("fr-active");
