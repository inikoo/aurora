! function(i, h, m, f, d, k, e) {
    ...
    var n = {
        ...
        s = i.$BannerSlideshowFormations$ = new function() {
            var h = this,
                b = 0,
                a = 1,
                f = 2,
    ...
    i.$BannerSlideshowRunner$ = function(m, r, p, u, z, A) {
        var a = this,
            v, h, e, y = 0,
    ...
    i.$BannerBulletNavigator$ = function() {
        var a = this,
            E = b.Y(a, o),
            h, v, C, B, m, l = 0,
    ...
    i.$BannerArrowNavigator$ = function() {
        var a = this,
            v = b.Y(a, o),
            e, c, g, l, s, k, h, m, j, i;
    ...
    i.$BannerThumbnailNavigator$ = function() {
        var i = this,
            E = b.Y(i, o),
            h, B, a, y, C, m, l = [],
            A, z, g, p, s, w, v, x, t, u;
    ...
    p.kd = 21;
    p.vc = 24;
    var t = i.$BannerCaptionSlideo$ = function() {
            var a = this,
                hb = b.Y(a, o);
            l.call(a, 0, 0);
        ...
        j = i.$BannerSlider$ = (i.module || {}).exports = function() {
            var a = this,
                Ec = b.Y(a, o),
                Nb = "data-banner-slider",
                ic = "data-banner-thumb",
            ...
            function Mc(c) {
                ...
                if (u === a)
                    if (db) {
                        b.$StopEvent(c);
                        a = b.lb(f, e, "data-banner-button", "A");
                        a && b.$CancelEvent(c)
                    } else {
                        t & 4 && (t = 0);
                        a = b.lb(f, e, "data-banner-click");
                        if (a) {
                            b.$CancelEvent(c);
                            hitValues = (b.n(a, "data-banner-click") || "").split(":");
...
banner_1_slider_init = function() {

    var banner_1_SlideshowTransitions = [
        {$Duration:400,$Opacity:2}
    ];

    var banner_1_options = {
        $AutoPlay: 1,
        $SlideshowOptions: {
            $Class: $BannerSlideshowRunner$,
            $Transitions: banner_1_SlideshowTransitions,
            $TransitionsOrder: 1
        },
        $ArrowNavigatorOptions: {
            $Class: $BannerArrowNavigator$
        },
        $BulletNavigatorOptions: {
            $Class: $BannerBulletNavigator$
        }
    };

    var banner_1_slider = new $BannerSlider$("banner_1", banner_1_options);
    ...
    function ScaleSlider() {
        var containerElement = banner_1_slider.$Elmt.parentNode;
        ...
        if (containerWidth) {
            ...
            banner_1_slider.$ScaleWidth(expectedWidth);
        }
        else {
    ...
    $Banner$.$AddEvent(window, "load", ScaleSlider);
    $Banner$.$AddEvent(window, "resize", ScaleSlider);
    $Banner$.$AddEvent(window, "orientationchange", ScaleSlider);
};