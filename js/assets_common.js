...
function change_department_view(e, data) {
    ...
    else if (tipo == 'department_products') tipo = 'products';
    else if (tipo == 'department_customers') tipo = 'customers';
    ...
    if (tipo == 'sales') {
        ...
        Dom.setStyle(['change_departments_stock_display_mode'], 'display', '')
