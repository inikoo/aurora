...
YAHOO.util.Event.addListener(window, "load", function() {
	...
	if(Dom.get('show_subjects').value){
	    ...
	    var ColumnDefs = [ 
				       ...
				       ,{key:"name", label:labels.Customer_Name, width:260,sortable:true,className:"aleft",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_ASC}}
				       ,{key:"location", label:labels.Location,hidden:(Dom.get('customers_view')=='general'||Dom.get('customers_view')=='other_value'?false:true), width:200,sortable:true,className:"aleft",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_ASC}}
				       ,{key:"contact_since", label:labels.Since,hidden:(Dom.get('customers_view').value=='general'?false:true),sortable:true,className:"aright",width:85,sortable:true,className:"aright",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_DESC}}
				       ,{key:"last_order", label:labels.Last_Order,hidden:(Dom.get('customers_view').value=='general'?false:true),sortable:true,className:"aright",width:85,sortable:true,className:"aright",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_DESC}}
				       ,{key:"orders", label:labels.Orders,hidden:(Dom.get('customers_view').value=='general'?false:true),sortable:true,className:"aright",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_DESC}}
				       ,{key:"activity", label:labels.Status,hidden:(Dom.get('customers_view').value=='general'?false:true),sortable:true,className:"aright",sortable:true,className:"aright",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_DESC}}
				       ,{key:"contact_name", label:labels.Contact_Name,width:160,hidden:(Dom.get('customers_view')=='contact'?false:true),sortable:true,className:"aleft",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_DESC}}
				       ,{key:"email", label:labels.Email,width:210,hidden:(Dom.get('customers_view')=='contact'?false:true),sortable:true,className:"aleft",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_DESC}}
				       ,{key:"telephone", label:labels.Telephone, width:137,hidden:(Dom.get('customers_view')=='contact'?false:true),sortable:true,sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_DESC},className:"aright"}
				       ,{key:"address", label:labels.Contact_Address, width:176,hidden:(Dom.get('customers_view')=='address'?false:true),sortable:true,className:"aleft"}
				       ,{key:"billing_address", label:labels.Billing_Address, width:170,hidden:(Dom.get('customers_view')=='address'?false:true),sortable:true,className:"aleft"}
				       ,{key:"delivery_address", label:labels.Delivery_Address, width:170,hidden:(Dom.get('customers_view')=='address'?false:true),sortable:true,className:"aleft"}
				       ,{key:"total_payments", label:labels.Payments,width:99,hidden:(Dom.get('customers_view')=='balance'?false:true),sortable:true,className:"aright",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_DESC}}
				       ,{key:"total_refunds", label:labels.Refunds,width:90,hidden:(Dom.get('customers_view')=='balance'?false:true),sortable:true,className:"aright",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_DESC}}
				       ,{key:"net_balance", label:labels.Balance,width:90,hidden:(Dom.get('customers_view')=='balance'?false:true),sortable:true,className:"aright",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_DESC}}
				       ,{key:"balance", label:labels.Outstanding,width:90,hidden:(Dom.get('customers_view')=='balance'?false:true),sortable:true,className:"aright",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_DESC}}
				       ,{key:"total_profit", label:labels.Profit,width:90,hidden:(Dom.get('customers_view')=='balance'?false:true),sortable:true,className:"aright",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_DESC}}
				       ,{key:"top_orders", label:labels.Orders_Rank,width:121,hidden:(Dom.get('customers_view')=='rank'?false:true),sortable:true,className:"aright",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_DESC}}
				       ,{key:"top_invoices", label:labels.Invoices_Rank ,width:121,hidden:(Dom.get('customers_view')=='rank'?false:true),sortable:true,className:"aright",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_DESC}}
				       ,{key:"top_balance", label:labels.Balance_Rank ,width:120,hidden:(Dom.get('customers_view')=='rank'?false:true),sortable:true,className:"aright",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_DESC}}
				       ,{key:"top_profits", label:labels.Profits_Rank ,width:120,hidden:(Dom.get('customers_view')=='rank'?false:true),sortable:true,className:"aright",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_DESC}}
						,{key:"logins", label:labels.Logins,width:120,hidden:(Dom.get('customers_view')=='weblog'?false:true),sortable:true,className:"aright",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_DESC}}
				       ,{key:"failed_logins", label:labels.Failed_Logis,width:120,hidden:(Dom.get('customers_view')=='weblog'?false:true),sortable:true,className:"aright",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_DESC}}
				       ,{key:"requests", label:labels.Viewed_Pages,width:120,hidden:(Dom.get('customers_view')=='weblog'?false:true),sortable:true,className:"aright",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_DESC}}
				       ,{key:"other_value", label:labels.Category_Other_Value,width:300,hidden:(Dom.get('customers_view').value=='other_value'?false:true),sortable:true,className:"aleft",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_DESC}}
	    ...
	    this.table0.filter={key:state.customer_categories.customers.f_field,value:state.customer_categories.customers.f_value};
...
if(Dom.get('show_subcategories').value){
	    ...
	    var OrdersColumnDefs = [ 
				    ...
				    {key:"code", label:labels.Code, width:190,sortable:true,className:"aleft",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_ASC}}
				    ,{key:"label", label:labels.Label, width:360,sortable:true,className:"aleft",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_ASC}}
					,{key:"subjects", label:labels.Customers, width:100,sortable:true,className:"aright",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_DESC}}
...
rowsPerPage:state.customer_categories.subcategories.nr, 
	    ...
	    this.table1.filter={key:state.customer_categories.subcategories.f_field,value:state.customer_categories.subcategories.f_value};
	    ...
	    var tableDivEL="table"+tableid;
	  	  	    ...
	  	  	    var CustomersColumnDefs = [
				      ...
				      ,{key:"time", label:labels.Time,className:"aleft",width:50}
...
rowsPerPage:state.customer_categories.history.nr, 								 
								 containers : 'paginator2', alwaysVisible:false,
                pageReportTemplate: '(' + labels.Page + ' {currentPage} ' + labels.of + ' {totalPages})',
								 previousPageLinkLabel : "<",
								 nextPageLinkLabel : ">",
								 firstPageLinkLabel :"<<",
	    ...
	    this.table2.filter={key:state.customer_categories.history.f_field,value:state.customer_categories.history.f_value};
     ...
     this.dataSource4.responseSchema = {
      ...
      this.table4 = new YAHOO.widget.DataTable(tableDivEL, productsColumnDefs,
       this.dataSource4
       , {
        renderLoopSize: 50,generateRequest : myRequestBuilder
							 //,initialLoad:false
...
this.table4.filter={key:state.customer_categories.offers.f_field,value:state.customer_categories.offers.f_value};
