...
YAHOO.util.Event.addListener(window, "load", function() {
	YAHOO.deliverynote.XHR_JSON = new function() {
		...
		var DeliverynotesColumnDefs = [
					   {key:"code", label:"<?=_('Our Code')?>", width:80,sortable:true,formatter:this.productLink,className:"aleft",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_ASC}}
					   ,{key:"sup_code", label:"<?=_('Code')?>", width:80,sortable:true,className:"aleft",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_ASC}}
					   ...
					   ,{key:"price", label:"<?=_('Cost Price Unit')?>" ,width:100,sortable:true,className:"aright",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_DESC}}
					   ,{key:"qty", label:"<?=_('Unit Ordered')?>" ,width:60,sortable:true,className:"aright",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_DESC}}
					   ,{key:"qty2", label:"<?=_('Unit Received')?>" ,width:60,sortable:true,className:"aright",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_DESC}}
