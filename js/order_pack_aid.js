...
YAHOO.util.Event.addListener(window, "load", function() {
    ...
    tables = new function() {
        ...
        this.dataSource0.responseSchema = {
            ...
            fields: ["sku", "used_in", "description", "picked", "picking_notes", "reference", "location", "packing_notes", "done", "quantity", "packed", "add", "remove", "itf_key", "todo", "notes", "required", 'out_of_stock', 'not_found', 'formated_todo', "no_packed_other", "check_mark","packed_bis"
        ...
        this.table0 = new YAHOO.widget.DataTable(tableDivEL, ColumnDefs, this.dataSource0, {
            ...
            paginator: new YAHOO.widget.Paginator({
                rowsPerPage: state.packing_aid.items.nr,
            ...
            ,
            sortedBy: {
                key: state.packing_aid.items.order,
                dir: state.packing_aid.items.order_dir
            },
            dynamicData: true
        ...
        this.table0.filter = {
            key: state.packing_aid.items.f_field,
            value: state.packing_aid.items.f_value
        };
