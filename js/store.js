...
YAHOO.util.Event.addListener(window, "load", function() {
    ...
    tables = new function() {
...

        {
            ...
            sortable: true,
            className: "aright",
            hidden: (state.store.departments.view == 'web' ? false : true),
            sortOptions: {
                defaultDir: YAHOO.widget.DataTable.CLASS_DESC
            }
        }, {
            ...
            sortable: true,
            className: "aright",
            hidden: (state.store.departments.view == 'timeline' ? false : true),
            sortOptions: {
                defaultDir: YAHOO.widget.DataTable.CLASS_DESC
            }
        }, {
        ...
        this.dataSource0.responseSchema = {
            ...
            fields: ['id', 'name', 'code', 'aws_p', 'awp_p', 'sales_type', 'delta_sales', 'from', 'last_update', 'to', 'families', 'products_for_sale', 'percentage_out_of_stock', 'sales_1q', 'delta_sales_1q', 'sales',
             'stock_error', 'stock_value', 'outofstock', 'profit', 'surplus', 'optimal', 'low', 'critical',
        ...
        this.table0.filter = {
            key: state.store.departments.f_field,
            value: state.store.departments.f_value
        };
        ...
        var ColumnDefs = [{
            ...
            hidden: (state.store.families.view == 'general' ? false : true),
            width: 80,
            sortable: true,
            className: "aleft",
            sortOptions: {
            ...
            key: "name",
            label: labels.Name,
            hidden: (state.store.families.view == 'customers' || state.store.families.view == 'timeline' ? true : false),
            sortable: true,
            className: "aleft",
            sortOptions: {
                defaultDir: YAHOO.widget.DataTable.CLASS_ASC
            ...
            sortable: true,
            className: "aright",
            hidden: (state.store.families.view == 'sales' ? false : true),
            sortOptions: {
                defaultDir: YAHOO.widget.DataTable.CLASS_DESC
            }
        }, {
            ...
            sortable: true,
            className: "aright",
            hidden: (state.store.families.view == 'stock' ? false : true),
            sortOptions: {
                defaultDir: YAHOO.widget.DataTable.CLASS_DESC
            }
        }, {
            ...
            sortable: true,
            className: "aright",
            hidden: (state.store.families.view == 'timeline' ? false : true),
            sortOptions: {
                defaultDir: YAHOO.widget.DataTable.CLASS_DESC
            }
        }, {
            ...
            sortable: true,
            className: "aright",
            hidden: (state.store.families.view == 'products' ? false : true),
            sortOptions: {
                defaultDir: YAHOO.widget.DataTable.CLASS_DESC
            }
        },{
            ...
            sortable: true,
            className: "aright",
            hidden: (state.store.families.view == 'customers' ? false : true),
            sortOptions: {
                defaultDir: YAHOO.widget.DataTable.CLASS_DESC
            }
        },{
        ...
        this.table1.filter = {
            key: state.store.families.f_field,
            value: state.store.families.f_value
        };
        ...
        ColumnDefs = [{
            ...
            label: labels.Name,
            width: 400,
            hidden: (state.store.products.view == 'general' ? false : true),
            sortable: true,
            className: "aleft",
            sortOptions: {
                defaultDir: YAHOO.widget.DataTable.CLASS_ASC
            ...
            className: "aleft",
            className: "aleft",
            hidden: (state.store.products.view == 'general' || state.store.products.view == 'timeline' || state.store.products.view == 'properties' ? true : false),
            sortOptions: {
                defaultDir: YAHOO.widget.DataTable.CLASS_ASC
            }
        }, {
            ...
            width: 150,
            hidden: (state.store.products.view == 'general' || state.store.products.view == 'stock' ? false : true),
            sortable: true,
            className: "aleft",
            sortOptions: {
                defaultDir: YAHOO.widget.DataTable.CLASS_ASC
            ...
            label: labels.Sold,
            width: 90,
            hidden: (state.store.products.view == 'sales' ? false : true),
            sortable: true,
            className: "aright",
            sortOptions: {
                defaultDir: YAHOO.widget.DataTable.CLASS_ASC
            ...
            sortable: true,
            className: "aright",
            hidden: (state.store.products.view == 'stock' ? false : true),
            sortOptions: {
                defaultDir: YAHOO.widget.DataTable.CLASS_DESC
            }
        }, {
            ...
            label: labels.Parts,
            width: 130,
            hidden: (state.store.products.view == 'parts' ? false : true),
            sortable: true,
            className: "aleft",
            sortOptions: {
                defaultDir: YAHOO.widget.DataTable.CLASS_ASC
            ...
            width: 160,
            hidden: (state.store.products.view == 'cats' ? false : true),
            sortable: true,
            className: "aleft",
            sortOptions: {
                defaultDir: YAHOO.widget.DataTable.CLASS_ASC
            ...
            sortable: true,
            className: "aright",
            hidden: (state.store.products.view == 'timeline' ? false : true),
            sortOptions: {
                defaultDir: YAHOO.widget.DataTable.CLASS_DESC
            }
        }, {
            ...
            sortable: true,
            className: "aright",
            hidden: (state.store.products.view == 'properties' ? false : true),
            sortOptions: {
                defaultDir: YAHOO.widget.DataTable.CLASS_DESC
            }
        }, {
        ...
        this.dataSource2.responseSchema = {
            ...
            fields: ['id', "package_type", "package_weight", "package_dimension", "package_volume", "unit_weight", "unit_dimension", "code", "price", "name", "stock", "stock_value", "from", "last_update", "to", 'sales', 'profit', 'margin', 'sold', "parts", "supplied", "gmroi", "family", "dept", "expcode", "smallname", "state", "web", "delta_sales"]
        };
        ...
        this.table2.filter = {
            key: state.store.products.f_field,
            value: state.store.products.f_value
        };
        ...
        var ColumnDefs = [{
            ...
            label: labels.Name,
            width: 120,
            hidden: (state.store.sites.view == 'general' ? false : true),
            sortable: true,
            className: "aleft",
            sortOptions: {
                defaultDir: YAHOO.widget.DataTable.CLASS_ASC
            ...
            label: labels.Products,
            width: 100,
            hidden: (state.store.sites.view == 'producys' || state.store.sites.view == 'general' ? false : true),
            sortable: true,
            className: "aright",
            sortOptions: {
                defaultDir: YAHOO.widget.DataTable.CLASS_ASC
            ...
            label: labels.OoS,
            width: 100,
            hidden: (state.store.sites.view == 'products' ? false : true),
            sortable: true,
            className: "aright",
            sortOptions: {
                defaultDir: YAHOO.widget.DataTable.CLASS_ASC
            ...
            key: "pages_out_of_stock",
            label: labels.Pages_w_OoS,
            width: 100,
            hidden: (state.store.sites.view == 'products' ? false : true),
            sortable: true,
            className: "aright",
            ...
            key: "pages_out_of_stock_percentage",
            label: "%",
            width: 100,
            hidden: (state.store.sites.view == 'products' ? false : true),
            sortable: true,
        ...
        this.dataSource3.responseSchema = {
            ...
            fields: ['id', 'title', 'code', 'url', 'type', 'site', 'name', 'users', 'pages', 'pages_products', 'pages_out_of_stock', 'pages_out_of_stock_percentage', 'products', 'out_of_stock', 'out_of_stock_percentage']
        };
        ...
        this.table3.filter = {
            key: state.store.sites.f_field,
            value: state.store.sites.f_value
        };
        ...
        this.table5 = new YAHOO.widget.DataTable(tableDivEL, ColumnDefs, this.dataSource5, {
        ...
        this.table5.filter = {
            key: state.store.history.f_field,
            value: state.store.history.f_value
        };
        ...
        this.dataSource6.responseSchema = {
            ...
            fields: ["date", "invoices", "customers", "sales"
        ...
        this.table6.filter = {
            key: state.store.sales_history.f_field,
            value: state.store.sales_history.f_value
        };
        ...
        this.dataSource7.responseSchema = {
            ...
            fields: ['id', "code", "name", "stock", "stock_value", "record_type", 'sales', 'profit', 'margin', 'sold', "parts", "supplied", "gmroi", "department", "dept", "expcode", "state", "web", "smallname", "delta_sales"]
        };



        this.table7 = new YAHOO.widget.DataTable(tableDivEL, ColumnDefs, this.dataSource7, {
            //draggableColumns:true,
            // formatRow: myRowFormatter,
            renderLoopSize: 50,
            generateRequest: myRequestBuilder,
        ...
        this.table7.filter = {
            key: state.store.family_sales.f_field,
            value: state.store.family_sales.f_value
        };
        ...
        this.table8 = new YAHOO.widget.DataTable(tableDivEL, ColumnDefs, this.dataSource8, {
            //draggableColumns:true,
            // formatRow: myRowFormatter,
            renderLoopSize: 50,
            generateRequest: myRequestBuilder,
        ...
        this.dataSource9.responseSchema = {
            ...
            fields: ['id', "code", "name", "stock", "stock_value", "record_type", 'sales', 'profit', 'margin', 'sold', "parts", "supplied", "gmroi", "family", "dept", "expcode", "state", "web", "smallname", "delta_sales"]
        };



        this.table9 = new YAHOO.widget.DataTable(tableDivEL, ColumnDefs, this.dataSource9, {
            //draggableColumns:true,
            formatRow: myRowFormatter,
            renderLoopSize: 50,
            generateRequest: myRequestBuilder,
        ...
        this.table9.filter = {
            key: state.store.product_sales.f_field,
            value: state.store.product_sales.f_value
        };
        ...
        this.table10.filter = {
            key: state.store.offers.f_field,
            value: state.store.offers.f_value
        };
        ...
        this.table11 = new YAHOO.widget.DataTable(tableDivEL, productsColumnDefs, this.dataSource11, {
            renderLoopSize: 50,
            generateRequest: myRequestBuilder
            //,initialLoad:false
            ,
        ...
        this.table11.filter = {
            key: state.store.campaigns.f_field,
            value: state.store.campaigns.f_value
        };
...
function change_display_mode(parent, name, label) {
    ...
    if (parent == 'products') {
        ...
        dialog_change_families_display.hide();
          Dom.removeClass(['families_display_menu_percentages', 'families_display_menu_value'], 'selected')
        Dom.addClass(['families_display_menu_' + name], 'selected')
    ...
    } else if (parent == 'families_stock') {
        var table = tables['table1'];
        var datasource = tables.dataSource1;
        dialog_change_families_stock_display.hide();

        Dom.removeClass(['families_stock_display_menu_horizontal', , 'families_stock_display_menu_vertical','families_stock_display_menu_value'], 'selected')
        Dom.addClass(['families_stock_display_menu_' + name], 'selected')
...
Dom.removeClass([parent+'_table_type_option_list'],'selected')
   Dom.addClass([parent+'_table_type_option_thumbnails'],'selected')
 if (tipo == 'list') {
        ...
        Dom.addClass([parent+'_table_type_option_list'],'selected')
   Dom.removeClass([parent+'_table_type_option_thumbnails'],'selected')
...
function show_dialog_change_families_stock_display() {
    region1 = Dom.getRegion('change_families_stock_display_mode');
    region2 = Dom.getRegion('change_families_stock_display_menu');
    var pos = [region1.right - region2.width, region1.bottom]
    Dom.setXY('change_families_stock_display_menu', pos);
    dialog_change_families_stock_display.show();
}
...
function init() {
  ...
  dialog_change_families_stock_display = new YAHOO.widget.Dialog("change_families_stock_display_menu", {
        visible: false,
        close: true,
        underlay: "none",
        draggable: false
    });
    dialog_change_families_stock_display.render();
    YAHOO.util.Event.addListener("change_families_stock_display_mode", "click", show_dialog_change_families_stock_display);
    ...
    Event.addListener(['elements_family_discontinued', 'elements_family_private', 'elements_family_normal', 'elements_family_nosale'], "click", change_family_elements,{table_id:1});
    ...
    ids = ['family_general', 'family_sales', 'family_stock', 'family_timeline', 'family_products', 'family_customers'];
