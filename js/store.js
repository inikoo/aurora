...
YAHOO.util.Event.addListener(window, "load", function() {
    ...
    tables = new function() {
        ...
        var ColumnDefs = [{
            ...
            hidden: (state.store.families.view == 'timeline' ? true : false),
            width: 80,
            sortable: true,
            className: "aleft",
            sortOptions: {
            ...
            key: "name",
            label: labels.Name,
            hidden: (state.store.families.view == 'stock' || state.store.families.view == 'timeline' ? true : false),
            width: 280,
            sortable: true,
            className: "aleft",
            sortOptions: {
            ...
            sortable: true,
            className: "aright",
            hidden: (state.store.families.view == 'stock' || state.store.families.view == 'timeline' ? false : true),
            sortOptions: {
                defaultDir: YAHOO.widget.DataTable.CLASS_DESC
            }
        }, {
...

        {
            ...
            key: "type",
            label: labels.Type,
            hidden: (state.store.pages.view == 'general' ? false : true),
            width: 120,
            sortable: true,
            className: "aleft",
            sortOptions: {
            ...
            key: "link_title",
            label: labels.Link_Label,
            hidden: (state.store.pages.view != 'products' ? false : true),
            width: 270,
            sortable: true,
            className: "aleft",
            sortOptions: {
            ...
            key: "users",
            label: labels.Users,
            hidden: (state.store.pages.view == 'requests' ? false : true),
            width: 70,
            sortable: true,
            className: "aright",
            sortOptions: {
            ...
            key: "percentage_products_out_of_stock",
            label: "%",
            hidden: (state.store.pages.view = 'products' ? false : true),
            width: 70,
            sortable: true,
        ...
        this.table4.filter = {
            key: state.store.pages.f_field,
            value: state.store.pages.f_value
        };
