...
YAHOO.util.Event.addListener(window, "load", function() {
    ...
    tables = new function() {
        ...
        this.dataSource0.responseSchema = {
            ...
            fields: ["code", "description", "quantity", "discount", "to_charge", "gross", "tariff_code", "stock", "add", "remove", "pid", 'dispatching_status'
            // "promotion_id",
            ]
        };
        ...
        this.dataSource5 = new YAHOO.util.DataSource("ar_quick_tables.php?tipo=active_staff_list&active=Yes&tableid=" + tableid + "&nr=20&sf=0");
        ...
        this.table5.subscribe("rowClickEvent", select_staff_from_list);
