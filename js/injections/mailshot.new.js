...
function toggle_mailshot_scope(element) {
    ...
    if (!$(element).hasClass('selected')) {
        ...
        var _container = $(element).closest('.button_radio_options')
        _container.find('.button').removeClass('selected')
        $(element).addClass('selected')


        _container.find('.value').val($(element).attr('field'))
        ...
        switch ($(element).attr('field')) {
            case 'Customer_List':
                ...
                console.log($('#Scope_Type_container').find('.button_radio_options').find('.button'))
                $('#Scope_Type_container').find('.button_radio_options').find('.button').removeClass('selected')
...
function get_mailshot_form_validation_state() {


    form_validation = 'valid';

    var fields=['Email_Campaign_Name','Type']
    ...
    switch($('#_Type').val()){
        ...
        case 'Product_Category':
            ...
            fields=['Email_Campaign_Name','Scope_Type']
            break;
    }
    ...
    //    console.log(field+' '+$('#' + field + '_field').hasClass('valid'))
