...
var myRowsPerPageDropdown = function() {
        return true
    };
var mydoBeforeSortColumn = function() {
        return true
    };
...
var myhandleDataReturnPayload = function(oRequest, oResponse, oPayload) {
        ...
        if (oPayload.totalRecords == 0) {
            ...
            if (YAHOO.util.Dom.get('filter_div' + oResponse.meta.tableid) != null) YAHOO.util.Dom.get('filter_div' + oResponse.meta.tableid).style.visibility = 'visible';
...
function change_table_type(e, data) {
    ...
    parent = data.parent;
    if (Dom.hasClass(this, 'selected')) return;
