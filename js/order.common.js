...
function set_order_for_collection(element){



    var delivery_options =$('.delivery_options')

    var icon=$(element).find('.radio_icon')
...
function use_delivery_address_form_directory(element){
    ...
    form_data.append("order_key", order_key)
    form_data.append("other_delivery_address_key", $(element).data('other_delivery_address_key'))
    form_data.append("type", $(element).data('type'))
