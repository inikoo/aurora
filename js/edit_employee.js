    ...
    validate_scope_data = {
        ...
        'staff_description': {
            'alias': {
                ...
                'validation': [{
                    'regexp': "[a-z\d]+",
                    'invalid_msg': Dom.get('label_invalid_alias').value
                }]
            }
        },
        'staff_employment': {
        ...
        'staff_pin': {
            'pin': {
                ...
                'validation': [{
                    'regexp': "[a-z\d]{0,4}",
                    'invalid_msg': Dom.get('label_invalid_pin').value
                }]
            },
            'pin_confirm': {
                'changed': false,
