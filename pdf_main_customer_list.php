<?php
require_once(dirname(__FILE__).'/external_libs/PDF/config/tcpdf_config.php');
class TCPDF {
	 ...
	 * @protected
	 */
	protected $header_logo_width = 20;
	...
	public function __construct($orientation='P', $unit='mm', $format='A4', $unicode=true, $encoding='UTF-8', $diskcache=false) {
		...
		require(dirname(__FILE__).'/external_libs/PDF/htmlcolors.php');
		...
		require_once(dirname(__FILE__).'/external_libs/PDF/unicode_data.php');
	...
	public function getPageSizeFromFormat($format) {
		...
		switch (strtoupper($format)) {
			...
			case 'MY_SIZE'             : {$pf = array(  102.000,  255.100); break;}
			// DEFAULT ISO A4
