...
if (isset($_REQUEST['store']) and is_numeric($_REQUEST['store'])) {
	...
	if (isset($_REQUEST['tipo'])) {
		$tipo=$_REQUEST['tipo'];
		$_SESSION['state']['report_pending_orders']['tipo']=$tipo;
	} else
		$tipo=$_SESSION['state']['report_pending_orders']['tipo'];
	...
	if ($_SESSION['state']['report_pending_orders']['store_keys']=='all') {
		$store_keys=join(',',$user->stores);
		$formated_store_keys='all';
	} else {
		$store_keys=$_SESSION['state']['report_pending_orders']['store_keys'];
	...
	$smarty->assign('view',$_SESSION['state']['report_pending_orders']['view']);

	//print_r($_SESSION['state']['report_pending_orders']['currency']);

	$smarty->assign('currencies',$_SESSION['state']['report_pending_orders']['currency']);
	...
	$smarty->assign('type',$_SESSION['state']['report_pending_orders']['block_view']);
...
$plot_tipo=$_SESSION['state']['report_pending_orders']['plot'];
