...
$sql="select * from  de_orders_data.orders  where   (last_transcribed is NULL  or last_read>last_transcribed) and deleted='No'  and filename not like  '%DE0315.xls' order by filename  ";




//$sql="select * from  de_orders_data.orders where filename like '%refund.xls'   order by filename";
//$sql="select * from  de_orders_data.orders  where (filename like '/%DE0436.xls' ) order by filename";
