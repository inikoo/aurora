...
function read_header($raw_header_data,$map_act,$y_map,$map,$convert_encoding=true){
  ...
  foreach($map as $key=>$map_data){
	...
	$_data=preg_replace('/-lip-/i','-july-',$_data);
		...
		$_data=preg_replace('/-gru-/i','-december-',$_data);
		$_data=preg_replace('/-gar-/i','-december-',$_data);
		$_data=preg_replace('/-paz-/i','-october-',$_data);
		$_data=preg_replace('/-lis-/i','-november-',$_data);
		$_data=preg_replace('/-lut-/i','-feb-',$_data);
		$_data=preg_replace('/-luty-/i','-feb-',$_data);
		$_data=preg_replace('/-mar-/i','-march-',$_data);
		$_data=preg_replace('/-kwi-/i','-april-',$_data);
