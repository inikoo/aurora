...
$sql="select `Delivery Note Metadata` as id ,`Delivery Note Key` from `Delivery Note Dimension` where  `Delivery Note Store Key`=1 and ( `Delivery Note Assigned Picker Key` IS NULL or `Delivery Note Assigned Packer Key` IS NULL) ";
