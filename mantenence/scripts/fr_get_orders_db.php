...
$sql="select * from  fr_orders_data.orders  where   (last_transcribed is NULL  or last_read>last_transcribed) and deleted='No'  and (filename like '/mnt/%/FR62%.xls')  order by filename  ";
