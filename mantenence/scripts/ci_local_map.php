...
if(preg_match('/^devoluci|^refund|VAT REFUND|abono/i',$ltipo)){
    ...
    $tipo=5; 
  }elseif(preg_match('/^\s*REPLACEMENT|Replcement|^reemplazo por roturas|Abono Por Roturas|^replacement|Damaged item|REPLACMENT|DELIVERY COLLECTION|repplacements|repalcements/i',$ltipo)){
    $tipo=6;
