...
//Created: 3 December 2013 20:31:22 CET Malaga, Spain
//Copyright (c) 2013 LW
...
while ($row=mysql_fetch_array($res)) {
    ...
    foreach($site_keys as $site_key) {
        ...
        $data['Page Store Description']=(isset($family_data[$row['Store Code'].'_'.$row['Product Family Code']]['Resume'])?$family_data[$row['Store Code'].'_'.$row['Product Family Code']]['Resume']:'');
...
foreach($store_data as $store_code=>$xdata) {
    ...
    foreach($site_keys as $site_key) {
        ...
        $data['Page Store Description']=$xdata['Resume'];
        $data['Showcases Layout']='Splited';
...
while ($row=mysql_fetch_array($res)) {
    ...
    foreach($site_keys as $site_key) {
        ...
        $data['Page Store Description']=(isset($department_data[$row['Store Code'].'_'.$row['Product Department Code']]['Resume'])?$department_data[$row['Store Code'].'_'.$row['Product Department Code']]['Resume']:'');
