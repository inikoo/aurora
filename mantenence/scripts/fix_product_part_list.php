...
$sql="select `Product ID` from `Product Dimension` where `Product ID`=65484 ";
...
if(count($current_part_skus)>1){

print 'PID: '.$row['Product ID']."\n";

    print   print_r($current_part_skus);
