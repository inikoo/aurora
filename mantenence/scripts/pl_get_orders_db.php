...
//$sql="select * from  pl_orders_data.orders where filename like '%refund.xls'   order by filename";
//$sql="select * from  pl_orders_data.orders  where (filename like '%PL1206.%' ) order by filename";
