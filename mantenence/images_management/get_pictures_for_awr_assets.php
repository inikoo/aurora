...
$sql=sprintf("select `Product Family Key`,`Product Family Code`,`Product Family Store Key`,`Product Family Main Image Key` from `Product Family Dimension` where `Product Family Main Image Key`=0  ");
...
$sql=sprintf("select `Product ID`,`Product Code`,`Product Store Key`,`Product Main Image Key` from `Product Dimension` where  `Product Main Image Key`=0  ");
