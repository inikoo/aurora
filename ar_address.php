...
$_address_format=preg_replace('/\//',' ',$_address_format);
	...
	$address_fields=array(
		'recipient'=>array('required'=>false, 'render'=>false, 'label'=>_('Recipient')),
		'organization'=>array('required'=>false, 'render'=>false, 'label'=>_('Organization')),
		'addressLine1'=>array('required'=>false, 'render'=>false, 'label'=>_('Line 1')),
		'addressLine2'=>array('required'=>false, 'render'=>false, 'label'=>_('Line 2')),
		'sortingCode'=>array('required'=>false, 'render'=>false, 'label'=>_('Sorting code')),
		'postalCode'=>array('required'=>false, 'render'=>false, 'label'=>_('Postal code')),
		'dependentLocality'=>array('required'=>false, 'render'=>false, 'label'=>_('Dependent locality')),
		'locality'=>array('required'=>false, 'render'=>false, 'label'=>_('Locality (City)')),
		'administrativeArea'=>array('required'=>false, 'render'=>false, 'label'=>_('Administrative area')),
