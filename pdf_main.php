...
{
	if(!defined('FPDF_FONTPATH') && is_dir(dirname(__FILE__).'/external_libs/PDF/font'))
		define('FPDF_FONTPATH',dirname(__FILE__).'/external_libs/PDF/font/');
