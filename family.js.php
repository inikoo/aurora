    ...
    tables = new function() {
	    ...
	    var ColumnDefs = [ 
				...
				,{key:"package_type", label:"<?php echo _('Pkg Type')?>", width:70,sortable:true,className:"aright",<?php echo($_SESSION['state']['family']['products']['view']=='properties'?'':'hidden:true,')?>sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_DESC}}
				    ...
				    ,{key:"1m_avg_sold_over_1y", label:"<?php echo _('1mASo1Y')?>",width:100,<?php echo($_SESSION['state']['family']['products']['view']=='reorder'?'':'hidden:true,')?> sortable:true,className:"aright",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_DESC}}
