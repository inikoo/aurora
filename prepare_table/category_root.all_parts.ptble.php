...
$table='   `Part Dimension` P  left join `Category Dimension` F on (`Part Family Category Key`=F.`Category Key`) ';
$filter_msg='';
$sql_type='part';
$filter_msg='';
$wheref='';
...
elseif ($parameters['f_field']=='description' and $f_value!='')
	$wheref=sprintf(' and `Part Unit Description` REGEXP "[[:<:]]%s" ',addslashes($f_value));
