...
$fields
    = "PA.`Payment Account Key`,`Payment Account Currency`,`Payment Account Code`,`Payment Account Name`,`Payment Account Transactions`,`Payment Account Payments Amount`,`Payment Account Refunds Amount`,`Payment Account Balance Amount`";
