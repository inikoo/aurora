...
case 'website':
	...
	break;
case 'page':
	$table='`User Dimension` U left join `User Request Dimension` URD on (URD.`User Key`=U.`User Key`) ';
...
$fields="`User Site Key`,`User Alias`,`User Parent Key`,`User Handle`,U.`User Key`,`User Sessions Count`,`User Last Login`";
?>
