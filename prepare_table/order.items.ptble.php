...
$fields
    = "`Product Properties`,`Order Transaction Metadata`,
    `Product Number of Parts`,`Product Availability State`,`Product Package Weight`,`Product Tariff Code`,`Product UN Number`,`Order Transaction Product Type`,
