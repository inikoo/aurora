...
$fields
    = "`Product Availability State`,`Product Package Weight`,`Product Tariff Code`,`Product UN Number`,
	`Delivery Note Quantity`,OTF.`Product Key`,OTF.`Order Transaction Fact Key`,`Product Units Per Case`,`Product History Name`,`Product History Price`,`Product Currency`,OTF.`Product ID`,OTF.`Product Code`,`Order Quantity`,`Order Bonus Quantity`,`Product Availability`,`Product History XHTML Short Description`,`Order Transaction Amount`,`Transaction Tax Rate`,`Product Tariff Code`,
