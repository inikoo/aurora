...
sum(`Timesheet Paid Overtime`+`Timesheet Unpaid Overtime`+`Timesheet Working Time`-(`Timesheet Sunday Paid Overtime`+`Timesheet Sunday Unpaid Overtime`+`Timesheet Sunday Working Time`+`Timesheet Sunday Paid Overtime`+`Timesheet Sunday Unpaid Overtime`+`Timesheet Sunday Working Time`)) worked_time_workweek,
sum(`Timesheet Sunday Paid Overtime`+`Timesheet Sunday Unpaid Overtime`+`Timesheet Sunday Working Time`+`Timesheet Sunday Paid Overtime`+`Timesheet Sunday Unpaid Overtime`+`Timesheet Sunday Working Time`) worked_time_weekend,
...
sum(`Timesheet Clocked Time`-(`Timesheet Sunday Clocked Time`+`Timesheet Sunday Clocked Time`)) clocked_time_workweek,
sum(`Timesheet Sunday Clocked Time`+`Timesheet Sunday Clocked Time`) clocked_time_weekend,
...
sum(`Timesheet Unpaid Overtime`-(`Timesheet Sunday Unpaid Overtime`+`Timesheet Sunday Unpaid Overtime`)) unpaid_overtime_workweek,
sum(`Timesheet Sunday Unpaid Overtime`+`Timesheet Sunday Unpaid Overtime`) unpaid_overtime_weekend,
...
sum(`Timesheet Paid Overtime`-(`Timesheet Sunday Paid Overtime`+`Timesheet Sunday Paid Overtime`)) paid_overtime_workweek,
sum(`Timesheet Sunday Paid Overtime`+`Timesheet Sunday Paid Overtime`) paid_overtime_weekend,
...
sum(`Timesheet Working Time`-(`Timesheet Sunday Working Time`+`Timesheet Sunday Working Time`)) work_time_workweek,
sum(`Timesheet Sunday Working Time`+`Timesheet Sunday Working Time`) work_time_weekend,
