...
/*
 ...
 Created: 9 February 2019 at 02:06:54 GMT+8, Kuala Lumpur , Malaysia
...
switch ($parameters['parent']){
    case 'store':
        $where=sprintf(' where `Email Campaign Type Scope`="Marketing" and `Email Campaign Type Store Key`=%d ',$parameters['parent_key']);
        break;
    case 'account':
        $where=sprintf(' where `Email Campaign Type Scope`="Marketing" ');
        break;
    default:
