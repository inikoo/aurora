...
$fields
    = "`Page Parent Key`,`Page Parent Code`,`Page Name`,`Webpage Website Key`,`User Request Key`,URD.`Page Key`,`Webpage Code`,`User Site Key`,`User Alias`,`User Parent Key`,`User Handle`,U.`User Key`,`Date`";
