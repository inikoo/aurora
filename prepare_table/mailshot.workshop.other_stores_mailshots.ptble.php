...
/*
 ...
 Created:  12 February 2019 at 02:06:41 MYT+0800, Kuala Lumpur, Malaysia
...
$where=sprintf(' where `Email Campaign Type Code`=%s and   `Email Campaign Email Template Type Key`!=%d and  `Email Campaign State`="Sent" ',
               prepare_mysql($mailshot->get('Email Campaign Type')),
               $parameters['email_campaign_type_key']);
...
left join `Email Campaign Type Dimension` ECT on (ECT.`Email Campaign Type Key`=C.`Email Campaign Email Template Type Key`) 
