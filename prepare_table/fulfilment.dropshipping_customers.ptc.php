...
class prepare_table_fulfilment_dropshipping_customers extends prepare_table {
    ...
    ';
        ...
        $this->where = sprintf(' where  `Customer Fulfilment Warehouse Key`=%d and `Store Type`="Dropshipping" ', $this->parameters['parent_key']);
