...
$fields="P.`Part SKU`,`Part Reference`,`Part Package Description`,`Part Current Stock`,`Part Stock Status`,`Part Days Available Forecast`,`Part 1 Quarter Acc Provided`,`Product Part Ratio`,`Product Part Note`";
