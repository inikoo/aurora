...
/*
 ...
 Created: 26 July 2018 at 13:25:54 GMT+8, Kuala Lumpur , Malaysia
...
$timeseries_key = '';
$sql            = sprintf(
    'SELECT `Timeseries Key` FROM `Timeseries Dimension` WHERE `Timeseries Parent`="Customer" AND `Timeseries Parent Key`=%s AND `Timeseries Frequency`=%s AND  `Timeseries Type`="CustomerSales" ',
...
$fields
       = '`Timeseries Record Key`,`Timeseries Record Timeseries Key`, `Timeseries Record Date` as `Date`,`Timeseries Record Float A`-`Timeseries Record Float B`  as sales ,`Timeseries Record Float A` as invoiced_amount ,`Timeseries Record Float B` as refunded_amount ,`Timeseries Record Integer A` as invoices,`Timeseries Record Integer B` as refunds';
$where = sprintf(
