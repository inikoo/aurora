...
/*
 ...
 Created: 24 July 2018 at 16:59:03 GMT+8, Kuala Lumpur, Malaysia
...
$table = '`Staff Dimension` SD left join `Staff Role Bridge`  B on  (B.`Staff Key`=SD.`Staff Key`) left join `User Dimension` U on (SD.`Staff Key`=U.`User Parent Key` and `User Type`="Staff") ';
