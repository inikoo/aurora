...
$timeseries_key='';
$sql=sprintf('select `Timeseries Key` from `Timeseries Dimension` where `Timeseries Parent`="Category" and `Timeseries Parent Key`=%s and `Timeseries Frequency`=%s and  `Timeseries Type`="PartCategorySales" ',
...
$fields=' `Timeseries Record Date` as Date,sum(`Timeseries Record Float A`) as sales ,sum(`Timeseries Record Integer A`) as deliveries,sum(`Timeseries Record Integer B`) as skos';
