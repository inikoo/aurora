...
$currency='';
$where='where true';
$table='`Agent Dimension` A left join `Agent Data` D on (D.`Agent Key`=A.`Agent Key`) ';
$group_by='';
$where_type='';
...
elseif ($order=='delta_sales_year0') {$order="(-1*(`Agent Year To Day Acc Invoiced Amount`-`Agent Year To Day Acc 1Yb Invoiced Amount`)/`Agent Year To Day Acc 1Yb Invoiced Amount`)";}
elseif ($order=='delta_sales_year1') {$order="(-1*(`Agent 2 Year Ago Invoiced Amount`-`Agent 1 Year Ago Invoiced Amount`)/`Agent 2 Year Ago Invoiced Amount`)";}
elseif ($order=='delta_sales_year2') {$order="(-1*(`Agent 3 Year Ago Invoiced Amount`-`Agent 2 Year Ago Invoiced Amount`)/`Agent 3 Year Ago Invoiced Amount`)";}
elseif ($order=='delta_sales_year3') {$order="(-1*(`Agent 4 Year Ago Invoiced Amount`-`Agent 3 Year Ago Invoiced Amount`)/`Agent 4 Year Ago Invoiced Amount`)";}
elseif ($order=='sales_year1') {$order="`Agent 1 Year Ago Invoiced Amount`";}
elseif ($order=='sales_year2') {$order="`Agent 2 Year Ago Invoiced Amount`";}
elseif ($order=='sales_year3') {$order="`Agent 3 Year Ago Invoiced Amount`";}
elseif ($order=='sales_year4') {$order="`Agent 4 Year Ago Invoiced Amount`";}
elseif ($order=='sales_year0') {$order="`Agent Year To Day Acc Invoiced Amount`";}
elseif ($order=='delta_sales_quarter0') {$order="(-1*(`Agent Quarter To Day Acc Invoiced Amount`-`Agent Quarter To Day Acc 1Yb Invoiced Amount`)/`Agent Quarter To Day Acc 1Yb Invoiced Amount`)";}
elseif ($order=='delta_sales_quarter1') {$order="(-1*(`Agent 2 Quarter Ago Invoiced Amount`-`Agent 1 Quarter Ago Invoiced Amount`)/`Agent 2 Quarter Ago Invoiced Amount`)";}
elseif ($order=='delta_sales_quarter2') {$order="(-1*(`Agent 3 Quarter Ago Invoiced Amount`-`Agent 2 Quarter Ago Invoiced Amount`)/`Agent 3 Quarter Ago Invoiced Amount`)";}
elseif ($order=='delta_sales_quarter3') {$order="(-1*(`Agent 4 Quarter Ago Invoiced Amount`-`Agent 3 Quarter Ago Invoiced Amount`)/`Agent 4 Quarter Ago Invoiced Amount`)";}
elseif ($order=='sales_quarter1') {$order="`Agent 1 Quarter Ago Invoiced Amount`";}
elseif ($order=='sales_quarter2') {$order="`Agent 2 Quarter Ago Invoiced Amount`";}
elseif ($order=='sales_quarter3') {$order="`Agent 3 Quarter Ago Invoiced Amount`";}
elseif ($order=='sales_quarter4') {$order="`Agent 4 Quarter Ago Invoiced Amount`";}
elseif ($order=='sales_quarter0') {$order="`Agent Quarter To Day Acc Invoiced Amount`";}
