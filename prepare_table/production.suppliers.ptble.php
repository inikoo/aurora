...
$currency='';
$where='where true';
$table='`Supplier Production Dimension` PS left join   `Supplier Dimension` S  on (S.`Supplier Key`=`Supplier Production Supplier Key`) left join `Supplier Data`  D on (S.`Supplier Key`=D.`Supplier Key`)';
$group_by='';
$where_type='';
