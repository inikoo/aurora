...
$table='`Staff Dimension` SD left join `Company Position Staff Bridge` B on (B.`Staff Key`=SD.`Staff Key`) left join `Company Position Dimension` P on (P.`Company Position Key`=B.`Position Key`)  ';
$where=' where `Company Position Code`="PROD.O"  and `Staff Currently Working`="Yes" ';
