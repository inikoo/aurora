...
$where      = 'where  `Part Status` in ("In Use","Discontinuing") and `Part Products Web Status`="No Products" ';
...
`Part Valid From`,`Part Valid From`,`Part Active From`,`Part Main Image Key`,`Part Status`,`Part Package Weight`,
