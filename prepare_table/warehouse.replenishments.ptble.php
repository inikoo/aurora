...
$where
    = ' where `Can Pick`="Yes" and `Minimum Quantity` IS NOT NULL and   `Minimum Quantity`>=(`Quantity On Hand`) and (P.`Part Current On Hand Stock`-`Quantity On Hand`)>=`Minimum Quantity`  ';
