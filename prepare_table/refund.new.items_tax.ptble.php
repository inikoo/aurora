...
/*
 ...
 Created: 03-05-2019 10:08:53 GMT+2, Tranava , Slovakia
...
$fields
    = "
	OTF.`Product Key`,OTF.`Order Transaction Fact Key`,`Product Units Per Case`,`Product History Name`,`Product History Price`,`Product Currency`,OTF.`Product ID`,`Product History Code`,`Order Quantity`,`Order Bonus Quantity`,`Product Availability`,`Product History XHTML Short Description`,`Order Transaction Amount`,`Transaction Tax Rate`,`Product Tariff Code`,
