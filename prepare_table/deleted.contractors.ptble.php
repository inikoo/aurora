...
$sql_totals="select count(Distinct SD.`Staff Deleted Key`) as num from $table  $where  ";

$fields="`Staff Deleted Key`,`Staff Deleted Alias`,`Staff Deleted Name`,`Staff Deleted ID`,`Staff Deleted Date`";
?>
