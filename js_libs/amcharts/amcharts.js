    ...
    d.AxisBase = d.Class({
        ...
        handleMouse: function (a, b, c) {
            ...
            if (0 < this.gridCountR)for (B - 5 - k > this.autoRotateCount && !isNaN(this.autoRotateAngle) && (this.labelRotationR = this.autoRotateAngle), a = k; a <= B; a++) {
                ...
                this.pushAxisItem(m);
                m = l = p;
                if (!isNaN(v))for (h = 1; h < u; h += v)this.gridAlpha = this.minorGridAlpha, f = p + x * h, f = d.resetDateToMin(new Date(f), A, v, t).getTime(), f = new this.axisItemRenderer(this, (f - this.startTime) *
    ...
    d.ValueAxis = d.Class({
        inherits: d.AxisBase, construct: function (a) {
            ...
            if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max)e = !0; else {
                ...
                if (this.autoGridCount || 0 !== this.gridCount)if ("date" == c)this.generateDFObject(), this.timeDifference = this.max - this.min,
                    ...
                    if (t == this.baseValue && "radar" != a.type) {
                        ...
                        D && (u = d.fitToBounds(2 * this.gridAlpha, 0, 1), isNaN(this.zeroGridAlpha) ||
                        (u = this.zeroGridAlpha), u = d.line(a.container, D, C, this.gridColor, u, 1, this.dashLength), u.translate(this.x, this.y), this.grid0 = u, a.axesSet.push(u), u.toBack(), d.setCN(a, u, this.bcn + "zero-grid-" + this.id), d.setCN(a, u, this.bcn + "zero-grid"))
                    }
            ...
            if (f)return !0 === this.logarithmic && (e = -1 != String(a).indexOf("e") ? !0 : !1), this.useScientificNotation && (e = !0), this.usePrefixes && (e = !1), e ? (c = -1 == String(a).indexOf("e") ? a.toExponential(15) : String(a), e = c.split("e"), c = Number(e[0]), e = Number(e[1]), c = d.roundTo(c, 14), b || isNaN(this.precision) || (c = d.roundTo(c, this.precision)), 10 == c && (c = 1, e += 1), c = c + "e" + e, 0 === a &&
            (c = "0"), 1 == a && (c = "1")) : (h && (e = String(a).split("."), e[1] ? (f.precision = e[1].length, 0 > c && (f.precision = Math.abs(c)), b && 1 < a && (f.precision = 0), b || isNaN(this.precision) || (f.precision = this.precision)) : f.precision = -1), c = this.usePrefixes ? d.addPrefix(a, g.prefixesOfBigNumbers, g.prefixesOfSmallNumbers, f, !b) : d.formatNumber(a, f, f.precision)), this.duration && (b && (f.precision = 0), c = d.formatDuration(a, this.duration, "", this.durationUnits, this.maxInterval, f)), "date" == this.type && (c = d.formatDate(new Date(a), this.currentDateFormat,
                g)), this.recalculateToPercents ? c += "%" : (b = this.unit) && (c = "left" == this.unitPosition ? b + c : c + b), this.labelFunction && (c = "date" == this.type ? this.labelFunction(c, new Date(a), this).toString() : this.labelFunction(a, c, this).toString()), c
            ...
            for (p = n; p <= l; p++) {
                ...
                for (q = 0; q < k.length; q++)if (n = k[q], n.hidden)n.newStack && (h[p] = NaN, e[p] = NaN); else if (m = n.type, n.chart == this.chart && n.valueAxis == this && a == m && n.stackable)if (m = this.data[p].axes[this.id].graphs[n.id], g = m.values.value, isNaN(g))n.newStack && (h[p] = NaN, e[p] = NaN); else {
                    ...
                    f[p] = d.roundTo(f[p], v);
                    y = n.fillToGraph;
                    r && y && (y = this.data[p].axes[this.id].graphs[y.id]) &&
            ...
            for (c = 0; c < b.length; c++) {
                ...
                if (e.valueAxis == this) {
                    ...
                    if (!isNaN(a.startTime) && (m = a.categoryAxis)) {
                        var n = m.minDuration(), n = new Date(a.startTime + n / 2), q = d.resetDateToMin(new Date(a.startTime),
                            m.minPeriod).getTime();
            ...
            this.logarithmic && (2 < Math.log(b) * Math.LOG10E - Math.log(a) * Math.LOG10E ? (this.minReal = this.min = Math.pow(10, Math.floor(Math.log(Math.abs(a)) * Math.LOG10E)), this.max = Math.pow(10, Math.ceil(Math.log(Math.abs(b)) * Math.LOG10E))) :
            ...
            this.logarithmic && (d = Math.log(d) * Math.LOG10E - Math.log(e) * Math.LOG10E, f = Math.pow(10,
                d * a + Math.log(e) * Math.LOG10E), g = Math.pow(10, d * b + Math.log(e) * Math.LOG10E));
            ...
            var b = this.axisWidth, c = this.stepWidth,
                e = this.reversed, d = this.rotate, f = this.min, g = this.minReal;
            ...
            if (this.synchronizeWith) {
                ...
                e && (this.min =
                    b * e, this.max = c * e, this.step = a * e, b = Math.abs(Math.log(Math.abs(Math.pow(10, Math.floor(Math.log(Math.abs(this.step)) * Math.LOG10E)))) * Math.LOG10E), this.maxDecCount = b = Math.round(b), this.draw())
            }
        }
    })
})();
...
(function () {
    ...
    d.RecItem = d.Class({
        construct: function (a, b, c, e, h, f, g, k, l, m, n, q) {
            ...
            g ? (void 0 !== g.id && (q = p.classNamePrefix + "-guide-" + g.id), Q = !0, isNaN(g.tickLength) || (B = g.tickLength), void 0 != g.lineColor && (J = g.lineColor), void 0 != g.color && (v = g.color), isNaN(g.lineAlpha) || (D = g.lineAlpha), isNaN(g.dashLength) || (H = g.dashLength), isNaN(g.lineThickness) || (C = g.lineThickness), !0 === g.inside && (I = !0, 0 < ea && (ea = 0)), isNaN(g.labelRotation) ||
            ...
            if ("H" == Oa) {
                if (0 <= b && b <= Aa + 1 && (0 < B && 0 < z && b + l <= Aa + 1 && (fa = d.line(y, [b + l, b + l], [0, B], A, z, C), x.push(fa)), 0 < D && (Ba = d.line(y, [b, b + va, b + va], [X, X + ma, ma], J, D, C, H), x.push(Ba))), w = 0, G = b, g && 90 == n && I && (G -= r), !1 === e ? (ha = "start", w = "bottom" == Z ? I ? w + B : w - B : I ? w - B : w + B, G += 3, 0 < h && (G += h / 2 - 3, ha = "middle"), 0 < n && (ha = "middle")) : ha = "middle", 1 == ga && 0 < O && !g && !m && da < Aa && (e = d.fitToBounds(b, 0, Aa), da = d.fitToBounds(da, 0, Aa), Y = e - da, 0 < Y && (Da = d.rect(y, Y, a.height, S, O), Da.translate(e - Y + va, ma), x.push(Da))), "bottom" == Z ? (w += X + r / 2 + ea, I ? (0 < n ? (w =
                        ...
                        ia / 2 * Math.cos(T)), ca && (f = 0, I && (f = ia / 2 * Math.cos(T)), r + f > Aa + 2 || 0 > r))ca.remove(), ca = null
            } else {
                ...
                w += r / 2;
                "right" == Z ? (G +=
                    va + Aa + ea, w += ma, I ? (f || (w -= r / 2 + 3), G = G - (B + 4) - aa) : (G += B + 4 + u, w -= 2, G += aa)) : I ? (G += B + 4 - ea, f || (w -= r / 2 + 3), g && (G += va, w += ma), G += aa) : (G += -B - u - 4 - 2 - ea, w -= 2, G -= aa);
            ...
            ca && (ca.attr({"text-anchor": ha}), ca.translate(G,
                w, NaN, !0), 0 !== n && ca.rotate(-n, a.chart.backgroundColor), a.allLabels.push(ca), this.label = ca, d.setCN(p, ca, a.bcn + "label"), d.setCN(p, ca, q, !0), g && d.setCN(p, ca, "guide"));
        ...
        construct: function (a) {
            ...
            if (a) {
                var b = this.chartDiv, c = a.offsetWidth, e = a.offsetHeight,
                    h = this.container, c = d.removePx(d.getStyle(a, "padding-left")), e = d.removePx(d.getStyle(a, "padding-right")), f = d.removePx(d.getStyle(a, "padding-top")), g = d.removePx(d.getStyle(a, "padding-bottom"));
                isNaN(c);
                isNaN(e);
                isNaN(f);
                isNaN(g);
                ...
                (c != this.previousWidth || e != this.previousHeight) && 0 < a && 0 < f && (b.style.width =
                    a + "px", b.style.height = f + "px", b.style.padding = 0, h && h.setSize(a, f), this.balloon = d.processObject(this.balloon, d.AmBalloon, this.theme));
...
(function () {
    ...
    d.AmGraph = d.Class({
        construct: function (a) {
            ...
            var va = this.categoryAxis, ma = this.baseCoord, Oa = this.negativeBase, Z = this.columnIndex, da = this.lineThickness, X = this.lineAlpha,
                Aa = this.lineColorR, ea = this.dashLength, fa = this.set, Ba, ha = this.getGradRotation(), T = this.chart.columnSpacing, Y = va.cellWidth, Da = (Y * k - r) / r;
            T > Da && (T = Da);
            ...
            if (!(I || "line" != g && "smoothedLine" != g && "step" != g || (1 == e.length && "step" != g && "none" == this.bullet && (this.bullet = "round", this.resetBullet = !0), !Qa && void 0 == Ja || m))) {
                ...
                t ? (ia = q, Pa = Math.abs(Lb - Ka), ub = q, vb = Math.abs(ib - Ka), hb = tb = 0, f.reversed ? (ca = 0, gb = Ka) : (ca = Ka, gb = 0)) : (Pa = n, ia = Math.abs(Lb - Ka), vb = n, ub = Math.abs(ib - Ka), gb = ca = 0, f.reversed ?
                    (hb = p, tb = Ka) : hb = Ka)
            }
            var La = Math.round;
            this.pmx = La(ca);
            ...
            for (L = Q; L <= ga; L++) {
                ...
                var R, P, K, ba, ja = NaN, E = NaN, F = NaN, N = NaN, M = NaN,
                    pa = NaN, qa = NaN, ra = NaN, sa = NaN, wa = NaN, Ea = NaN, ka = NaN, la = NaN, W = NaN, zb = NaN, Ab = NaN, ta = NaN, ua = void 0, Ma = wb, Va = Ya, Ga = Aa, Ca, xa, Bb = this.proCandlesticks, mb = this.topRadius, Fa = q - 1, oa = n - 1, bb = this.pattern;
                ...
                if (Ia) {
                    ...
                    if ("candlestick" == g || "ohlc" ==
                        g)W = Ia.close, Ab = Ia.low, qa = f.getCoordinate(Ab), zb = Ia.high, sa = f.getCoordinate(zb);
                    ta = Ia.open;
                    ...
                    switch (g) {
                        ...
                        case "smoothedLine":
                            if (isNaN(W))y || (this.drawSmoothedGraph(x, u, U, V), x = [], u = [], U = [], V = []); else {
                                ...
                                la = F;
                                !Ra || isNaN(M) || isNaN(N) || (U.push(N), V.push(M));
                                void 0 == w.lineColor && void 0 == w.fillColors && isNaN(w.dashLength) || (this.drawSmoothedGraph(x, u, U, V), x = [E], u = [F], U = [], V = [], !Ra || isNaN(M) || isNaN(N) || (U.push(N),
                                    V.push(M)), this.lineColorSwitched = w.lineColor, this.fillColorsSwitched = w.fillColors, this.dashLengthSwitched = w.dashLength);
                                w.gap && (this.drawSmoothedGraph(x, u, U, V), x = [], u = [], U = [], V = [])
                            }
                            break;
                        case "step":
                            if (!isNaN(W)) {
                                t ? (isNaN(A) || (x.push(A), u.push(F - ya)), u.push(F - ya), x.push(E), u.push(F + Ha), x.push(E), !Ra || isNaN(M) || isNaN(N) || (isNaN(B) || (U.push(B), V.push(M - ya)), U.push(N), V.push(M - ya), U.push(N), V.push(M + Ha))) : (isNaN(z) || (u.push(z), x.push(E - ya)), x.push(E - ya), u.push(F), x.push(E + Ha), u.push(F), !Ra || isNaN(M) ||
                                isNaN(N) || (isNaN(D) || (U.push(N - ya), V.push(D)), U.push(N - ya), V.push(M), U.push(N + Ha), V.push(M)));
                                A = E;
                                z = F;
                                B = N;
                                D = M;
                                ...
                                if ($a || void 0 != w.lineColor || void 0 != w.fillColors || !isNaN(w.dashLength) && L < ga) {
                                    ...
                                    this.dashLengthSwitched = w.dashLength;
                                    m && (Sa ?
                                        (this.lineColorSwitched = Aa, this.fillColorsSwitched = wb) : (this.lineColorSwitched = Ja, this.fillColorsSwitched = Qa))
                                }
                            ...
                            if (!isNaN(W)) {
                                ...
                                if (!(W < Qb && ob < Qb || W > Rb && ob > Rb)) {
                                    ...
                                    if (t) {
                                        ...
                                        (K = this.width * G.percentWidthValue / 100, R = ja - K / 2, wa = R + K / 2);
                                        K = d.roundTo(K, 2);
                                        ba = d.roundTo(ba, 2);
                                ...
                                if (ua) {
                                    ...
                                    P = d.roundTo(P, 2);
                                    xa.translate(R, P);
                                    (w.url || this.showHandOnHover) &&
                                    xa.setAttr("cursor", "pointer");
                                    if (!I) {
                                        ...
                                        void 0 !== this.tabIndex && xa.setAttr("tabindex",
                                            this.tabIndex)
                                    }
                        ...
                        case "candlestick":
                            if (!isNaN(ta) && !isNaN(W)) {
                                ...
                                ua && (xa = ua.set, w.columnGraphics = xa, fa.push(xa), xa.translate(R, P - da / 2), (w.url || this.showHandOnHover) && xa.setAttr("cursor",
                                    "pointer"), Xa && (fa.push(Xa), fa.push(cb)), I || (w.x = t ? P + K / 2 : R + K / 2, this.animateColumns(ua, L, E, N, F, M), this.addListeners(xa, w), void 0 !== this.tabIndex && xa.setAttr("tabindex", this.tabIndex)))
                            }
                            break;
                        case "ohlc":
                            if (!(isNaN(ta) || isNaN(zb) || isNaN(Ab) || isNaN(W))) {
                                ...
                                if (t) {
                                    ...
                                    "high" == l && (la = sa);
                                    "low" == l && (la = qa);
                                    var ka = E, qa = d.fitToBounds(qa, 0, Fa), sa = d.fitToBounds(sa, 0, Fa), Jb = E - k / 2, Jb = d.fitToBounds(Jb, 0, n), Ub = d.fitToBounds(E,
                                        0, n), Kb = E + k / 2, Kb = d.fitToBounds(Kb, 0, n);
            ...
            f && (b = f(a, b));
            if (void 0 !== b && "" !== b)return a = d.text(this.container, b, h, e.fontFamily, c), a.node.style.pointerEvents =
            ...
            if (1 < a.length) {
                ...
                v && (t = v);
                var v =
                    h.fillColorsR, y = h.fillColorsSwitched;
                y && (v = y);
                var x = h.dashLength;
                ...
                if (0 < g || 0 < A)if (p = a.join(";").split(";"), r = b.join(";").split(";"), q = k.type, "serial" == q || "radar" == q ? 0 < c.length ? (c.reverse(), e.reverse(),
            ...
            if (1 < a.length) {
                ...
                h.push(l);
                h.push(k);
                var m = this.lineAlpha, n = this.lineThickness, h = this.dashLength, q = this.fillAlphas, p = this.lineColorR,
                    t = this.fillColorsR, r = this.negativeLineColor, v = this.negativeFillColors, y = this.negativeFillAlphas, x = this.baseCoord, u = this.lineColorSwitched;
                u && (p = u);
                ...
                0 < q && (m = a.join(";").split(";"),
                    ...
                    a, this.bcn + "fill"), d.setCN(f, a, this.bcn + "fill-negative"), l.push(a.path));
                this.applyMask(l, k)
            }
            ...
            if (a) {
                ...
                if (g && g.enabled && this.showBalloon && !this.hidden) {
                    ...
                    m && "" !== m ? (e = f.getBalloonColor(this, a), g.drop || (g.pointerOrientation = b), b = a.x, h = a.y, f.rotate && (b = a.y, h = a.x), b += k, h += l, isNaN(b) || isNaN(h) ? this.hideBalloonReal() : (a = this.width, q = this.height, n && g.setBounds(k,
                        l, a + k, q + l), g.changeColor(e), g.setPosition(b, h), g.fixPrevious(), g.fixedPosition && (c = !1), !c && "radar" != f.type && (b < k || b > a + k || h < l - .5 || h > q + l) ? (g.showBalloon(m), g.hide(0)) : (g.followCursor(c), g.showBalloon(m)))) : (this.hideBalloonReal(), g.hide(), this.resizeBullet(a, e, h))
    ...
    d.ChartCursor = d.Class({
        construct: function (a) {
            ...
            if (!this.pan && this.enabled) {
                ...
                isNaN(this.mouse2X) && 0 < Math.abs(h) && 0 < Math.abs(f) &&
                (a = this.chart, b = d.rect(this.container, h, f, this.cursorColor, this.selectionAlpha), d.setCN(a, b, "cursor-selection"), b.width = h, b.height = f, b.translate(c, e), this.set.push(b), this.selection = b);
                this.updateFullLine()
            }
    ...
    d.SimpleChartScrollbar = d.Class({
        construct: function (a) {
                ...
                if (n.mouseIsOver) {
                    ...
                    if (this.resizingLeft) {
                        if (m)if (c = e, e = r, e < f && (e = f), isNaN(e) && (e = f), e > p + f && (e = p + f), a = !0 === b ? c - e : k + c - e, !isNaN(this.maxHeight) && a > this.maxHeight && (a = this.maxHeight, e = c), 0 > a)this.resizingRight = !0, this.resizingLeft = !1, g.setAttr("y", c + k - f); else {
                            ...
                            g.setAttr("y", e - f);
                            g.setAttr("height", a)
                        } else if (e = t, e < d && (e = d), isNaN(e) && (e = d), e > q + d && (e = q + d), a = !0 === b ? c - e : l + c - e, !isNaN(this.maxWidth) && a > this.maxWidth && (a = this.maxWidth,
                                e = c), 0 > a)this.resizingRight = !0, this.resizingLeft = !1, g.setAttr("x", c + l - d); else {
                            if (0 === a || isNaN(a))a = .1;
                            g.setAttr("x", e - d);
                            g.setAttr("width", a)
                        }
            ...
            if (b) {
                ...
                f && (this.clipAndUpdate(c, e, d, b), a && (this.updateOnReleaseOnly ||
        ...
        construct: function (a) {
            ...
            if (!isNaN(a)) {
                ...
                if (this.show) {
                    ...
                    var r = this.horizontalPadding, v = this.verticalPadding, y = this.pointerWidth, x = this.pointerOrientation, u = this.cornerRadius,
...
(function () {
    ...
    d.TrendLine = d.Class({
        construct: function (a) {
            ...
            var a = this;
            a.destroy();
            var b = a.chart, c = b.container, e, h, f, g, k = a.categoryAxis, l = a.initialDate, m = a.initialCategory, n = a.finalDate, q = a.finalCategory, p = a.valueAxis, t = a.valueAxisX, r = a.initialXValue, v = a.finalXValue, y = a.initialValue, x =
...
(function () {
    ...
    d.wedge = function (a, b, c, e, h, f, g, k, l, m, n, q, p, t) {
        ...
        if (0 < l) {
            ...
            l = a.path(" M" + D + "," + C + " L" + D + "," + (C + l) + " L" + J + "," + (u + l) + " L" + J + "," + u + " L" + D + "," + C + " Z", void 0,
        ...
        construct: function (a) {
            ...
            if (!1 !== a.visibleInLegend && !a.hideFromLegend) {
                ...
                if (e) {
                    e = a.type;
                    b.switchType = void 0;
                    if ("line" == e || "step" == e || "smoothedLine" == e || "ohlc" == e)l = n.set(), a.hidden || (f = a.lineColorR, k = a.bulletBorderColorR), p = d.line(n, [0, 2 * q], [q / 2, q / 2], f, a.lineAlpha,
                        a.lineThickness, a.dashLength), d.setCN(c, p, "graph-stroke"), l.push(p), a.bullet && (a.hidden || (f = a.bulletColorR), p = d.bullet(n, a.bullet, a.bulletSize, f, a.bulletAlpha, a.bulletBorderThickness, k, a.bulletBorderAlpha)) && (d.setCN(c, p, "graph-bullet"), p.translate(q + 1, q / 2), l.push(p)), r = 0, p = q, t = q / 3; else {
                        var v;
                        a.getGradRotation && (v = a.getGradRotation(), 0 === v && (v = 180));
                        p = a.fillColorsR;
                        !0 === a.hidden && (p = f);
                        if (l = b.createMarker("rectangle", p, a.fillAlphas, a.lineThickness, f, a.lineAlpha, v, l, a.dashLength))r = q, l.translate(r,
                            q / 2);
                        p = q
                    }
                    d.setCN(c, l, "graph-" + e);
