...
<settings>
  ...
  <data_sets> 
    ...
    <data_set did="0">
       ...
       <file_name>plot_data.csv.php?<?php echo $data_args?></file_name>
  ...
  <data_set_selector>
    ...
    <!-- [] ({title} {short} {description}) Sometimes data set title doesn't fit in the dropdown. If you set a
    value like {title} here, the roll-over balloon will display full title so users could read it. You can also
    display short title and description in this balloon -->
