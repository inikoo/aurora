        ...
        array(
            ...
            'fields'     => array(
                ...
                array(
                    ...
                    'render' => ($new ? false : (($object->get('Store Next Invoice Public ID Method') == 'Same Invoice ID' or $object->get('Store Refund Public ID Method') != 'Store Own Index') ? false : true)),
        ...
        $operations = array(
            ...
            'fields'     => array(
                ...
                array(
                    ...
                    'class'     => 'operation',
                    'value'     => '',
                    'label'     => '<i class="fa fa-fw fa-lock button" onClick="toggle_unlock_delete_object(this)" style="margin-right:20px"></i> <span  onClick="change_view(\'store/'.$object->id.'/website/new\')" class="create_object disabled">'._('Create website')
                        .' <i class="far fa-plus new_button link"></i></span>',
                    'reference' => '',
                    'type'      => 'operation'
                ),
            )
