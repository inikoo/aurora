        ...
        'fields' => array(
            array(
                ...
                'formatted_value' => '<span id="Email_Campaign_Abandoned_Cart_Type_Inactive_field" class=" '.($object->get('Email Campaign Abandoned Cart Type') == 'Inactive' ? 'valid' : 'very_discreet_on_hover')
                    ...
                    .($object->get('Email Campaign Abandoned Cart Type') == 'Inactive' ? 'fa-dot-circle' : 'fa-circle').'" aria-hidden="true"></i> <span class="">'
                    ...
                    .($object->get('Email Campaign Abandoned Cart Type') == 'Last_Updated' ? 'fa-dot-circle' : 'fa-circle').'" aria-hidden="true"></i> <span class="">'
