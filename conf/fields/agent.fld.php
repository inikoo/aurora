        ...
        'fields'     => array(
            ...
            array(
                ...
                'value'           => htmlspecialchars(
                    $object->get('Agent Company Name')
                ),
                'formatted_value' => $object->get('Company Name'),
                'label'           => ucfirst(
                    $object->get_field_label('Agent Company Name')
                ),
                'required'        => false,
                'type'            => 'value'
            ),
            ...
            array(
                ...
                'value'           => htmlspecialchars(
                    $object->get('Agent Main Contact Name')
                ),
                'formatted_value' => $object->get('Main Contact Name'),
                'label'           => ucfirst(
                    $object->get_field_label('Agent Main Contact Name')
                ),
                'required'        => true,
                'type'            => 'value'
            ),
    ...
    array(
        ...
        'fields'     => array(
            ...
            array(
                ...
                'label'             => ucfirst(
                    $object->get_field_label('Agent Main Plain Email')
                ),
    ...
    array(
        ...
        'fields'     => array(
            ...
            array(
                ...
                'label'           => ucfirst(
                        $object->get_field_label('Agent Main Plain Mobile')
                    ).($object->get('Agent Main Plain Mobile') != '' ? ($object->get('Agent Preferred Contact Number') == 'Mobile'
            ...
            array(
                ...
                'label'           => ucfirst(
                        $object->get_field_label('Agent Main Plain Telephone')
                    ).($object->get('Agent Main Plain Telephone') != '' ? ($object->get('Agent Preferred Contact Number') == 'Telephone'
                        ? ' <i  title="'._('Main contact number').'" class="fa fa-star button discreet"></i>'
            ...
            array(
                ...
                'formatted_value' => '',
                'label'           => ucfirst(
                        $object->get_field_label('Agent Other Telephone')).' <i onClick="set_this_as_main(this)" title="'._('Set as main telephone').'" class="far fa-star very_discreet button"></i>',
                'required'        => false,
                'type'            => 'ignore'
            ),
            ...
            array(
                ...
                'label'           => ucfirst(
                    $object->get_field_label('Agent Main Plain FAX')
                ),
                'invalid_msg'     => get_invalid_message('telephone'),
                'required'        => false,
                'type'            => 'value'
    ...
    array(
        ...
        'fields'     => array(
            ...
            array(
                ...
                'value'           => htmlspecialchars(
                    $object->get('Agent Contact Address')
                ),
                'formatted_value' => $object->get('Contact Address'),
                'label'           => ucfirst(
                    $object->get_field_label('Agent Contact Address')
                ),
    ...
    array(
        ...
        'fields'     => array(
            ...
            array(
                ...
                'label'           => ucfirst(
                    $object->get_field_label('Agent Default Incoterm')
                ),
                'required'        => false,
                'type'            => 'value'
            ),
    ...
    array(
        ...
        'fields'     => array(
            ...
            array(
                ...
                'label'           => ucfirst(
                    $object->get_field_label('Agent Default Port of Export')
                ),
                'required'        => false,
                'type'            => 'value'
            ),
            array(
                ...
                'label'           => ucfirst(
                    $object->get_field_label('Agent Default Port of Import')
                ),
                'required'        => false,
                'type'            => 'value'
            ),
    ...
    array(
        ...
        'fields'     => array(
            ...
            array(
                ...
                'value'           => $object->get(
                    'Agent Default PO Terms and Conditions'
                ),
            ...
            array(
                ...
                'label'           => ucfirst(
                    $object->get_field_label('Agent Show Warehouse TC in PO')
                ),
                'required'        => false,
                'type'            => 'value'
            ),
...
if (!$new) {
    ...
    /*
        if ($object->get('Agent User Key')) {
            ...
            $object_fields[]=array(
                'label'=>_('System user').' <i  onClick="change_view(\'users/'.$object->get('Agent User Key').'\')" class="fa fa-link link"></i>',
                'show_title'=>true,
                'class'=>'edit_fields',
                'fields'=>array(
        ...
        'fields'     => array(
            array(
                ...
                'label'     => '<i class="fa fa-fw fa-lock button" onClick="toggle_unlock_delete_object(this)" style="margin-right:20px"></i> <span data-data=\'{ "object": "'.$object->get_object_name(
                    ).'", "key":"'.$object->id.'"}\' onClick="delete_object(this)" class="delete_object disabled">'._("Delete agent").' <i class="far fa-trash-alt new_button link"></i></span>',
                'reference' => '',
                'type'      => 'operation'
            ),
