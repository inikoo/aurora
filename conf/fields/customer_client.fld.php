            ...
            array(
                ...
                'server_validation' => json_encode(
                    array(
                        ...
                        'parent'     => 'customer',
                        'parent_key' => $object->get('Customer Client Customer Key'),
    ...
    array(
        ...
        'fields'     => array(
            ...
            array(
                ...
                'label'           => ucfirst($object->get_field_label('Customer Client Main Plain Mobile')).($object->get('Customer Client Main Plain Mobile') != '' ? ($object->get('Customer Client Preferred Contact Number') == 'Mobile' ? ' <i class="fa yellow fa-star"></i>'
                        : ' <i onClick="set_this_as_main(this)" title="'._('Set as main contact number').'" class="fal fa-star very_discreet button"></i>') : ''),
