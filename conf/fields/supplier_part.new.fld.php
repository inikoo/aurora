...
$part_fields[] = array(
    ...
    'fields'     => array(
        ...
        array(
            ...
            'value'           => htmlspecialchars($part->get('Part Production Supply')),
            'formatted_value' => $part->get('Production Supply'),
            'label'           => ucfirst($part->get_field_label('Part Production Supply')),
            'required'        => false,
            'type'            => 'value'
        ),
