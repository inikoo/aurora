...
$export_edit_template_fields=array(
	...
	'supplier_part'=>array(
		...
		array('default_value'=>'', 'show_for_new'=>true, 'required'=>false, 'header'=>'Average delivery time (days)', 'name'=>'Average delivery time (days)', 'label'=>_('Average delivery time (days)'), 'checked'=>0),
		...
		array('default_value'=>'', 'show_for_new'=>true, 'required'=>false, 'header'=>'Part Unit RRP', 'name'=>'Part Part Unit RRP', 'label'=>_('Unit recommended RRP'), 'checked'=>0),
		array('default_value'=>'', 'show_for_new'=>true, 'required'=>false, 'header'=>'Unit recommended RRP', 'name'=>'Part Family Category Code', 'label'=>_('Part family'), 'checked'=>0),
		array('default_value'=>'', 'show_for_new'=>true, 'required'=>false, 'header'=>'Unit extra costs', 'name'=>'Part Part Unit Weight', 'label'=>_('Unit weight'), 'checked'=>0),
		...
		array('default_value'=>'', 'show_for_new'=>true, 'required'=>false, 'header'=>'SKO weigh', 'name'=>'Part Part Package Weight', 'label'=>_('SKO weigh'), 'checked'=>0),
