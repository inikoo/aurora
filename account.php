...
$smarty->assign('title', _('Account'));
$smarty->assign('css_files',$css_files);
$smarty->assign('js_files',$js_files);
if (!$user->can_view('account')) {

	$smarty->assign('scope', 'account');
...
$block_view=$_SESSION['state']['account']['block_view'];
...
$tipo_filter=$_SESSION['state']['account']['history']['f_field'];
$filter_value=$_SESSION['state']['account']['history']['f_value'];
