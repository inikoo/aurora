...
$object_fields=get_object_fields($customer, $db, $user, $smarty, array('show_full_label'=>false));
...
$default_country=($customer->get('Contact Address Country 2 Alpha Code')==''? $store->get('Store Home Country Code 2 Alpha'):$customer->get('Contact Address Country 2 Alpha Code'));
