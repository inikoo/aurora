	...
	array(
		...
		'fields'=>array(
			...
			array(
				...
				'formated_value'=>$manufacture_task->get('Task Code'),
			...
			array(
				...
				'formated_value'=>$manufacture_task->get('Task Name'),
		...
		'fields'=>array(
            ...
            */
			...
			array(
				...
				'edit'=>'option',
				'value'=>'On top salary',
				'formated_value'=>_('On top salary'),
...
$smarty->assign('object_name', preg_replace('/ /', '_', $manufacture_task->get_object_name()));
