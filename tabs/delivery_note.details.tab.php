	...
	array(
		...
		'fields'=>array(
			...
			array(
				'class'=>'locked',
				'id'=>'Cutomer',
				'value'=>$delivery_note->get('Delivery Note Customer Name').' (<span class="id">'.sprintf("%05d",$delivery_note->get('Delivery Note Customer Key')).'</span>)',
				'label'=>_('Customer')
			),array(
				'id'=>'Delivery_Note_Customer_Contact_Name',
				'value'=>$delivery_note->get('Delivery Note Customer Contact Name')  ,
