    ...
    array(
        ...
        'fields'     => array(
            ...
            array(
                ...
                'formatted_value' => $manufacture_task->get(
                    'Lower Target Per Hour'
                ),
                'label'           => ucfirst(
                    $manufacture_task->get_field_label(
                        'Manufacture Task Lower Target Per Hour'
            ...
            array(
                ...
                'formatted_value' => $manufacture_task->get(
                    'Operative Reward Allowance Type'
                ),
