...
if (!$is_cached) {
    ...
    if ($version == 1) {
     ...
     if(file_exists(INIKOO_ACCOUNT."_js/page_%05d.js")){
        $js_files[]  = sprintf(INIKOO_ACCOUNT."_js/page_%05d.js", $page->id);

        }
        
        if(file_exists(INIKOO_ACCOUNT."_css/page_%05d.css")){
  ...
  $smarty->assign('_css_files', $css_files);
    $smarty->assign('_js_files', $js_files);
