...
function orders_in_process(){
 ...
 if(isset( $_REQUEST['from']))
  ...
  if(isset( $_REQUEST['to']))
   ...
   $_SESSION['state']['report']['orders_in_process']['order']=$order;
      $_SESSION['state']['report']['orders_in_process']['order_dir']=$order_direction;
      $_SESSION['state']['report']['orders_in_process']['sf']=$start_from;
      $_SESSION['state']['report']['orders_in_process']['nr']=$number_results;
   ...
   if($date_interval['error']){
     ...
     $_SESSION['state']['report']['orders_in_process']['from']=$date_interval['from'];
     $_SESSION['state']['report']['orders_in_process']['to']=$date_interval['to'];
   }
