...
YAHOO.util.Connect.asyncRequest('POST','ar_sessions.php?tipo=update&keys=customer_categories-root_block_view&value='+this.id ,{});
}
...
function update_customer_category_history_elements() {
    ...
    var request = 'tipo=get_customer_category_history_elements&parent=store&parent_key=' + Dom.get('store_key').value;
...
YAHOO.util.Event.addListener(window, "load", function() {
    tables = new function() {
	    ...
	    var OrdersColumnDefs = [ 
								    {key:"branch_type", label:"", width:40,sortable:false,className:"aleft"}
								    //,{key:"public_view", label:"", width:16,sortable:false,className:"aleft"}
				    ...
				    ,{key:"label", label:"<?php echo _('Label')?>", width:350,sortable:true,className:"aleft",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_ASC}}
				    ...
				    ,{key:"subjects", label:"<?php echo _('Customers')?>", width:90,sortable:true,className:"aright",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_ASC}}
...
request="ar_categories.php?tipo=main_categories&parent=customer_categories&tableid=1&parent_key="+Dom.get('store_key').value;
//alert(request)
		...
		fields: [
			"code","label","children","subjects","percentage_assigned",'branch_type','public_view'
			 ]};
						     ...
						     this.dataSource1, {
							   renderLoopSize: 50,generateRequest : myRequestBuilder
								       ,paginator : new YAHOO.widget.Paginator({
									      rowsPerPage:<?php echo$_SESSION['state']['customer_categories']['main_categories']['nr']?>,containers : 'paginator1', 
								     ...
								     ,sortedBy : {
									 key: "<?php echo$_SESSION['state']['customer_categories']['main_categories']['order']?>",
									 dir: "<?php echo$_SESSION['state']['customer_categories']['main_categories']['order_dir']?>"
								     }
							   ,dynamicData : true
	    ...
	    this.table1.filter={key:'<?php echo$_SESSION['state']['customer_categories']['main_categories']['f_field']?>',value:'<?php echo$_SESSION['state']['customer_categories']['main_categories']['f_value']?>'};
 ...
 var tableid=2; // Change if you have more the 1 table
	    ...
	    var CustomersColumnDefs = [
				      ...
				      ,{key:"time", label:"<?php echo _('Time')?>",className:"aleft",width:90}
		...
		request="ar_history.php?tipo=customer_categories&parent=store&parent_key="+Dom.get('store_key').value+"&tableid=2";
		//alert(request)
