...
YAHOO.util.Connect.asyncRequest('POST','ar_sessions.php?tipo=update&keys=invoice_categories-root_block_view&value='+this.id ,{});
}
...
function update_invoice_category_history_elements() {
    ...
    var request = 'tipo=get_invoice_category_history_elements&parent=store&parent_key=' + Dom.get('store_key').value;
...
YAHOO.util.Event.addListener(window, "load", function() {
    tables = new function() {
	    ...
	    var OrdersColumnDefs = [ 
				  ...
				  ,{key:"subjects", label:"<?php echo _('Invoices')?>", width:90,sortable:true,className:"aright",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_ASC}}
...
request="ar_categories.php?tipo=main_categories&parent=invoice_categories&tableid=1&parent_key="+Dom.get('store_key').value;
//alert(request)
						     ...
						     this.dataSource1, {
							   renderLoopSize: 50,generateRequest : myRequestBuilder
								       ,paginator : new YAHOO.widget.Paginator({
									      rowsPerPage:<?php echo$_SESSION['state']['invoice_categories']['main_categories']['nr']?>,containers : 'paginator1', 
								     ...
								     ,sortedBy : {
									 key: "<?php echo$_SESSION['state']['invoice_categories']['main_categories']['order']?>",
									 dir: "<?php echo$_SESSION['state']['invoice_categories']['main_categories']['order_dir']?>"
								     }
							   ,dynamicData : true
	    ...
	    this.table1.filter={key:'<?php echo$_SESSION['state']['invoice_categories']['main_categories']['f_field']?>',value:'<?php echo$_SESSION['state']['invoice_categories']['main_categories']['f_value']?>'};
 ...
 var tableid=2; // Change if you have more the 1 table
		...
		request="ar_history.php?tipo=invoice_categories&parent=store&parent_key="+Dom.get('store_key').value+"&tableid=2";
		//alert(request)
