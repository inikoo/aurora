    ...
    switch ($type) {
        ...
        case 'bigint_unsigned':
            $messages = array(
                ...
                'negative'    => _('Value has to be a positive'),
                'too_big'     => sprintf(
                    _('The maximum value is %s'), '18446744073709551615'
                ),
                'empty'       => _("Value can't be empty"),
            );
            break;
        ...
        case 'mediumint_unsigned':
            $messages = array(
                ...
                'negative'    => sprintf(_('Value has to be a positive')),
                'too_big'     => sprintf(
                    _('The maximum value is %s'), '16777215'
                ),
                'empty'       => _("Value can't be empty"),
        ...
        case 'bigint':
            $messages = array(
                ...
                'negative'    => sprintf(_('Value has to be a positive')),
                'too_big'     => sprintf(
                    _('The maximum value is %s'), '9223372036854775807'
                ),
                'too_small'   => sprintf(
                    _('The minimum value is %s'), '-9223372036854775808'
                ),
                'empty'       => _("Value can't be empty"),
        ...
        case 'int':
            $messages = array(
                ...
                'negative'    => sprintf(_('Value has to be a positive')),
                'too_big'     => sprintf(
                    _('The maximum value is %s'), '2147483647'
                ),
                'too_small'   => sprintf(
                    _('The minimum value is %s'), '-2147483648'
                ),
                'empty'       => _("Value can't be empty"),
        ...
        case 'mediumint':
            $messages = array(
                ...
                'negative'    => sprintf(_('Value has to be a positive')),
                'too_big'     => sprintf(
                    _('The maximum value is %s'), '8388607'
                ),
                'too_small'   => sprintf(
                    _('The minimum value is %s'), '-8388608'
                ),
                'empty'       => _("Value can't be empty"),
        ...
        case 'smallint':
            $messages = array(
                ...
                'too_small'   => sprintf(
                    _('The minimum value is %s'), '-32768'
                ),
                'empty'       => _("Value can't be empty"),
        ...
        case 'password':
            $messages = array(
                ...
                'short'   => sprintf(
                    _('Password has to be at least %d characters'), 6
                ),
            );
            break;
        ...
        case 'pin':
            $messages = array(
                'invalid' => _('Invalid value'),
                'short'   => sprintf(
                    _('PIN has to be at least %d characters'), 4
                ),
            );
            break;
        case 'handle':
            $messages = array(
                'invalid' => _('Invalid value'),
                'short'   => sprintf(
                    _('Value has to be at least %d characters'), 4
                ),
            );
            break;
        case 'pin_paranoid':
        ...
        case 'address':
            $messages = array(
                ...
                'missing_addressLine1' => _(
                    'Please provide the address first line'
                ),
