...
$modules=array(
		...
		'sections'=>array(
			...
			'delivery_note'=>array('type'=>'object',
				'tabs'=>array(
					...
					'delivery_note.history'=>array('label'=>_('History'), 'icon'=>'road'),
					'delivery_note.orders'=>array('label'=>_('Orders'), 'icon'=>'shopping-cart'),
					'delivery_note.invoices'=>array('label'=>_('Invoices'), 'icon'=>'file-text-o'),
				)
			...
			'invoice'=>array('type'=>'object',
				'tabs'=>array(
					...
					'invoice.history'=>array('label'=>_('History'), 'icon'=>'road'),
	...
	'invoices'=>array(
		...
		'sections'=>array(
			...
			'invoices'=>array('type'=>'navigation', 'label'=>_('Invoices'), 'icon'=>'file-text-o', 'reference'=>'invoices/%d',
				'tabs'=>array(
					'invoices'=>array('label'=>_('Invoices'), 'icon'=>'file-text-o'),
				)
			),
	...
	'suppliers'=>array(
		...
		'sections'=>array(
            ...
            */
			...
			'agent.new'=>array('type'=>'new_object',
				'tabs'=>array(
					'agent.new'=>array('label'=>_('New agent')),
		...
		'sections'=>array(
			...
			'barcode'=>array(
				...
				'tabs'=>array(
					...
					'barcode.history'=>array('label'=>_('History'), 'icon'=>'road'),
			...
			'part.image'=>array('type'=>'object',
				...
				'tabs'=>array(
					...
					'part.image.history'=>array('label'=>_('History/Notes'), 'icon'=>'road'),
