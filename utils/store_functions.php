...
function formatted_rrp($data, $options = false) {
    ...
    if (isset($options['show_unit'])) {
        $show_units = $options['show_unit'];
    }
    ...
    $rrp = money(
        $data['Product RRP'] / $data['Product Units Per Case'], $data['Product Currency'], $locale
    );
    if ($locale == "de_DE") {
...
function formatted_price($data) {
    ...
    $price          = money(
        $data['Product Price'], $data['Product Currency'], $locale
    );
    $price_per_unit = money(
        $data['Product Price'] / $data['Product Units Per Case'], $data['Product Currency'], $locale
    );
