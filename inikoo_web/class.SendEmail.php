            ...
            */
            ...
            case 'plain':
                ...
                if (true) {
                    ...
                    $this->from_name=$data['from'];//getenv("USERNAME");
                    $this->from_address="requests@inikoo.com";//$row['Email Address'];
                    ...
                    $this->message_object->smtp_host='smtp.gmail.com';//$row['Outgoing Mail Sever'];
                    ...
                    */
                    ...
                    $this->message_object->smtp_user='requests@inikoo.com';//$row['Login'];

                    /* authentication password */
                    $this->message_object->smtp_password='NKcyvqzoH2';//$row['Password'];
            ...
            case 'HTML Template':
                ...
                */
                ...
                if (true) {
                     ...
                     * or smtp.gmail.com for Gmail
                     * or smtp.live.com for Hotmail */
                    $this->message_object->smtp_host='smtp.gmail.com';//$row['Outgoing Mail Server'];
