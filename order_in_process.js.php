	...
	//alert(request)
	 ...
	 // alert("ar_edit_orders.php?tipo=transactions_to_process&tid=0&sf=0&f_value=&display="+Dom.get('products_display_type').value)
       ...
       var tableid=2; 
		...
		request="ar_history.php?tipo=customer_history&parent=customer&parent_key="+Dom.get('customer_key').value+"&sf=0&tid="+tableid
		//alert(request)
		...
		metaFields: {
		    ...
		    this.table2 = new YAHOO.widget.DataTable(tableDivEL, ColumnDefs,
								 ...
								 formatRow: myRowFormatter,
								     renderLoopSize: 5,generateRequest : myRequestBuilder
								       ,paginator : new YAHOO.widget.Paginator({
									      rowsPerPage    : <?php echo$_SESSION['state']['customer']['history']['nr']?>,containers : 'paginator2', 
		    ...
		    this.table2.filter={key:'<?php echo$_SESSION['state']['customer']['history']['f_field']?>',value:'<?php echo$_SESSION['state']['customer']['history']['f_value']?>'};
