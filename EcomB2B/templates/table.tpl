        ...
        <div style="position:absolute" class="export_dialog_container  ">
            ...
            <div class="export_dialog export_dialog_block hide">
                <table border=0 style="width:100%">
                    <tr class="no_border">
                        ...
                        <td class="export_button link" data-type="excel" onclick="export_table(this)" data-ar_url="/ar_web_export.php"><i class="fa fa-file-excel fa-fw"></i><span class="excel">Excel</span><span class="csv hide">CSV</span</td>
                    </tr>
            ...
            <div class="export_dialog_config export_dialog_block hide">
                ...
                <div class="export_type_options ">
                    ...
                    {if  isset($web_user)}
                    <span data-type="csv" onclick="change_export_as(this,'CSV');export_table(this)" data-ar_url="/ar_web_export.php" class=" button" title="{t}Export as CSV file{/t}"><i class="far fa-fw fa-file-csv"></i>CSV</span>
                        <a href="ar_web_data_feed.php?uid={$web_user->id}&token={$web_user->get('Website User Static API Hash')}&output=CSV&scope=portfolio_items" class="hide margin_left_20" style="cursor:pointer;font-size: x-small">{t}CSV data feed link{/t} <i class="fal fa-external-link padding_left_5"></i> </a>
                    {/if}
