    ...
    <div class="table_info">
        ...
        <div style="position:absolute" class="export_dialog_container  ">
            ...
            <div class="export_dialog_config export_dialog_block hide">
                ...
                <div class="export_type_options ">
                    <span data-type="excel" onclick="change_export_as(this,'Excel');export_table(this)" class="margin_right_20 button" title="{t}Export as spreadsheet{/t}"><i
                                class="far fa-fw fa-file-excel"></i>Excel</span>
                    <span data-type="csv" onclick="change_export_as(this,'Excel')" export_table(this)" class=" button" title="{t}Export as CSV file{/t}"><i class="far fa-fw fa-file-csv"></i>CSV</span>
                </div>
