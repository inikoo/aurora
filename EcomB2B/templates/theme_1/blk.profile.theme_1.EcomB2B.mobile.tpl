                ...
                <div id="delivery_address_fields_container" class="{if $customer->get('Customer Delivery Address Link')=='Billing'}hide{/if}">
                    ...
                    <fieldset id="delivery_address_fields">
                        ...
                        <div id="delivery_sortingCode" class="row {if 'sortingCode'|in_array:$delivery_used_address_fields}{else}hide{/if}">
                            <section class="col col-6 ">
                                <label class="input">
                                    <label class="label">{if !empty($labels.address_sorting_code) and $labels.address_sorting_code!=''}{$labels.address_sorting_code}{else}{t}Sorting code{/t}{/if}</label>
                                    ...
                                    <input value="{$customer->get('Customer Delivery Address Sorting Code')}" type="text" name="sortingCode"
                                           ...
                                           placeholder="{if !empty($labels.address_sorting_code) and $labels.address_sorting_code!=''}{$labels.address_sorting_code}{else}{t}Sorting code{/t}{/if}">
                                    <b class="tooltip tooltip-bottom-right">{if !empty($labels.address_sorting_code) and $labels.address_sorting_code!=''}{$labels.address_sorting_code}{else}{t}Sorting code{/t}{/if}</b>
                                </label>
                            </section>
            ...
            {foreach from=$customer->get_orders_data() item=_order}
                {if $current_order_key!=$_order.key}
                    <tr>
                        ...
                        <td style="width: 55px">
                            <a target="_blank" href="ar_web_invoice.pdf.php?id={$_order.invoice_key}"><img class="button  {if !$_order.invoice_key}hide{/if}" style=";height:16px;position: relative;top:6px;padding: 0px 5px"
                                                                                                    src="/art/pdf.gif"></a>
                        </td>
                    </tr>
                {/if}
