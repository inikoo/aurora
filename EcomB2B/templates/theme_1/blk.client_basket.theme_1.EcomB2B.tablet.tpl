        ...
        <div class="one-half-responsive">
            ...
            <section style="border: none">
                <label class="textarea">
                    ...
                    <textarea id="special_instructions"  data-order_key="{$order->id}" rows="5" name="comment" placeholder="{$data._special_instructions}">{$order->get('Order Customer Message')}</textarea>
                </label>
            </section>
