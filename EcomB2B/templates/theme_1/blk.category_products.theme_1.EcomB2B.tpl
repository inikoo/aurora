                        ...
                        {if $logged_in}
                            ...
                            {else}
                                ...
                                {foreach from=$item.variants item=variant name=variant}
                                    <div id="ordering_variant_{$variant.id}" class="ccccc ordering_variant {if !$smarty.foreach.variant.first}hide{/if}" onclick="console.log('{$variant.label}', JSON.stringify({$variant}))">
