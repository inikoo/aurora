...
<head>
    ...
    {if $website->get('Website Code')=='AW.biz'}
        <!-- Cloudflare Web Analytics --><script defer src='https://static.cloudflareinsights.com/beacon.min.js' data-cf-beacon='{"token": "0403252eaa2a4a92a589447d8006afe8"}'></script><!-- End Cloudflare Web Analytics -->
    {/if}
    {/if}
