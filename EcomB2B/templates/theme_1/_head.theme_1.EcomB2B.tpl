...
<head>
    ...
    {if $smarty.server.SERVER_NAME!='ecom.bali' }
        ...
        <script>
            Sentry.init({
                dsn: 'https://bdeef00d9ed04614a5b3245c0ba178ec@sentry.io/1319896' ,
                release: "au-web@1.0"
...
{literal}
<script type="text/javascript">var rumMOKey='71ba1592c4709b90cc4a78003954b68c';(function(){if(window.performance && window.performance.timing && window.performance.navigation) {var site24x7_rum_beacon=document.createElement('script');site24x7_rum_beacon.async=true;site24x7_rum_beacon.setAttribute('src','//static.site24x7rum.com/beacon/site24x7rum-min.js?appKey='+rumMOKey);document.getElementsByTagName('head')[0].appendChild(site24x7_rum_beacon);}})(window)</script>
{/literal}
