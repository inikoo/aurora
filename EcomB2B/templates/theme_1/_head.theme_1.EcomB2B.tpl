...
<head>
    ...
    {elseif $website->get('Website Code')=='AC'}
        ...
        {if $logged_in}
            ...
            <script src="https://staging.awads.io/announcementr9I0jJ2Oy2.js?v=10&logged_in=true&json=https://delivery-staging.wowsbar.com/announcement" async type="text/javascript"></script>
        {else}
            <script>
                console.log('ag logout');
            </script>
            <script src="https://staging.awads.io/announcementr9I0jJ2Oy2.js?v=10&logged_in=false&json=https://delivery-staging.wowsbar.com/announcement" async type="text/javascript"></script>
        {/if}
    {/if}
