    ...
    <div class="content">
        ...
        <div class="one-third-responsive last-column">
            <table class="order_totals">
                ...
                <tr class="tax">
                    <td>{if !empty($labels._total_tax) }{$labels._total_tax}{else}{t}Tax{/t}{/if}<div class="tax_description" style="font-size: x-small">{$order->get('Tax Description')}</div></td>
...
<div style="z-index: 3001" class="address_form" >
    <form id="order_delivery_address_form" class="sky-form sky-form-modal">
        ...
        <footer>
            ...
            <a href="#" class="button button-secondary modal-closer">{if !empty($labels._close) and $labels._close!=''}{$labels._close}{else}{t}Close{/t}{/if}</a>
        </footer>
    </form>
</div>
<div style="z-index: 3001" class="address_form" >
        ...
        <fieldset id="order_invoice_address_fields" class=" " style="position:relative">
            ...
            <section id="order_invoice_addressLine1" class="{if 'addressLine1'|in_array:$invoice_used_address_fields}{else}hide{/if}">
                ...
                <label for="file" class="input">
                    ...
                    <b class="tooltip tooltip-bottom-right">{if !empty($labels.address_addressLine1) and $labels.address_addressLine1!=''}{$labels.address_addressLine1}{else}{t}Address Line 1{/t}{/if}</b>
                </label>
            </section>
