...
<div >
    ...
    <div class="container  text_blocks  text_template_21">
        ...
        <div class="text_block ">
            ...
            <div style="margin-bottom: 10px;border-bottom: 1px solid #eee;width: 90%;">
                ...
                <span style="">{t}Invoice{/t} <a  target="_blank" href="invoice.pdf.php?id={$order->get('Order Invoice Key')}"><img style="margin-left: 10px" src="art/pdf.gif"></a></span>
                {/if}
            </div>
    ...
    <div class="container order">
        {include file="theme_1/_order_items.theme_1.tpl" edit=false hide_title=true }
    </div>
</div>
