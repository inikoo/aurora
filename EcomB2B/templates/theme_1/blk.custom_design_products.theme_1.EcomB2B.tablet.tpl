...
<div style="display: flex;padding: 10px 0px 2px 0px">
    <a style="flex-grow:1;color:#888" href="customer_discounts.sys"><div style="flex-grow:1;text-align: center;border-bottom: 1px solid #ccc;padding-bottom: 5px"><i class="fa fa-user-tag"></i> {t}Customer discounts{/t}</div></a>
