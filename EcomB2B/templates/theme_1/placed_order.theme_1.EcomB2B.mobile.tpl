    ...
    <table class="order_totals">
        ...
        <tr class="order_charges_container {if $placed_order->get('Order Charges Net Amount')==0 }very_discreet{/if}">
            <td>
                ...
                {if !empty($labels._items_charges)}{$labels._items_charges}{else}{t}Charges{/t}{/if}  <i class=" order_charges_info fa fa-info-circle padding_left_5  info {if $placed_order->get('Order Charges Net Amount')==0 }hide{/if}"    style="color: #007fff;" onclick="show_charges_info()" ></i>
            </td>
