            ...
            <div class="gallery" style="display: flex;max-width: 330px;flex-wrap: wrap " itemscope itemtype="http://schema.org/ImageGallery">
                ...
                {if $product->get('Video ID')}
                    ...
                    <div style="width: 100px; margin: 0px 5px 5px  5px" class=" tw-relative tw-isolate">
                        ...
                        <div onclick="show_video()" style="cursor:pointer"  class="tw-absolute tw-inset-0 tw-z-10"><i style="padding:10px;font-size:35px;color:green;--fa-seconday--opacity:.8;--fa-primary-opacity:1;--fa-primary-color:white" class="fad fa-play-circle"></i></div>
                    </div>
