...
<div class="reg_form">
    ...
    <form id="registration_form" class="{if $type=='company_fork'}hide{/if} sky-form">
        <header id="_title">{$data.labels._title}</header>
        ...
        {if !empty($settings.fu_key)}
            <footer>
                <div class="cf-turnstile" data-action="register_mobile" data-sitekey="{$settings.fu_key}"></div>
            </footer>
        {/if}
