...
<div class="header header-logo-center header-light">
    ...
    <a href="/" title=":)" class="header-logo" style="padding-left: 70px;margin: 0;margin-left: 60px;">{if isset($settings['header_text_mobile_website'])}{$settings['header_text_mobile_website']}{/if}</a>
