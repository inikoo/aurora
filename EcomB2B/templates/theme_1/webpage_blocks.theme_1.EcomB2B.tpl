...
<script type="module" src="../../js/vika_luigi.js?v=18&device_type=desktop&color1=4b5058&color2=957a65&color3=e87928&logged_in={if $logged_in}true{else}false{/if}"></script>
