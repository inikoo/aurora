...
<!--
 ...
 Created: 18 July 2017 at 16:59:51 CEST, Vienna, Austria
...
#header #trueHeader {
	background: {$primary_color};
	border-bottom: 3px solid {$primary_color_darker};
}
#header ul.nav>li>a.active {
...
.pritable .pacdetails.three {
	box-shadow: 0px -5px 0px {$primary_color};
}
...
.site_wrapper .cd-timeline-content h2 { color: {$primary_color}; font-weight: normal; margin-bottom: 0px;}
.site_wrapper .no-touch .cd-timeline-content .cd-read-more:hover { background-color: {$primary_color}; }
...
border-color: {$primary_color_lighter};
}
