    ...
    <div id="page-content" class="page-content">
        ...
        <div id="page-content-scroll" class="header-clear"><!--Enables this element to be scrolled -->
            <div class="menu-bar menu-bar-text">
                <a href="{$parent.code|strtolower}" class="menu-bar-text-1"><i class="fa fa-arrow-up"></i><em style="position: relative;left:-4px">{$parent.label}</em></a>
                <span class="menu-bar-title">{$category->get('Label')}</span>
            </div>
            ...
            {foreach from=$products item=product_data key=stack_index}
                ...
                <div class="store-item-list" >
                    <span >
                        ...
                        <a href="{$product->get('Code')|strtolower}" style="z-index: 10000"><img src="{$product->get('Image')}&r=600x375" alt="img"></a>
