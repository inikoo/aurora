...
<div id="block_{$key}" data-block_key="{$key}" data-client_key="{$customer_client->id}" block="{$data.type}" class="{$data.type}  {if !$data.show}hide{/if}" style="padding-bottom:{$bottom_margin}px">
    <div class="table_top" style="margin-top: 4px">
        <span class="title"><span class="Customer_Client_Name">{$customer_client->get('Customer Client Name')}</span>
    </div>
    ...
    <div class="client_showcase" style="padding-top:10px">
        ...
        <div class="data_container" >
            ...
            <div style="min-height:100px;float:left;width:28px">
                <i class="fa fa-fw fa-map-marker-alt"></i>
            </div>
            <div class="Customer_Client_Contact_Address" style="line-height: normal">
    ...
    <div style="display:flex;border-bottom:1px solid #ccc">
        <div style="flex-grow:1;font-style: italic;cursor: pointer;text-align: center" class="discreet small">
