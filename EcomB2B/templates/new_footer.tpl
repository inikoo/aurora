        ...
        <div class="tw-w-full tw-grid md:tw-grid-cols-4 tw-gap-4 md:tw-gap-8 tw-pt-2 tw-pb-4 md:tw-pb-6 tw-mb-4 md:tw-mb-10 tw-border-0 tw-border-b tw-border-solid tw-border-gray-700">
            <div class="tw-flex-1 tw-flex tw-items-center tw-justify-center md:tw-justify-start ">
                {if $wowsbar_footer_data.data.fieldValue.logo.source.original}
                    <img src="{$wowsbar_footer_data.data.fieldValue.logo.source.original}" alt="{$wowsbar_footer_data.data.fieldValue.logo.alt}" class="tw-h-auto tw-max-h-20 tw-w-auto tw-min-w-16">
