    ...
    <div id="footer_container" class="-tw-mx-2 md:tw-mx-0 tw-pb-24 tw-pt-4 md:tw-pt-8 md:tw-px-16">
        <div class="tw-w-full tw-flex tw-flex-col md:tw-flex-row tw-gap-4 md:tw-gap-8 tw-pt-2 tw-pb-4 md:tw-pb-6 tw-mb-4 md:tw-mb-10 tw-border-0 tw-border-b tw-border-solid tw-border-gray-700">
            ...
            <div class="tw-flex-1 tw-flex tw-gap-x-1.5 tw-justify-center md:tw-justify-start tw-items-center">
                <a href="https://api.whatsapp.com/send/?phone={$wowsbar_footer_data.data.fieldValue.whatsapp.number}&text={$wowsbar_footer_data.data.fieldValue.whatsapp.message}&type=phone_number" class="tw-flex tw-gap-x-2 tw-items-center">
                    ...
                    <div>
                        ...
                        <div class="tw-flex tw-flex-col tw-items-center tw-gap-y-6 tw-mt-12">
                            ...
                            {foreach from=$wowsbar_footer_data.data.fieldValue.paymentData.data item=block}
                                <img src="{$block.image}" alt="{$block.name}" class="tw-h-auto tw-max-h-6 md:tw-max-h-8 tw-max-w-full tw-w-fit">
                            {/foreach}
                        </div>
                    </div>
                {*
