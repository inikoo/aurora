...
<!--
 ...
 Created: 5 March 2017 at 13:09:37 GMT+8, Sanur, Bali, Indonesia
...
<head>
    <title>Aaika - Responsive MultiPurpose HTML5 Template</title>

    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge" />
    <meta name="keywords" content="" />
    <meta name="description" content="" />
    <link rel="shortcut icon" type="image/png" href="theme_1/images/favicon.png"/>

    <!-- Favicon -->
    <link rel="shortcut icon" href="theme_1/images/favicon.ico">
    ...
    <!-- simple line icons -->
    <link rel="stylesheet" type="text/css" href="theme_1/css/simpleline-icons/simple-line-icons.css" media="screen" />

    <!-- animations -->
    <link href="theme_1/js/animations/css/animations.min.css" rel="stylesheet" type="text/css" media="all" />
    ...
    <!--<link rel="stylesheet" href="theme_1/css/colors/blue.css" />-->
    <!--<link rel="stylesheet" href="theme_1/css/colors/green.css" />-->
    <!--<link rel="stylesheet" href="theme_1/css/colors/cyan.css" />-->
    <!--<link rel="stylesheet" href="theme_1/css/colors/orange.css" />-->
    <!--<link rel="stylesheet" href="theme_1/css/colors/lightblue.css" />-->
    <!--<link rel="stylesheet" href="theme_1/css/colors/pink.css" />-->
    <!--<link rel="stylesheet" href="theme_1/css/colors/purple.css" />-->
    <!--<link rel="stylesheet" href="theme_1/css/colors/bridge.css" />-->
    <!--<link rel="stylesheet" href="theme_1/css/colors/slate.css" />-->
    <!--<link rel="stylesheet" href="theme_1/css/colors/yellow.css" />-->
    <!--<link rel="stylesheet" href="theme_1/css/colors/darkred.css" />-->
  ...
  <link rel="stylesheet" href="theme_1/css/bg-patterns/pattern-eight.css" />
    ...
    <!--<link rel="stylesheet" href="theme_1/css/bg-patterns/pattern-five.css" />-->
    <!--<link rel="stylesheet" href="theme_1/css/bg-patterns/pattern-six.css" />-->
    <!--<link rel="stylesheet" href="theme_1/css/bg-patterns/pattern-seven.css" />-->
    <!--<link rel="stylesheet" href="theme_1/css/bg-patterns/pattern-eight.css" />-->
    <!--<link rel="stylesheet" href="theme_1/css/bg-patterns/pattern-nine.css" />-->
    <!--<link rel="stylesheet" href="theme_1/css/bg-patterns/pattern-ten.css" />-->
    <!--<link rel="stylesheet" href="theme_1/css/bg-patterns/pattern-eleven.css" />-->
    <!--<link rel="stylesheet" href="theme_1/css/bg-patterns/pattern-twelve.css" />-->
    <!--<link rel="stylesheet" href="theme_1/css/bg-patterns/pattern-thirteen.css" />-->
  ...
  <div class="wrapper_boxed">
      ...
      <div class="site_wrapper">
        ...
        <div class="content_fullwidth less">
            ...
            {include file="{$webpage->get('Webpage Template Filename')}"}
...
<!-- slide panel -->
<script type="text/javascript"  src="theme_1/js/slidepanel/slidepanel.js"></script>

<!-- mega menu -->
<script  src="theme_1/js/mainmenu/bootstrap.min.js"></script>
<script  src="theme_1/js/mainmenu/customeUI.js"></script>
