...
while ($row = $stmt->fetch()) {
    ...
    if($product->id) {
        ...
        $products[] = [
            ...
            'image_link_s'=>$website->get('Website URL').'/wi.php?id='.$product->get('Product Main Image Key').'&s=100x100',
            'image_link_m'=>$website->get('Website URL').'/wi.php?id='.$product->get('Product Main Image Key').'&s=200x200',
            'image_link_l'=>$website->get('Website URL').'/wi.php?id='.$product->get('Product Main Image Key').'&s=600x600',
