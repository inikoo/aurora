...
ALTER TABLE `Product Dimension` ADD `Product Barcode Type` ENUM( 'none', 'ean8', 'ean13', ' code11', 'code39', 'code128', 'codabar' ) NOT NULL DEFAULT 'ean13' AFTER `Product Code` ,ADD `Product Barcode Data Source` ENUM( 'ID', 'Key', 'Other' ) NOT NULL DEFAULT 'ID' AFTER `Product Barcode Type` ,ADD `Product Barcode Data` VARCHAR( 256 ) NULL AFTER `Product Barcode Data Source` ;
ALTER TABLE `Product Dimension` CHANGE `Product Barcode Type` `Product Barcode Type` ENUM( 'none', 'ean8', 'ean13', ' code11', 'code39', 'code128', 'codabar' ) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'code128';
DROP TABLE IF EXISTS `Table Dimension`;
CREATE TABLE `Table Dimension` (  `Table Key` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,  `Table Name` varchar(64) NOT NULL,  `Table Export Fields` text NOT NULL,  PRIMARY KEY (`Table Key`)) ENGINE=MyISAM AUTO_INCREMENT=11 DEFAULT CHARSET=utf8;
INSERT INTO `Table Dimension` VALUES (1,'customers','C.`Customer Key`|1,`Customer Name`|1,`Customer Main Contact Name`|1,`Customer Main Plain Email`|1,`Customer Address`|0,Customer Address Elements|0,`Customer Billing Address`|0,Customer Billing Address Elements|0,Customer Delivery Address|0,Customer Delivery Address Elements|0'),(2,'orders','`Order Public ID`|1,`Order Customer Name`|1,`Order Date`|1,O`rder Currency`|1,`Order Balance Total Amount`|1'),(3,'invoices','`Invoice Title`|1,`Invoice Public ID`|1,`Invoice Customer Name`|1,`Invoice Date`|1,`Invoice Currency`|1,`Invoice Total Net Amount`|1,`Invoice Total Tax Amount`|1'),(4,'dn','`Delivery Note ID`|1,`Delivery Note Customer Name`|1,`Delivery Note Date`|1,`Delivery Note Weight`|1'),(5,'parts','`Part SKU`|1,`Part Reference`|1,`Part Unit Description`|1,`Part Current Stock`|1'),(6,'stores','`Store Code`|1,`Store Name`|1'),(7,'departments','`Product Department Code`|1,`Product Department Name`|1'),(8,'families','`Product Family Code`|1,`Product Family Name`|1'),(9,'products','`Product ID`|1,`Product Code`|1,`Product Name`|1,`Product Price`|1'),(10,'part_stock_historic','`Date`|1,ISF.`Part SKU`|1,`Part Reference`|1,locations`|0,stock|1,value_at_cost|0,value_at_end_day|1,commercial_value|0');
ALTER TABLE `Product Dimension` CHANGE `Product Barcode Data Source` `Product Barcode Data Source` ENUM( 'ID', 'Code', 'Other' ) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'ID';

ALTER TABLE `Product Dimension` CHANGE `Product Barcode Type` `Product Barcode Type` ENUM( 'none', 'ean8', 'ean13', ' code11', 'code39', 'code128', 'codabar' ) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'none';
