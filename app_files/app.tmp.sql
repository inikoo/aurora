...
CREATE TABLE `Agent Dimension` (
  ...
  `Agent Products Origin` varchar(256) DEFAULT NULL,
  `Agent Code` varchar(16) NOT NULL,
  `Agent Name` varchar(255) DEFAULT NULL,
  `Agent File As` varchar(256) NOT NULL,
  ...
  `Agent Main Country` varchar(256) NOT NULL,
  ...
  `Agent Website` varchar(256) NOT NULL,
...
-- Dump completed on 2016-08-09 13:20:57
