...
ALTER TABLE `Product Dimension`  ADD `Product Month To Day Acc Margin` FLOAT NULL DEFAULT NULL AFTER `Product Year To Day Acc Margin`,  ADD `Product Week To Day Acc Margin` FLOAT NULL DEFAULT NULL AFTER `Product Monath To Day Acc Margin`;
