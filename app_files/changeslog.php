...
ALTER TABLE `Site Dimension` ADD `Site Show LinkedIn` ENUM( 'Yes', 'No' ) NOT NULL DEFAULT 'Yes' AFTER `Site Show Facebook` ,ADD `Site Show Skype` ENUM( 'Yes', 'No' ) NOT NULL DEFAULT 'Yes' AFTER `Site Show LinkedIn` ,ADD `Site Show Youtube` ENUM( 'Yes', 'No' ) NOT NULL DEFAULT 'Yes' AFTER `Site Show Skype` ,ADD `Site Show Flickr` ENUM( 'Yes', 'No' ) NOT NULL DEFAULT 'Yes' AFTER `Site Show Youtube` ,ADD `Site Show Blog` ENUM( 'Yes', 'No' ) NOT NULL DEFAULT 'Yes' AFTER `Site Show Flickr` ,ADD `Site Show Digg` ENUM( 'Yes', 'No' ) NOT NULL DEFAULT 'Yes' AFTER `Site Show Blog` ,ADD `Site Show Google` ENUM( 'Yes', 'No' ) NOT NULL DEFAULT 'Yes' AFTER `Site Show Digg` ,ADD `Site Show RSS` ENUM( 'Yes', 'No' ) NOT NULL DEFAULT 'Yes' AFTER `Site Show G+`;

ALTER TABLE `Site Dimension` CHANGE `Site Show Facebook` `Site Show Facebook` ENUM('Yes','No') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'No', CHANGE `Site Show LinkedIn` `Site Show LinkedIn` ENUM('Yes','No') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'No', CHANGE `Site Show Skype` `Site Show Skype` ENUM('Yes','No') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'No', CHANGE `Site Show Youtube` `Site Show Youtube` ENUM('Yes','No') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'No', CHANGE `Site Show Flickr` `Site Show Flickr` ENUM('Yes','No') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'No', CHANGE `Site Show Blog` `Site Show Blog` ENUM('Yes','No') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'No', CHANGE `Site Show Digg` `Site Show Digg` ENUM('Yes','No') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'No', CHANGE `Site Show Google` `Site Show Google` ENUM('Yes','No') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'No', CHANGE `Site Show RSS` `Site Show RSS` ENUM('Yes','No') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'No', CHANGE `Site Show Twitter` `Site Show Twitter` ENUM('Yes','No') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'No', CHANGE `Show Site Badges` `Show Site Badges` ENUM('Yes','No') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'No';