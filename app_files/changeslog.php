...
INSERT INTO `Table Dimension` VALUES (1,'ar_contacts','customers','Customer Name,Customer Main Plain Email'),(2,'ar_orders','orders','Order Public ID,Order Customer Name,Order Date,Order Currency,Order Invoiced Balance Total Amount'),(3,'ar_orders','invoices','Invoice Title,Invoice Public ID,Invoice Customer Name,Invoice Date,Invoice Currency,Invoice Total Net Amount,Invoice Total Tax Amount'),(4,'ar_orders','dn','Delivery Note ID,Delivery Note Customer Name,Delivery Note Date,Delivery Note Weight');
