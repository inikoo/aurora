ALTER TABLE `Store Data` ADD `Store Orders Packed Done Number` MEDIUMINT UNSIGNED NOT NULL DEFAULT '0' AFTER `Store Orders Packed Amount`, ADD `Store Orders Packed Done Amount` DECIMAL(12,2) NOT NULL DEFAULT '0' AFTER `Store Orders Packed Done Number`;
