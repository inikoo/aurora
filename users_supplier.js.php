								 ...
								 , {
								     renderLoopSize: 50,generateRequest : myRequestBuilder
								      ,paginator : new YAHOO.widget.Paginator({
									      rowsPerPage:<?php echo$_SESSION['state']['users']['supplier']['nr']?>,containers : 'paginator0', 
								     ...
								     ,sortedBy : {
									 key: "<?php echo$_SESSION['state']['users']['supplier']['order']?>",
									 dir: "<?php echo$_SESSION['state']['users']['supplier']['order_dir']?>"
								     },
								     dynamicData : true
