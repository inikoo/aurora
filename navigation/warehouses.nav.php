...
function get_locations_new_main_category_navigation($data, $smarty, $user, $db, $account) {
	...
	$left_buttons=array();
	$left_buttons[]=array('icon'=>'arrow-up', 'title'=>_('Categories'), 'reference'=>'warehouses/'.$data['parent_key'].'/categories', 'parent'=>'');
...
function get_locations_category_navigation($data, $smarty, $user, $db, $account) {
	...
	case 'category':
		...
		$up_button=array('icon'=>'arrow-up', 'title'=>_("Location's Categories"), 'reference'=>'warehouses/category/'.$parent_category->id);
	...
	case 'account':
		...
		$up_button=array('icon'=>'arrow-up', 'title'=>_("Locations's Categories"), 'reference'=>'warehouses/categories');
	...
	if ($prev_key) {
		$left_buttons[]=array('icon'=>'arrow-left', 'title'=>$prev_title, 'reference'=>'warehouses/category/'.$parent_categories.$prev_key);
	...
	if ($next_key) {
		$left_buttons[]=array('icon'=>'arrow-right', 'title'=>$next_title, 'reference'=>'warehouses/category/'.$parent_categories.$next_key);
	...
	$sections=get_sections('warehouses', $data['store']->id);
	$sections['categories']['selected']=true;
