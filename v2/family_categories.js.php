...
YAHOO.util.Connect.asyncRequest('POST','ar_sessions.php?tipo=update&keys=family_categories-root_block_view&value='+this.id ,{});
}
...
YAHOO.util.Event.addListener(window, "load", function() {
    tables = new function() {
	    ...
	    var OrdersColumnDefs = [ 
				    ...
				    ,{key:"subjects", label:"<?php echo _('Families')?>", width:90,sortable:true,className:"aright",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_ASC}}
					...
					,{key:"percentage_assigned", label:"<?php echo _('Assigned')?>", width:90,sortable:true,className:"aright",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_ASC}}
				     ...
				     request="ar_categories.php?tipo=main_categories&parent=family_categories&tableid=1&parent_key="+Dom.get('store_key').value;
						     ...
						     this.dataSource1, {
							   renderLoopSize: 50,generateRequest : myRequestBuilder
								       ,paginator : new YAHOO.widget.Paginator({
									      rowsPerPage:<?php echo$_SESSION['state']['family_categories']['main_categories']['nr']?>,containers : 'paginator1', 
								     ...
								     ,sortedBy : {
									 key: "<?php echo$_SESSION['state']['family_categories']['main_categories']['order']?>",
									 dir: "<?php echo$_SESSION['state']['family_categories']['main_categories']['order_dir']?>"
								     }
							   ,dynamicData : true
	    ...
	    this.table1.filter={key:'<?php echo$_SESSION['state']['family_categories']['main_categories']['f_field']?>',value:'<?php echo$_SESSION['state']['family_categories']['main_categories']['f_value']?>'};
 ...
 var tableid=2; // Change if you have more the 1 table
		...
		request="ar_history.php?tipo=family_categories&parent=store&parent_key="+Dom.get('store_id').value+"&tableid=2";
		//alert(request)
