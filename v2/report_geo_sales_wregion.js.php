	...
	//    alert("ar_contacts.php?tipo=customers&sf=0&where="+where);
	    ...
	    this.table1 = new YAHOO.widget.DataTable(tableDivEL, CustomersColumnDefs,
								 ...
								 , {
								     renderLoopSize: 50,generateRequest : myRequestBuilder
								       ,paginator : new YAHOO.widget.Paginator({
									      rowsPerPage    : <?php echo$_SESSION['state']['customers']['customers']['nr']?>,containers : 'paginator1', 
 									      pageReportTemplate : '(<?php echo _('Page')?> {currentPage} <?php echo _('of')?> {totalPages})',
									      previousPageLinkLabel : "<",
 									      nextPageLinkLabel : ">",
 									      firstPageLinkLabel :"<<",
	    ...
	    this.table1.view='<?php echo$_SESSION['state']['customers']['customers']['view']?>';

	    this.table1.filter={key:'<?php echo$_SESSION['state']['customers']['customers']['f_field']?>',value:'<?php echo$_SESSION['state']['customers']['customers']['f_value']?>'};
