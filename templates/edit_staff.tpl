...
<div id="bd">
	...
	<ul class="tabs" id="chooser_ul" style="clear:both">
		<li> <span class="item {if $edit=='description'}selected{/if}" id="description"> <span> {t}Staff{/t}</span></span></li>
		<li> <span class="item {if $edit=='user'}selected{/if}" id="user"> <span> {t}User{/t}</span></span></li>
	</ul>
	<div class="tabbed_container no_padding">
		<div class="edit_block" id="description_block" style="{if $edit!='description'}display:none{/if}">
			<div class="buttons small left tabs">
				<button class="item first {if $edit_description_block=='id'}selected{/if}" id="description_block_id" block_id="id">{t}Id{/t}</button> <button class="item  {if $edit_description_block=='contact'}selected{/if}" id="description_block_contact" block_id="contact">{t}Contact{/t}</button> <button class="item {if $edit_description_block=='position'}selected{/if}" id="description_block_position" block_id="position">{t}Employment details{/t}</button> 
			</div>
			<div class="tabs_base">
			</div>
		...
		<div class="edit_block" id="user_block" style="{if $edit!='user'}display:none{/if}">
		
			<div class="buttons small left tabs">
				<button class="item first {if $edit_description_block=='id'}selected{/if}" id="description_block_id" block_id="id">{t}User Info{/t}</button> 
				<button class="item  {if $edit_description_block=='contact'}selected{/if}" id="description_block_contact" block_id="contact">{t}Permisions{/t}</button> 
			</div>
			<div class="tabs_base">
