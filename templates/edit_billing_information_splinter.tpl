     ...
     <div style="height:25px;display:table-cell; vertical-align:bottom">
       ...
       close_if_reset=true 
       address_identifier='billing_' 
       address_type='Shop' 
       show_tel=true show_contact=true  
       address_function='Billing'  
       hide_type=true hide_description=true 
       show_form=false  
      ...
      <table>
       <tr id="tr_address_showcase">
		...
		<div class="address_buttons" id="billing_address_buttons0">
		  ...
		  <button id="billing_set_main0" style="float:left" class="hide  billing_set_main small_button small_button_edit"  onClick="change_main_address(0,{literal}{{/literal}type:'billing',prefix:'billing_',Subject:'Customer',subject_key:{$customer->get('Customer Key')}{literal}}{/literal})" >{t}Set as Main{/t}</button>
