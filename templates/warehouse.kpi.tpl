...
<div style="border-bottom:1px solid #ccc;padding:20px">
    ...
    <div class="unselectable button" onclick="change_view('warehouse/{$warehouse->id}/leakages')" style="border:1px solid #eee;padding:10px;font-size:150%;width:200px;float:left;"  ">{t}Leakage{/t} <i class="fa hide fa-play error fa-rotate-90" aria-hidden="true"></i> {$kpi.stock_leakage.down.amount}</div>
