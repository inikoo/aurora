...
<div style="border-bottom:1px solid #ccc;padding:20px">
    ...
    <div class="unselectable button " onclick="change_view('warehouse/{$warehouse->id}/leakages')" style="border:1px solid #eee;padding:10px;font-size:150%;float:left;"  ">{t}Missing stock{/t} <i class="fa  fa-play error fa-rotate-90" aria-hidden="true"></i> {$kpi.stock_leakage.stock_leakage_down_amount}</div>
