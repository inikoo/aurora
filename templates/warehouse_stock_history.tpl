...
<div id="bd">
	...
	<div style="clear:both">
		<h1 style="padding:10px 0 0 0 ;font-size:140%">
			<span style="font-weight:800">{t}Warehouse{/t} {$warehouse->get('Warehouse Name')}</span>
		</h1>
	</div>
	...
	<div id="block_stock_history" class="data_table" style="clear:both;">
		...
		<div>
			<span id="stock_history_type_day" style="float:right" class="table_type state_details {if $stock_history_type=='day'}selected{/if}">{t}Monthly{/t}</span> <span id="stock_history_type_week" style="float:right;margin-right:10px" class="table_type state_details {if $stock_history_type=='week'}selected{/if}">{t}Weekly{/t}</span> <span id="stock_history_type_day" style="float:right;margin-right:10px" class="table_type state_details {if $stock_history_type=='day'}selected{/if}">{t}Daily{/t}</span> 
		</div>
