...
<div id="bd" class="no_padding">
	...
	<input type="hidden" id="subject" value="report_sales_components" />
	...
	<div style="padding:0 20px">
		...
		<div class="top_page_menu">
			...
			<div class="buttons" style="float:left">
				<span class="main_title no_buttons">{t}Sales Components{/t}</span> 
			</div>
	...
	<div style="padding:0 20px">
		<div id="block_stores"  style="clear:both;margin:10px 0 40px 0;{if $block_view!='stores'}display:none{/if}">
