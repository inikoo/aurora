...
<div style="padding:0 20px">
	...
	<ul class="tabs" id="chooser_ul" style="clear:both;margin-top:10px">
		...
		<li> <span class="item {if $block_view=='departments'}selected{/if}" id="areas"> <span> {t}Departments{/t}</span></span></li>
		<li> <span class="item {if $block_view=='positions'}selected{/if}" id="areas"> <span> {t}Positions{/t}</span></span></li>
	</ul>
<div class="tabs_base">
	</div>
	
	<div style="padding:0 20px;margin-top:10px">
	<div id="block_staff" style="{if $block_view!='staff'}display:none{/if}">
