...
<style>
    ...
    .product_description_block:hover{
    ...
    #page_content .product_wrap,  #page_content .category_wrap{
        position: relative;
        float:left;
    ...
    #page_content  .wrap_to_center img {
    ...
    #page_content  .category_block{
        width:218px;
        height:218px;
        margin-bottom:20px;
    }

    #page_content  .category_showcase {
        border: 1px solid #ccc;
        background:#fff;
        padding:0px 0px 0px 0px;
    ...
    .page_break span.title{
        ...
        padding:0px;margin:0px;float:left;;padding-top:5px;position:relative;left:-20px;min-width:200px
