...
<div id="bd" style="padding:0px">
	<div style="padding:0 20px">
		<div class="branch">
			<span><a href="index.php"><img style="vertical-align:0px;margin-right:1px" src="art/icons/home.gif" alt="home" /></a>&rarr; &#9733; {t}Head Quarters{/t}</span> 
		</div>
		<div class="top_page_menu">
			<div class="buttons" style="float:right">
							<button style="{if !$user->can_edit('hq')}display:none{/if}" onclick="window.location='edit_hq.php'"><img src="art/icons/vcard_edit.png" alt=""> {t}Edit{/t}</button>  
