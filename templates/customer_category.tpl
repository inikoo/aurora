	...
	<div style="padding:0 20px">
		...
		<div class="top_page_menu">
			<div class="buttons" style="float:left">
				...
				<span class="main_title"> {t}Category{/t}: {$category->get('Category Label')} <span class="id">({$category->get('Category Code')})</span> {$category->get_icon()} <span id="user_view_icon">{$category->get_user_view_icon()}</span></span> 
			</div>
		...
		<div id="children_table" class="data_table">
			...
			<div class="clusters">
					<div class="buttons small left cluster">
						<button class="table_option {if $customers_view=='general'}selected{/if}" id="customers_general">{t}General{/t}</button> 
						<button style="{if $category->get('Is Category Field Other')=='No'}display:none{/if}" class="table_option {if $customers_view=='other_value'}selected{/if}" id="customers_other_value">{t}Other Category Value{/t}</button> 
						<button class="table_option {if $customers_view=='contact'}selected{/if}" id="customers_contact">{t}Contact{/t}</button>
						<button class="table_option {if $customers_view=='address'}selected{/if}" id="customers_address">{t}Address{/t}</button> 
						<button class="table_option {if $customers_view=='balance'}selected{/if}" id="customers_balance">{t}Balance{/t}</button> 
						<button class="table_option {if $customers_view=='rank'}selected{/if}" id="customers_rank">{t}Ranking{/t}</button> 
						<button class="table_option {if $customers_view=='weblog'}selected{/if}" id="customers_weblog">{t}WebLog{/t}</button> 
					</div>
					<div style="clear:both">
					</div>
				</div>
