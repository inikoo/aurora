<div id="edit_history_note_dialog"  class="hide textarea_dialog" object="{$state['object']}" key="{$state['key']}" history_key="">
<div class="note_type">
<div class="label">{t}Permanent{/t} <i onClick="note_type()"id="note_type" class="fa fa-check-square-o fw"></i></div>
</div>

<textarea id="history_note_value"></textarea><br>
<i id="history_note_close_button" class="fa fa-sign-out fa-flip-horizontal fw " onclick="close_history_note_dialog()"></i> 
