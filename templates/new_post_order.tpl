...
<div id="bd">
	...
	<div class="top_page_menu" style="border:none">
		<div class="buttons" style="float:left">
			<button onclick="window.location='order.php?id={$order->id}'"><img src="art/icons/door_out.png" alt="" /> {t}Order{/t}</button> 
		</div>
		<div class="buttons">
			<button id="cancel" class="negative">{t}Cancel Post Order{/t}</button> 
		</div>
		...
		<div style="width:400px;float:right">
			<table border="0" style="width:100%;width:100%,padding:0;margin:0;float:right;margin-left:0px">
				...
				<tr id="credit" style="{if $order_post_transactions_in_process.Credit.Distinct_Products==0}display:none;{/if};border-bottom:1px solid #ccc;margin-bottom:10px">
					<td>
					<div class="buttons small">
						<button id="save_credit">{t}Save Credit{/t}</button> 
					</div>
					</td>
					<td class="aright">{t}Credits Value{/t}:</td>
