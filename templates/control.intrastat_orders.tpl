...
<div style="padding:20px;border-bottom:1px solid #ccc" class="control_panel">
    ...
    <table class="intrastat_totals">
        ...
        <tr>
            <td>{t}Products{/t}</td>
            <td class="aright " ><span class=" intrastat_orders_total_products link" onclick="change_view('{$link_products}')"></span></td>
...
<script>
    ...
    function get_intrastat_orders_totals() {
        var request = "/ar_reports_tables.php?tipo=intrastat_orders_totals"
