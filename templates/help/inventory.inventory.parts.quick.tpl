...
<div class="item">
	<div class="question">
		<i class="fa fa-caret-right bullet fw"></i> {t}How to add new part?{/t} 
	</div>
...
<div class="item">
	<div class="question">
		<i class="fa fa-caret-right bullet fw"></i> {t}How to add parts in bulk?{/t} 
	</div>
	<div class="answer hide">
		<p>
			{t}Click in the <i class="fa fa-upload"></i> icon at the table header to upload a excel or a CSV file with the following fields{/t} — <i class="fa fa-file-excel-o"></i> <a title="{t}You can use this file as template{/t}" href="/upload_arrangement.php?object=part&parent=account&parent_key=1"> {t}template{/t}</a> — 
		</p>
		<ul>
							<li><b>{t}Supplier's code{/t}</b> <i>({t}required{/t})</i> [{t}string{/t}]</li>
			...
			<li><b>{t}Part barcode{/t}</b> <i>({t}optional{/t})</i> [12 or 13 digits] <i>{t}or{/t}</i> {t}NEXT for next available barcode{/t}</li>
