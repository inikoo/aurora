...
{include file='contacts_navigation.tpl'}
      ...
      <h2 style="clear:both">{t}New Parts List{/t} ({$warehouse->get('Warehouse Name')})</h2>
...
<span id="error_no_name" style="display:none">{t}Please specify a name{/t}.</span>
      <table >
	<form>
		<tr><td colspan="2"><b>{t}Product{/t}</b></td></tr>
      <tr>
        <td>{t}Parts created between{/t}:</td>
        <td>
            <input id="v_calpop3" type="text" class="text" size="11" maxlength="10" name="from" value=""/><img   id="part_created_from" class="calpop" src="art/icons/calendar_view_month.png" align="absbottom" alt=""   /> <span class="calpop">&rarr;</span> 
            <input id="v_calpop4" class="calpop"  size="11" maxlength="10"   type="text" class="text" size="8" name="to" value=""/><img   id="part_created_to" class="calpop_to" src="art/icons/calendar_view_month.png" align="absbottom" alt=""   />
            <div id="part_created_from_Container" style="position:absolute;display:none; z-index:2"></div>
            <div id="part_created_to_Container" style="display:none; z-index:2;position:absolute"></div>
        </td>        
      </tr>
<tr><td colspan="2"><b>{t}Destination country{/t}</b></td></tr> 
     <tr>
