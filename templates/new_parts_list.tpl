		...
		<table>
			...
			<tr>
				...
				<div style="margin-left:10px;display:inline" class="buttons small left">
					<button id="tariff_code_invalid">{t}Invalid Tariff Codes{/t}</button> <button id="tariff_code_valid">{t}Valid Tariff Codes{/t}</button> 
				</div>
				</td>
			</tr>
			<tr>
...
<div id="saving_form" style="padding:20px;width:890px;xtext-align:right">
...
<div style="padding:30px 40px;display:none" id="saving">
	{t}Saving list{/t} <img style="margin-left:20px;position:relative;top:5px " src="art/progressbar.gif" /> 
</div>
...
<div id="dialog_country_list">
	...
	<button id="dialog_country_list_european_union" >{t}European Union{/t}</button>
	<div style="clear:both"></div>
	</div>
	
		<div id="the_table" class="data_table" style="margin-top:10px">
