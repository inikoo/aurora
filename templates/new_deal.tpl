...
<div id="bd">
	...
	<div class="branch">
		...
		<span><a href="index.php"><img style="vertical-align:0px;margin-right:1px" src="art/icons/home.gif" alt="home" /></a>&rarr; {if $user->get_number_stores()>1}<a href="marketing_server.php">{t}Marketing{/t}</a> &rarr; {/if} <a href="marketing.php?store={$store->id}" title="{$campaign->get('Deal Campaign Name')}">{$store->get('Store Code')} {t}Marketing{/t}</a> &rarr; <a href="campaign.php?id={$campaign->id}" title="{$campaign->get('Deal Campaign Name')}">{$campaign->get('Deal Campaign Code')}</a> ({t}New Offer{/t})</span> 
		{elseif $scope_subject=='Family'} 
		<span><a href="index.php"><img style="vertical-align:0px;margin-right:1px" src="art/icons/home.gif" alt="home" /></a>&rarr; {if $user->get_number_stores()>1}<a href="stores.php">{t}Stores{/t}</a> &rarr; {/if}<a href="store.php?id={$store->id}" title="{$store->get('Store Name')}">{$store->get('Store Code')}</a> &rarr; <a id="department_branch_link" href="department.php?id={$department->id}" title="{$department->get('Product Department Name')}">{$department->get('Product Department Code')}</a> &rarr; <a href="family.php?id={$family->id}" title="{$family->get('Product Family Name')}">{$family->get('Product Family Code')}</a> ({t}New offer{/t})</span> 
		{elseif $scope_subject=='Department'} 
		<span><a href="index.php"><img style="vertical-align:0px;margin-right:1px" src="art/icons/home.gif" alt="home" /></a>&rarr; {if $user->get_number_stores()>1}<a href="stores.php">{t}Stores{/t}</a> &rarr; {/if}<a href="store.php?id={$store->id}" title="{$store->get('Store Name')}">{$store->get('Store Code')}</a> &rarr; <a id="department_branch_link" href="department.php?id={$department->id}" title="{$department->get('Product Department Name')}">{$department->get('Product Department Code')}</a> ({t}New offer{/t})</span> 
		{elseif $scope_subject=='Store'} 
		<span><a href="index.php"><img style="vertical-align:0px;margin-right:1px" src="art/icons/home.gif" alt="home" /></a>&rarr; <a href="stores.php"> &#8704; {t}Stores{/t}</a> &rarr; <a href="store.php?id={$store->id}" title="{$store->get('Store Name')}">{$store->get('Store Code')}</a> ({t}New offer{/t})</span> 
		{elseif $scope_subject=='Customer'} 
		<span><a href="index.php"><img style="vertical-align:0px;margin-right:1px" src="art/icons/home.gif" alt="home" /></a>&rarr; {if $user->get_number_stores()>1}<a href="customers_server.php">{t}Customers{/t}</a> &rarr; {/if}<a href="customers.php?store={$store->id}">{t}Customers{/t} ({$store->get('Store Code')})</a> &rarr; <a href="customer.php?id={$customer->id}">{$customer->get_formated_id()}</a> ({t}New offer{/t})</span> 
		{elseif $scope_subject=='Product'} 
	...
	<div class="top_page_menu">
		<div class="buttons" style="float:left">
			{if $scope_subject=='Store'} 
			<span class="main_title">{t}New Offer{/t} @ {t}Store{/t} <span class="id">{$store->get('Store Code')}</span></span> 
			{else if $scope_subject=='Department'} 
			<span class="main_title">{t}New Offer{/t} @ {t}Department{/t} <span class="id">{$department->get('Product Department Code')}</span></span> 
			{else if $scope_subject=='Family'} 
			<span class="main_title">{t}New Offer{/t} @ {t}Family{/t} <span class="id">{$family->get('Product Family Code')}</span></span> 
			{else if $scope_subject=='Product'} 
			<span class="main_title">{t}New Offer{/t} @ {t}Product{/t} <span class="id">{$product->get('Product Code')}</span></span> 
			{else if $scope_subject=='Customer'} 
			<span class="main_title">{t}New Offer{/t} @ {t}Customer{/t} <span class="id">{$customer->get('Customer Name')}</span></span> 
			{else if $scope_subject=='Campaign'} 
			<span class="main_title">{t}New Offer{/t} @ {t}Campaign{/t} <span class="id">{$campaign->get('Deal Campaign Code')}</span></span> 
	...
	<table class="edit" style="margin-top:20px;width:900px" border=0>
		<tbody id="trigger_options" style="{if $scope_subject!='Campaign'}display:none{/if}">
			...
			<tr class="space10" style="{if $scope_subject!='Campaign'}display:none{/if}">
				<td class="label" style="width:300px">{t}Trigger{/t}:</td>
			...
			<tr id="trigger_department_options" style="display:none">
				...
				<td>
					<div class="buttons small left">
						<span style="float:left;margin-right:10px" id="department_formated"></span> 
						<button style="" id="update_department">{t}Change department{/t}</button> 
					</div>
				</td>
			</tr>
			<tr id="trigger_family_options" style="display:none">
				...
				<td>
					<div class="buttons small left">
						<span style="float:left;margin-right:10px" id="family_formated"></span> 
						<button style="" id="update_family">{t}Change family{/t}</button> 
					</div>
				</td>
			</tr>
			<tr id="trigger_product_options" style="display:none">
				...
				<td>
					<div class="buttons small left">
						<span style="float:left;margin-right:10px" id="product_formated"></span> 
						<button style="" id="update_product">{t}Change product{/t}</button> 
					</div>
				</td>
			</tr>
			<tr id="trigger_customer_options" style="display:none">
				...
				<td>
					<div class="buttons small left">
						<span style="float:left;margin-right:10px" id="customer_formated"></span> 
						<button style="" id="update_customer">{t}Change customer{/t}</button> 
					</div>
				</td>
			</tr>	
		...
		<tbody id="campaign_options" style="{if $scope_subject=='Campaign'}display:none{/if}">
			...
			<tr class="space10" style="{if $scope_subject=='Campaign'}display:none{/if}">
				...
				<td style="text-align:left"> 
					...
					<div class="buttons small left">
						<span style="float:left;margin-right:10px" id="campaign_formated"></span> 
						<button style="display:none" id="update_campaign">{t}Change campaign{/t}</button> 
						<button style="margin-bottom:2px" id="select_campaign" alt_label="{t}Change campaign{/t}" label="{t}Select campaign{/t}" >{t}Select campaign{/t}</button> 
						<button style="" id="new_campaign">{t}New campaign{/t}</button> 
					</div>
				</td>
				<td></td>
		...
		<tr id="target_department_options" style="display:none">
			...
			<td>
				<div class="buttons small left">
					<span style="float:left;margin-right:10px" id="target_department_formated"></span> 
					<button style="" id="target_update_department">{t}Change department{/t}</button> 
				</div>
			</td>
		</tr>
		<tr id="target_family_options" style="display:none">
			...
			<td>
				<div class="buttons small left">
					<span style="float:left;margin-right:10px" id="target_family_formated"></span> 
					<button style="" id="target_update_family">{t}Change family{/t}</button> 
				</div>
			</td>
		</tr>
		<tr id="target_product_options" style="display:none">
			...
			<td>
				<div class="buttons small left">
					<span style="float:left;margin-right:10px" id="target_product_formated"></span> 
					<button style="" id="target_update_product">{t}Change product{/t}</button> 
				</div>
			</td>
		</tr>
		...
		<tbody id="voucher_options">
			<tr>
				...
				<td><input type=hidden id="voucher_code_type" value="Random">
					<div class="buttons small left">
						<button id="voucher_code_random" class="selected">{t}Generate Random Code{/t}</button>
						<button id="voucher_code_custome">{t}Custome Code{/t}</button>
					</div>
				</td>	
			...
			<tr id="voucher_code_tr" style="display: none">
				...
				<td style="text-align:left;width:400px"> 
					<div>
						<input style="text-align:left;width:60px" id="voucher_code" value='' ovalue=""> 
						<div id="voucher_code_Container">
						</div>
					</div>
				</td>
				<td> 
					<div style="float:left;width:180px" id="voucher_code_msg" class="edit_td_alert">
					</div>
				</td>
			...
			<tr>
				...
				<td><input type=hidden id="voucher_type" value="Public">
					<div class="buttons small left">
						<button id="voucher_type_public" class="selected" title="{t}One per customer{/t}">{t}Public{/t}</button>
						<button id="voucher_type_private" title="{t}Only applicable in the backend{/t}">{t}Private{/t}</button>
					</div>
				</td>	
		...
		<tbody id="amount_options" style="display:none">
			...
			<tr id="amount_tr" >
				...
				<td style="text-align:left;width:400px"> 
					<div>
						<input style="text-align:left;width:60px" id="amount" value='' ovalue=""> 
						<div id="amount_Container">
						</div>
					</div>
				</td>
				<td> 
					<div style="float:left;width:180px" id="amount_msg" class="edit_td_alert">
					</div>
				</td>
			</tr>
			<tr>
		...
		<tr id="if_order_more_tr" style="display:none">
			...
			<td style="text-align:left;width:400px"> 
				<div>
					<input style="text-align:left;width:60px" id="if_order_more" value='' ovalue=""> 
					<div id="if_order_more_Container">
					</div>
				</div>
			</td>
			<td> 
				<div style="float:left;width:180px" id="if_order_more_msg" class="edit_td_alert">
				</div>
			</td>
		</tr>
		<tr id="for_every_ordered_tr" style="display:none">
			...
			<td style="text-align:left;width:400px"> 
				<div>
					<input style="text-align:left;width:60px" id="for_every_ordered" value='' ovalue=""> 
					<div id="for_every_ordered_Container">
					</div>
				</div>
			</td>
			<td> 
				<div style="float:left;width:180px" id="for_every_ordered_msg" class="edit_td_alert">
				</div>
			</td>
		</tr>
		...
		<tr id="order_interval_tr" style="display:none">
			...
			<td style="text-align:left;width:400px"> 
				<div>
					<input style="text-align:left;width:60px" id="order_interval" value='' ovalue=""> 
					<div id="order_interval_Container">
					</div>
				</div>
			</td>
			<td> 
				<div style="float:left;width:180px" id="order_interval_msg" class="edit_td_alert">
				</div>
			</td>
		</tr>
		<tr id="order_number_tr" style="display:none">
			...
			<td style="text-align:left;width:400px"> 
				<div>
					<input style="text-align:left;width:60px" id="order_number" value='' ovalue=""> 
					<div id="order_number_Container">
					</div>
				</div>
			</td>
			<td> 
				<div style="float:left;width:180px" id="order_number_msg" class="edit_td_alert">
				</div>
			</td>
		</tr>
		<tr class="space15">
		...
		<tr id="target_bis_department_options" style="display:none">
			...
			<td>
				<div class="buttons small left">
					<span style="float:left;margin-right:10px" id="target_bis_department_formated"></span> 
					<button style="" id="target_bis_update_department">{t}Change department{/t}</button> 
				</div>
			</td>
		</tr>
		<tr id="target_bis_family_options" style="display:none">
			...
			<td>
				<div class="buttons small left">
					<span style="float:left;margin-right:10px" id="target_bis_family_formated"></span> 
					<button style="" id="target_bis_update_family">{t}Change family{/t}</button> 
				</div>
			</td>
		</tr>
		<tr id="target_bis_product_options" style="display:none">
			...
			<td>
				<div class="buttons small left">
					<span style="float:left;margin-right:10px" id="target_bis_product_formated"></span> 
					<button style="" id="target_bis_update_product">{t}Change product{/t}</button> 
				</div>
			</td>
		</tr>
		<tr id="clone_deal_options" style="display:none">
			...
			<td>
				<div class="buttons small left"><input type="hidden" id="clone_deal_key" id="">
					<span style="float:left;margin-right:10px" id="clone_deal_formated"></span> 
					<button style="" id="update_clone_deal">{t}Change deal{/t}</button> 
				</div>
			</td>
		</tr>
		...
		<tr id="percentage_off_tr">
			...
			<td style="text-align:left;width:400px"> 
				<div>
					<input style="text-align:left;width:60px" id="percentage_off" value='' ovalue=""> 
					<div id="percentage_off_Container">
					</div>
				</div>
			</td>
			<td> 
				<div style="float:left;width:180px" id="percentage_off_msg" class="edit_td_alert">
				</div>
			</td>
		</tr>
		...
		<tr id="get_same_free_tr">
			...
			<td style="text-align:left;width:400px"> 
				<div>
					<input style="text-align:left;width:60px" id="get_same_free" value='' ovalue=""> 
					<div id="get_same_free_Container">
					</div>
				</div>
			</td>
			<td> 
				<div style="float:left;width:180px" id="get_same_free_msg" class="edit_td_alert">
				</div>
			</td>
		</tr>
		...
		<tr style="height:50px">
			...
			<td style="text-align:left;"> 
				<div>
					<textarea style="text-align:left;width:300px;height:40px;resize:horizontal" id="deal_description" value='' ovalue=""></textarea> 
...
<div id="dialog_departments_list" style="position:absolute;left:-1000;top:0">
	<div class="splinter_cell" style="padding:10px 15px 10px 0;border:none">
		<div class="data_table">
			...
			{include file='table_splinter.tpl' table_id=101 filter_name=$filter_name101 filter_value=$filter_value101} 
...
<div id="dialog_families_list" style="position:absolute;left:-1000;top:0">
	<div class="splinter_cell" style="padding:10px 15px 10px 0;border:none">
		<div class="data_table">
			...
			{include file='table_splinter.tpl' table_id=102 filter_name=$filter_name102 filter_value=$filter_value102} 
...
<div id="dialog_products_list" style="position:absolute;left:-1000;top:0">
	<div class="splinter_cell" style="padding:10px 15px 10px 0;border:none">
		<div class="data_table">
			<span class="clean_table_title">{t}Products List{/t}</span> 
			{include file='table_splinter.tpl' table_id=103 filter_name=$filter_name103 filter_value=$filter_value103} 
...
<div id="dialog_customers_list" style="position:absolute;left:-1000;top:0">
	<div class="splinter_cell" style="padding:10px 15px 10px 0;border:none">
		<div class="data_table">
			...
			{include file='table_splinter.tpl' table_id=104 filter_name=$filter_name104 filter_value=$filter_value104} 
...
<div id="dialog_deals_list" style="position:absolute;left:-1000;top:0">
	<div class="splinter_cell" style="padding:10px 15px 10px 0;border:none">
		<div class="data_table">
			<span class="clean_table_title">{t}Deal List{/t}</span> 
			{include file='table_splinter.tpl' table_id=105 filter_name=$filter_name105 filter_value=$filter_value105} 
