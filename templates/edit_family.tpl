...
<textarea style="height:100px" id="description" name="description" rows="5" class='text' value="{$family->get('Product Family Description')}" ovalue="{$family->get('Product Family Description')}" />{$family->get('Product Family Description')}</textarea> 
		...
		<div class="edit_block" style="margin:0;padding:0 0px;{if $edit!='products'}display:none{/if}" id="d_products">
			...
			<div style="margin:0 0 10px 0;padding:10px;border:1px solid #ccc;padding-top:0;clear:both;display:none" id="new_product_dialog">
				...
				<div id="new_product_dialog_msg" style="display:none" class="messages_block">
				</div>
				<table class="edit" style="width:100%" border="1">
					<tbody style="display:none">
						<tr class="title">
							<td colspan="5">{t}Parts{/t}</td>
						</tr>
						<tr style="height:40px">
							<td style="vertical-align:middle" class="label">{t}Parts{/t}:</td>
							<td style="vertical-align:middle"> <span class="save" onclick="create_part()">Create Part</span> <span class="save" onclick="assing_part()">Assign Part</span> </td>
						</tr>
						<tr class="title">
							<td colspan="5">{t}Description{/t}</td>
						</tr>
					</tbody>
					<tr>
						<td style="width:160px" class="label">{t}Product Code{/t}:</td>
						<td> 
						<div>
							<input style="width:100%" id="product_code" changed="0" type='text' class='text' maxlength="16" value="{$family->get_next_product_code()}" ovalue="" />
					...
					<tr>
						...
						<td> 
						<div>
							<input style="width:100%" id="product_name" changed="0" type='text' maxlength="255" class='text' value="" ovalue="" />
					...
					<tr>
						...
						<td> 
						<div>
							<input style="width:100%" id="product_special_char" changed="0" type='text' maxlength="255" class='text' value="" ovalue="" />
							<div id="product_special_char_Container">
							</div>
						</div>
						</td>
					...
					<tr>
						<td class="label">{t}Units Per Case{/t}:</td>
						<td> 
						<div>
							<input id="product_units" changed="0" type='text' maxlength="255" class='text' value="1" ovalue="1" />
					...
					<tr>
						<td class="label">{t}Price Per Unit{/t}:</td>
						<td> 
						<div>
							<input id="product_price" changed="0" type='text' maxlength="255" class='text' value="" ovalue="" />
					...
					<tr>
						<td class="label">{t}Retail Price{/t}:</td>
						<td> 
						<div>
							<input id="product_retail_price" changed="0" type='text' maxlength="255" class='text' value="" ovalue="" />
							<div id="product_retail_price_Container">
							</div>
						</div>
						</td>
					...
					<tr style="display:none">
						<td class="label">{t}Type of Unit{/t}:</td>
						<td> 
...
<div id="dialog_new_product" style="padding:20px 20px 10px 20px ">
	...
	<div class="buttons">
		<button class="positive" onclick="window.location='associate_product_part.php?id={$family->id}'">{t}Manually{/t}</button> <button class="positive" onclick="window.location='import_csv.php?subject=family&subject_key={$family->id}'">{t}Import from file{/t}</button> <button class="negative" id="close_dialog_new_product">{t}Cancel{/t}</button> 
	</div>
</div>
