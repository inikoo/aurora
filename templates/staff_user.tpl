...
<div id="bd" style="padding:0">
	<div style="padding:0 20px">
		...
		<div class="branch">
			<span><a href="index.php"><img style="vertical-align:0px;margin-right:1px" src="art/icons/home.gif" alt="home" /></a> &rarr; <a href="users.php">{t}Users{/t}</a> &rarr; <a href="users_staff.php">{t}Staff Users{/t}</a> &rarr; {$user_class->get('User Alias')}</span> 
		</div>
