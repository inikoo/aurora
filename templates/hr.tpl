...
<div class="data_table" style="clear:both">
 ...
 <span  style="float:right;margin-left:20px;" class="table_type state_details"><a style="text-decoration:none" href="import_csv.php?subject=staff">{t}Import (CSV){/t}</a></span>
