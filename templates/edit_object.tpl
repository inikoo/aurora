...
<div id="editor_container_{$field.id}" class="hide">
		...
		<input id="{$field.id}_dropdown_select_label"  field="{$field.id}" scope="{$field.scope}" parent="{$field.parent}" parent_key="{$field.parent_key}" class="hide dropdown_select" value="{$field.formatted_value}" has_been_valid="0" placeholder="{if isset($field.placeholder)}{$field.placeholder}{/if}"/>
