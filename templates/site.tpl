		...
		<div id="block_pages" style="{if $block_view!='pages'}display:none;{/if}clear:both;margin:20px 0 40px 0">
			...
			<div class="clusters">
					<div class="buttons small left cluster">
						<button class="table_option {if $pages_view=='general'}selected{/if}" id="family_general">{t}Overview{/t}</button> <button class="table_option {if $pages_view=='stock'}selected{/if}" id="family_stock">{t}Visits{/t}</button> <button class="table_option {if $pages_view=='sales'}selected{/if}" id="family_sales" {if !$view_sales}style="display:none" {/if}>{t}Sales{/t}</button> 
					</div>
					<div id="family_period_options" class="buttons small left cluster" style="display:{if $pages_view!='sales' }none{else}block{/if};">
					...
					<div id="family_avg_options" class="buttons small left cluster" style="display:{if $pages_view!='sales' }none{else}block{/if};">
