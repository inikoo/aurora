...
<table width="100%" style="font-size: 9pt;" border="0">
	...
	<table width="100%">
		<tr>
			<tr>
				<td width="33%" style="color:#000;text-align: left;"> <small> {$purchase_order->get('Warehouse Company Name')}<br> {if $purchase_order->get('Warehouse VAT Number')!=''}{t}VAT Number{/t}: <b>{$purchase_order->get('Warehouse VAT Number')}</b><br>{/if} {if $purchase_order->get('Warehouse Company Number')!=''}{t}Registration Number{/t}: {$purchase_order->get('Warehouse Company Number')}{/if} </small></td>
				<td width="33%" style="color:#000;text-align: left;"> <small> {$purchase_order->get('Account Name')}</small></td>
				<td width="33%" style="color:#000;text-align: center">{t}Page{/t} {literal}{PAGENO}{/literal} {t}of{/t} {literal}{nbpg}{/literal}</td>
				<td width="34%" style="text-align: right;"> <small> {if $purchase_order->get('Warehouse Telephone')!=''}{$purchase_order->get('Warehouse Telephone')}<br>{/if} {if $purchase_order->get('Warehouse Email')!=''}{$purchase_order->get('Warehouse Email')}{/if} </small></td>
	...
	<table width="100%">
		<tr>
			...
			{t}Submitted{/t}: <b>{$purchase_order->get('Submitted Date')}</b> 
            </div>
			{/if}
