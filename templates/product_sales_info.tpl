...
<tbody class="hide">
        ...
        <tr class="top">
            ...
            <tr>
                ...
                <td class="timeseries_number_records_daily">{$object->get('OSF Records')}</td>
                <td class="timeseries_last_updated_daily">{$object->get('OSF Updated')}</td>
                <td>
...
<script>
    ...
    function create_sales_history( parent_key) {
        ...
        var request = '/ar_edit.php?tipo=create_osf&key=' + parent_key
        console.log(request)
