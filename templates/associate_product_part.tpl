...
<div id="bd">
	...
	<div class="top_page_menu">
		<div class="buttons">
			{if isset($next)}<img class="next" onmouseover="this.src='art/next_button.gif'" onmouseout="this.src='art/next_button.png'" title="{$next.title}" onclick="window.location='{$next.link}'" src="art/next_button.png" alt="{t}Next{/t}" />{/if} <button style="margin-left:0px" onclick="window.location='edit_family.php?id={$family->id}'"><img src="art/icons/door_out.png" alt="" /> {t}Cancel{/t}</button> <button style="display:none;margin-left:0px" onclick="window.location='associate_product_part.php?sku={$family->id}'"><img src="art/icons/brick_add.png" alt="" /> {t}Associate Product{/t}</button> 
		</div>
