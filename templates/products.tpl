...
<div id="bd" >
  ...
  <div id="top" class="top_bar">
	...
	<tr><td  {if $view=='general'}class="selected"{/if} id="general_view1" >{t}General{/t}</td>
	  {if $view_stock}<td {if $view=='stock'}class="selected"{/if}  id="stock_view1"  >{t}Stock{/t}</td>{/if}
	  {if $view_sales}<td  {if $view=='sales'}class="selected"{/if}  id="sales_view1"  >{t}Sales{/t}</td>{/if}
	</tr>
      </table>
    </div>
  ...
  <div class="data_table" style="clear:both;margin:0px 20px">
	...
	<div  class="clean_table_caption"  style="clear:both;">
	  ...
	  <div class="clean_table_controls" style="" ><div><span  style="margin:0 5px" id="paginator">{t}Showing all departments{/t}</span></div></div>
	</div>
