...
<div style="border:1px solid #ccc;padding:50px;width:650px">
<div id="campaign_div">{$msg}</div>

{literal}
	<STYLE>

	 .headerTop { background-color:red; border-top:0px solid #000000; border-bottom:1px solid #FFFFFF; text-align:center; }
