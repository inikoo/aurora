...
.labels td{
   font-size: 1.25mm;color:#000; text-align: center;vertical-align:bottom;padding:4px 5px 0px 5px;border-top:.1mm solid #000;font-family: Arial, "Helvetica Neue", Helvetica, sans-serif;}
.data td{
...
<div style="font-size:10.0mm;padding:3px 5px 2px 5px;font-family: Arial, "Helvetica Neue", Helvetica, sans-serif;">
    ...
    <table style="margin-top:.3mm;width: 100%; border-collapse: collapse;" border="0">
        ...
        <tr class="labels" >
            ...
            <td rowspan="4" style="text-align: center" valign="middle">
                <img src="wi.php?id={$supplier_part->part->get('Part Main Image Key')}&s=270x270" width="25mm" />
            <td>
        </tr>
        <tr class="data">
            <td style=" ">
        ...
        <tr>
            <td colspan="5" style="text-align: center"><barcode code="{$supplier_part->part->get('Part Carton Barcode')}" type="C128B" />
