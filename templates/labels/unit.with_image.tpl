...
{if $size=='EU30161' or $size=='EU30040' or $size=='SK06302900'}
    {assign 'text_margin' ''}
    ...
    <table border=0 style='width:100%;font-size:{$font_size};font-family: Arial, "Helvetica Neue", Helvetica, sans-serif'>
        ...
        <tr>
            ...
            <td class="image_td" valign="middle">
                <img src="/image.php?id={$part->get('Part Main Image Key')}&s=270x270&asset=Part&asset_key={$part->id}" style="margin-right: 0mm;vertical-align: middle;max-height: {$img_size}" width="{$img_size}" height="{$img_size}"/>
    ...
    <table border=0 style='width:100%;font-size:{$font_size};font-family: Arial, "Helvetica Neue", Helvetica, sans-serif'>
        <tr>
            ...
            <td class="image_td" style="" valign="middle">
                <img src="/image.php?id={$part->get('Part Main Image Key')}&s=270x270&asset=Part&asset_key={$part->id}" style="margin-right: 2mm;vertical-align: middle;max-height: {$img_size}" width="{$img_size}" height="{$img_size}"/>
