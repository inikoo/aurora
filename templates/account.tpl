...
<div id="bd" class="no_padding">
	<div style="padding:0 20px">
		...
		<div class="top_page_menu">
			...
			<div class="buttons" style="float:left">
				<span class="main_title"><img src="art/icons/hq.png" style="height:18px;position:relative;bottom:2px" /> <span style="position:relative;bottom:-1px">{t}Account{/t}</span> 
			</div>
	...
	<div style="padding:0 20px">
		<div id="block_details" style="clear:both;margin:10px 0 40px 0;{if $block_view!='details'}display:none{/if}">
		</div>
