...
<head>
    ...
    <link href="/art/aurora_log_v2_orange_small.png" rel="shortcut icon" type="image/x-icon"/>
        ...
        <script src="/js/aurora.min.js?v190124bis"></script>
        <script src="/js/app.js?v190124"></script>
        <script src="/js/search.js?v190124"></script>
        <script src="/js/table.js?v190124"></script>
        <script src="/js/validation.js?v190124"></script>
        <script src="/js/pdf.js?v190124"></script>
        <script src="/utils/country_data.js.php?v=v190124&locale={$locale}"></script>
        <script src="/js/edit.js?v190124"></script>
        <script src="https://wchat.freshchat.com/js/widget.js"></script>
    {if $user->get('User Type')=='Staff' or $user->get('User Type')=='Contractor'}

        <script src="/js/edit_webpage_edit.js?v190124"></script>
        <script src="/js/new.js?v190124"></script>
        <script src="/js/order.common.js?v190124"></script>
        <script src="/js/email_campaign.common.js?v190124"></script>
        <script src="/js/supplier.order.js?v190124"></script>
        <script src="/js/supplier.delivery.js?v190124"></script>
        <script src="/js/part_locations.edit.js?v=v190124"></script>
        ...
        <script src="/js/picking_and_packing.js?v190124"></script>
        <script src="/js/fast_track_packing.js?v190124"></script>
