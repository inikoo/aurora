...
<head>
    ...
    {if $_DEVEL}
        ...
        <link href="/css/app.css?v171113" rel="stylesheet">
        ...
        <script type="text/javascript" src="/js/validation.js?v171206"></script>
        ...
        <script type="text/javascript" src="/js/part_locations.edit.js?v=20171206v4"></script>
