...
<div id="bd">
	...
	<ul class="tabs" id="chooser_ul">
		...
		<li> <span class="item {if $edit=='prices'}selected{/if}" id="prices"><span> {t}Cost, Prices{/t}</span></span></li>
	...
	<div class="tabbed_container">
		<div class="edit_block" style="{if $edit!='prices'}display:none{/if}" id="d_prices">
			...
			<table class="edit" border="0" style="width:890px">
				<tr class="title">
					<td colspan="5">{t}Suggested Price{/t}</td>
				</tr>
				<tr class="first">
		...
		<div class="edit_block" style="{if $edit!='properties'}display:none{/if}" id="d_properties">
			<table class="edit" style="width:890px" border="0">
				<tr class="title">
					<td colspan="5">{t}Units{/t}</td>
				</tr>
				<tr>
					<td style="width:250px" class="label">{t}Units Type{/t}:</td>
					<td style="text-align:left"> 
				...
				<tr>
					<td class="label">{t}Unit Package Type{/t}:</td>
					<td style="text-align:left"> 
				...
				<tr>
					<td class="label"><span style="font-size:80%">({t}Without packing{/t})</span> {t}Unit Weight{/t}:</td>
					<td style="text-align:left"> 
					<div style="width:15em;position:relative;top:00px;">
						<input style="text-align:left;width:6em" id="Product_Unit_Weight" value="{$supplier_product->get('Supplier Product Unit Net Weight')}" ovalue="{$supplier_product->get('Supplier Product Unit Net Weight')}" valid="0"> <span style="margin-left:6.75em">{t}Kg{/t}</span> 
				...
				<tr>
					<td class="label"><span style="font-size:80%">({t}With packing{/t})</span> {t}Unit Weight{/t}:</td>
					<td style="text-align:left"> 
					<div style="width:15em;position:relative;top:00px">
						<input style="text-align:left;width:6em" id="Product_Unit_Gross_Weight" value="{$supplier_product->get('Supplier Product Unit Gross Weight')}" ovalue="{$supplier_product->get('Supplier Product Unit Gross Weight')}" valid="0"> <span style="margin-left:6.75em">{t}Kg{/t}</span> 
						<div id="Product_Unit_Gross_Weight_Container">
						</div>
					</div>
					</td>
				...
				<tr>
					<td class="label"><span style="font-size:80%">({t}With packing{/t})</span> {t}Unit Best Approximate Volume{/t}:</td>
					<td style="text-align:left"> 
					<div style="width:15em;position:relative;top:00px">
						<input style="text-align:left;width:6em" id="Product_Unit_Gross_Volume" value="{$supplier_product->get('Supplier Product Unit Gross Volume')}" ovalue="{$supplier_product->get('Supplier Product Unit Gross Volume')}" valid="0"> <span style="margin-left:6.75em">{t}Liters{/t}</span> 
						<div id="Product_Unit_Gross_Volume_Container">
						</div>
					</div>
					</td>
				...
				<tr>
					<td class="label"><span style="font-size:80%">({t}With packing{/t})</span> {t}Minimun Orthogonal Volume{/t}:</td>
					<td style="text-align:left"> 
					<div style="width:15em;position:relative;top:00px">
						<input style="text-align:left;width:6em" id="Product_Unit_MOV" value="{$supplier_product->get('Supplier Product Unit Minimun Orthogonal Gross Volume')}" ovalue="{$supplier_product->get('Supplier Product Unit Minimun Orthogonal Gross Volume')}" valid="0"> <span style="margin-left:6.75em">{t}Liters{/t}</span> 
						<div id="Product_Unit_MOV_Container">
						</div>
					</div>
					</td>
				...
				<tr class="title">
					<td colspan="5">{t}Cases{/t}</td>
				</tr>
				<tr style="width:250px" class="first">
				...
				<tr>
					<td class="label"> {t}Case Weight{/t}:</td>
					<td style="text-align:left"> 
					<div style="width:15em;position:relative;top:00px">
						<input style="text-align:left;width:6em" id="Product_Case_Gross_Weight" value="{$supplier_product->get('Supplier Product Case Gross Weight')}" ovalue="{$supplier_product->get('Supplier Product Case Gross Weight')}" valid="0"> <span style="margin-left:6.75em">{t}Kg{/t}</span> 
						<div id="Product_Case_Gross_Weight_Container">
						</div>
					</div>
					</td>
				...
				<tr>
					<td class="label"><span style="font-size:80%">({t}With packing{/t})</span> {t}Minimun Orthogonal Case Volume{/t}:</td>
					<td style="text-align:left"> 
					<div style="width:15em;position:relative;top:00px">
						<input style="text-align:left;width:6em" id="Product_Case_MOV" value="{$supplier_product->get('Supplier Product Case Minimun Orthogonal Gross Volume')}" ovalue="{$supplier_product->get('Supplier Product Case Minimun Orthogonal Gross Volume')}" valid="0"> <span style="margin-left:6.75em">{t}Liters{/t}</span> 
						<div id="Product_Case_MOV_Container">
						</div>
					</div>
					</td>
				...
				<tr class="buttons">
					...
					<div class="buttons left" style="margin-left:270px">
						<button id="save_edit_product_description" class="positive">{t}Save{/t}</button> <button id="reset_edit_product_description" class="negative">{t}Reset{/t}</button> 
					</div>
					</td>
					<td> </td>
				</tr>
		...
		<div class="edit_block" style="{if $edit!='description'}display:none{/if}" id="d_description">
			<table class="edit" style="width:890px">
				<tr class="title">
					<td colspan="5">{t}Name / Description{/t}</td>
				</tr>
				<tr class="first">
					<td style="width:250px" class="label">{t}Product ID{/t}:</td>
					<td>{$supplier_product->pid}</td>
				</tr>
				<tr>
					<td class="label">{t}Product Code{/t}:</td>
					<td style="text-align:left"> 
					<div>
				...
				<tr>
					<td class="label">{t}Product Name{/t}:</td>
					<td style="text-align:left"> 
					<div style="width:15em;position:relative;top:00px">
				...
				<tr>
					<td class="label">{t}Product Supplier Web Site{/t}:</td>
					<td style="text-align:left"> 
					<div style="width:15em;position:relative;top:00px">
				...
				<tr class="buttons">
					<td colspan="2"> 
					<div class="buttons left" style="margin-left:270px">
						<button class="negative" id="reset_edit_product_description">{t}Reset{/t}</button> <button class="positive" id="save_edit_product_description">{t}Save{/t}</button> 
					</div>
					</td>
					<td></td>
				</tr>
...
<div id="Editor_add_part" style="position:fixed;top:-200px;width:280px">
	...
	<div class="bd dt-editor">
		...
		<div class="yui-dt-button">
			<button style="display:none" onclick="save_add_part();" class="yui-dt-default">{t}Save{/t}</button> <button onclick="close_add_part_dialog()">{t}Cancel{/t}</button> 
		</div>
	</div>
</div>
