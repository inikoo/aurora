			...
			<div style="{if $order->data['Order Invoiced']=='Yes'}display:none{/if}">
				<table border="0" class="info_block">
					...
					<tr id="tr_order_total_to_pay" style="{if $order->get('Order To Pay Amount')==0}display:none{/if}">
						<td class="aright">
						<div id="show_add_payment_to_order" class="buttons small left" onclick="add_payment('order','{$order->id}','{$order->get('Order To Pay Amount')}')">
							<button><img src="art/icons/add.png"> {t}Payment{/t}</button>
						</div>
						{t}To Pay{/t}</td>
	...
	<table id="process_order_buttons" class="edit" style="width:100%;text-align:center" border="0">
		<tr>
			...
			<div class="buttons left">
				<button class="negative" onclick="close_process_order_dialog()">{t}Cancel{/t}</button> <button class="positive" onclick="show_quick_invoice_dialog()">{t}Quick Invoice{/t}</button> <button class="positive" id="pick_it" onclick="pick_it_()" style="{if !$current_delivery_note_key}display:none{/if}">{t}Pick it{/t}</button> <button class="positive" id="assign_picker_dialog_button" onclick="assign_picker()" style="{if !$current_delivery_note_key}display:none{/if}">{t}Assign Picker{/t}</button> 
			</div>
			</td>
		</tr>
	</table>
	<div id="assign_pickers_packers" style="display:none">
		<table class="edit" border="0" style="margin-bottom:5px;width:400px">
			...
			<tr id="Assign_Picker_Staff_Name_tr" style="display:none">
				...
				<input type="hidden" id="Assign_Picker_Staff_Name" value="" ovalue="" valid="0"> <span id="Assign_Picker_Staff_Name_label"></span> </td>
			</tr>
			...
			<tr id="Assign_Packer_Staff_Name_tr" style="display:none">
				...
				<td colspan="2" style="text-align:left;width:220px"> 
				<input type="hidden" id="Assign_Packer_Staff_Name" value="" ovalue="" valid="0"> <span id="Assign_Packer_Staff_Name_label"></span> </td>
			</tr>
			<tr style="{if $user->can_edit('assign_pp')}display:none{/if};display:none">
...
<div id="dialog_set_dn_data" style="width:710px;padding:20px 20px 0 20px;">
	<table class="edit" border="0" style="margin-bottom:5px;width:700px">
		...
		<tr>
			...
			<div class="buttons small left" id="parcel_type_options">
				<button onclick="change_parcel_type(this)" class="parcel_type" id="parcel_Pallet" valor="Pallet">{t}Pallet{/t}</button> <button onclick="change_parcel_type(this)" class="parcel_type" id="parcel_Envelope" valor="Envelope">{t}Envelope{/t}</button> <button onclick="change_parcel_type(this)" class="parcel_type" id="parcel_Small Parcel" valor="Small Parcel">{t}Small Parcel{/t}</button> <button onclick="change_parcel_type(this)" class="parcel_type" id="parcel_Box" valor="Box">{t}Box{/t}</button> <button onclick="change_parcel_type(this)" class="parcel_type" id="parcel_None" valor="None">{t}None{/t}</button> <button onclick="change_parcel_type(this)" class="parcel_type" id="parcel_Other" valor="Other">{t}Other{/t}</button> 
			</div>
	...
	<tr class="buttons">
		...
		<td colspan="2"> 
		<div class="buttons left">
			<button style="margin-right:10px;" id="reset_edit_delivery_note" onclick="reset_edit_delivery_note()" class="negative">{t}Close{/t}</button> <button style="margin-right:10px;" id="save_edit_delivery_note" onclick="save_edit_delivery_note()" class="positive">{t}Save{/t}</button> 
		</div>
		</td>
	</tr>
</table>
