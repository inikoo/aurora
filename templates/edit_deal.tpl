...
<tr class="title"><td colspan=3>{t}Deal State{/t}</td></tr>
<tr >
<td class="label">{t}Status{/t}:</td>
<td>
<div class="buttons left small">

<button class="{if $deal->get('Deal Status')!='Suspended'}selected{/if}">{t}Active{/t}</button>
<button class="{if $deal->get('Deal Status')=='Suspended'}selected{/if}">{t}Suspended{/t}</button>
...
<td>
<input id="v_calpop1" type="text" class="text" size="11" maxlength="10" name="from" value="{$deal->get('Deal Begin Date')}"/><img style="bottom:1px;left:-17px;"  id="calpop1" class="calpop" src="art/icons/calendar_view_month.png" align="absbottom" alt="" />
</td>
<td></td>
</tr>
...
<input id="v_calpop2" type="text" class="text" size="11" maxlength="10" name="from" value="{$deal->get('Deal Expiration Date')}"/><img style="bottom:1px;left:-17px;"  id="calpop2" class="calpop" src="art/icons/calendar_view_month.png" align="absbottom" alt="" />
</div>
</td>
<td></td>
</tr>
...
<tr class="title"><td colspan=3>{t}Deal Description{/t}</td></tr>
<tr>
...
<tr style="height:10px"><td colspan=3></td></tr>
<tr class="title"><td colspan=2>{t}Deal Terms & Allowances{/t}</td>
<td></td></tr>
</table>
