...
<div id="searches" style="float:right;xwidth:250px;margin-top:10px;padding:10px 10px 10px 10px;border:0px solid #6d84b4">
  ...
  <div class="search_box" style="padding:5px 0px">
      <span class="search_title" style="padding-right:15px">{t}Customer{/t}:</span> <input size="8" class="text search" id="customer_search" value="" name="search"/><img align="absbottom" id="customer_submit_search" class="submitsearch" src="art/icons/zoom.png" alt="Submit search"><br/>
    <span  class="search_msg"   id="order_search_msg"    ></span> <span  class="search_sugestion"   id="customer_search_sugestion"    ></span>
  </div>
</div>
