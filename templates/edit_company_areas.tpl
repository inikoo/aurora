...
{include file='hr_navigation.tpl'}
 ...
 <div id="no_details_title"  style="clear:left;xmargin:0 20px;{if $details!=0}display:none{/if}">
    <h1>{t}Editing Company Areas{/t}</h1>
  </div>

 
   <ul class="tabs" id="chooser_ul" style="clear:both">
      <li> <span class="item {if $edit=='areas'}selected{/if}"  id="areas">  <span> {t}Company Areas{/t}</span></span></li>
  ...
  <div class="tabbed_container"> 
   ...
   <div  class="edit_block" style="{if $edit!="areas"}display:none{/if}"  id="d_areas">
 
   <div class="general_options" style="float:right">
	<span  style="margin-right:10px;visibility:hidden"  id="save_edit_company_area" class="state_details">{t}Save{/t}</span>
	<span style="margin-right:10px;visibility:hidden" id="reset_edit_company_area" class="state_details">{t}Close Dialog{/t}</span>
		<span   style="margin-right:10px"  id="add_area" class="state_details" >Create Area</span>

      </div>
      <div  class="new_item_dialog"  id="new_area_dialog" style="display:none"  >
