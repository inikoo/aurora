...
{include file='hr_navigation.tpl'}
 ...
 <div id="no_details_title"  style="clear:left;xmargin:0 20px;{if $details!=0}display:none{/if}">
    <h1>{t}Editing Company Departments{/t}</h1>
  </div>

 
   <ul class="tabs" id="chooser_ul" style="clear:both">
      <li> <span class="item {if $edit=='departments'}selected{/if}"  id="departments">  <span> {t}Company Departments{/t}</span></span></li>
  ...
  <div class="tabbed_container"> 
   ...
   <div class="general_options" style="float:right">
	<span  style="margin-right:10px;visibility:hidden"  id="save_edit_company_department" class="state_details">{t}Save{/t}</span>
	...
	<tr class="first"><td style="width:11em" class="label">Department Code:</td>
	  <td  style="text-align:left;width:19em">
	    <div  style="width:15em;position:relative;top:00px" >
	      ...
	      <div id="Company_Department_Code_Container"  ></div>
	    </div>
	  </td>
	  <td id="Company_Department_Code_msg" class="edit_td_alert"></td>
	</tr>
	<tr class="first"><td  class="label">{t}Department Name{/t}:</td>
	  <td  style="text-align:left">
	    <div  style="width:15em;position:relative;top:00px" >
	      <input style="text-align:left;width:18em" id="Company_Department_Name" value="" ovalue="">
	      <div id="Company_Department_Name_Container"  ></div>
	    </div>
	  </td>
