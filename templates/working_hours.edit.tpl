...
<div id="working_hours" class="hide">
    <table border="0" style="">
        <tr class="bold">
            ...
            <td style="width:120px;padding-right:10px" class="aright"
            </span>  </td>
            <td style="width:30%" id="">


                <i id="{$field.id}_save_button" class="fa fa-cloud  save "
        ...
        {for $i=0 to 8}
            {$day_index = $i}
            <tr id="day_{$i}"
                class="{if  ($i>=0 and $i<6) }weekday{else}weekend{/if}  {if $i==0 or $i==6}group{else}day{/if}      {if  $i>0 and $i<6 and $compact_weekdays}hide{/if}  {if  ( $i==7 or $i==8 ) and $compact_weekend}hide{/if} {if   $i==6  and !$compact_weekend}hide{/if} {if   $i==0  and !$compact_weekdays}hide{/if}  ">
                ...
                <td class="day_labels">
                    ...
                    {/if}
                <td>
                    <input maxlength="5" id="wa_weekdays_start_{$i}" index='{$i}'
                           class="start time_input_field working_hours_input_field valid" placeholder="09:00"
                           value="{if isset($working_hours.data[$day_index]['s'])}{$working_hours.data[$day_index]['s']}{/if}"/>
                </td>
                <td>
                    <input maxlength="5" id="wa_weekdays_end_{$i}" index='{$i}'
                           class="end time_input_field working_hours_input_field valid" placeholder="17:00"
                           value="{if isset($working_hours.data[$day_index]['e'])}{$working_hours.data[$day_index]['e']}{/if}"/>
                </td>
                <td colspan=2 style="width:280px;padding-left:20px">
                    <table id="breaks_{$i}" border=0>
                            ...
                            {foreach from=$working_hours.data[$day_index]['b'] item=break_data key=break_key }
                                <tr class="breaks" id="break_{$i}_{$break_key}" break_id="{$break_key}" day_id="{$i}">
                                    <td><i class="fa fa-times link delete_break"></i> {t}Starting{/t}:
                                        <input maxlength="5" placeholder="12:00"
                                               class="time_input_field break_input_field valid"
                                               value="{$break_data.s}"/>
                                        <input maxlength="4" placeholder="30"
                                               class="minutes_input_field break_input_field valid"
                                               value="{$break_data.d}"/>
                                        {t}minutes{/t} </td>
                                </tr>
                            {/foreach}
                        ...
                        <tr id="add_break_tr_{$i}"
                            class="breaks {if isset($working_hours.data[$day_index]['b']) and $working_hours.data[$day_index]['b']|@count gt 0   }hide{/if}">
                            <td>
                                <span onClick="add_break('{$i}')" style="color:#aaa" class="link"><i
                                            class="fa fa-plus"></i> {t}add break{/t}</span>
                    ...
                    <table class="hide">
                        <tr id="new_break_{$i}" class="break breaks" break_id="">
                            <td>
                                ...
                                {t}Starting{/t}:
                                <input maxlength="5" placeholder="12:00"
                                       class="time_input_field break_input_field valid" value=""/>
                                <input maxlength="4" placeholder="30"
                                       class="minutes_input_field break_input_field valid" value=""/>
                                {t}minutes{/t}
