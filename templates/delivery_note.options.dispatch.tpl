        ...
        <table style="width:50%;float:right;width:100%;" >
            ...
            <td>
                ...
                <div style="display:flex">
                  ...
                  <div class=" very_discreet" style="align-items: stretch;flex: 1;border-left:1px solid #eeee;text-align:center"> <i class="fa fa-square"  title="{t}Set all as packed{/t}" aria-hidden="true"></i>  {t}mark all as packed{/t}</div>
                </div>
