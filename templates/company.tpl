...
<span class="nav2"><a href="contacts.php">{$home}</a></span>
  ...
  <div class="search_box" >
       <span class="search_title" style="padding-right:15px" tipo="company_name">{t}Company Name{/t}:</span> <br>
       <input size="8" class="text search" id="company_search" value="" name="search"/><img align="absbottom" id="company_submit_search" class="submitsearch" src="art/icons/zoom.png" alt="Submit search"><br/>
    ...
    <div class="yui-b" >
       <h1>{$company->get('Company Name')} <span style="color:SteelBlue">{$id}</span></h1> 
<table id="company_data" style="width:500px" border=0>

<tr>
{if $company->get('Company Main Address Key')}<td valign="top">{$company->get('Company Main XHTML Address')}</td>{/if}
<td  valign="top">
<table border=0 style="padding:0">
{if $company->get('Company Main Contact Key')}<tr><td colspan=2  class="aright"><a href="contact.php?id={$company->get('Company Main Contact Key')}">{$company->get('Company Main Contact Name')}</a></td ><td><img src="art/icons/user.png"/></td></tr>{/if}
{if $company->get('Company Main Email Key')}<tr><td colspan=2  class="aright">{$company->get('Company Main XHTML Email')}</td ><td><img src="art/icons/email.png"/></td></tr>{/if}
{if $company->get('Company Main Telephone Key')}<tr><td colspan=2 class="aright">{$company->get('Company Main Telephone')}</td ><td><img src="art/icons/telephone.png"/></td></tr>{/if}


{if $company->get('Company Main FAX Key')}<tr><td colspan=2 class="aright">{$company->get('Company Main FAX')}</td ><td><img src="art/icons/printer.png"/></td></tr>{/if}
...
<div >
  <h2 style="font-size:150%">{t}Company Overview{/t}</h2>
