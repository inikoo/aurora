...
<div id="bd">
	...
	<div style="clear:both;width:100%;border-bottom:1px solid #ccc;padding-bottom:3px">
		...
		<div class="buttons" style="float:right">
			...
			<button id="delete_all" class="negative" style="margin-left:20px;{if $user->id!=1}display:none{/if}"><img src="art/icons/cross.png" alt="" /> {t}Delete All Customers{/t}</button> 
		</div>
		...
		<tbody id="delete_all_tbody">
			<tr>
				...
				<p style="width:240px;color:red;font-weight:800">
					{if $customer_list_id}
					{t}Delete all customers without orders in the list below{/t}.
					{else}
					{t}Delete all customers without orders{/t}.
					{/if}
				</p>
			...
			<tr>
				<td> 
				<div class="buttons">
				<button id="save_delete_all" class="positive">{t}Delete{/t}</button> 
					<button id="close_delete_all" class="negative">{t}Cancel{/t}</button> 
				</div>
				</td>
			</tr>
		</tbody>
