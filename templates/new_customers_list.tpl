...
<div id="bd">
	...
	<table id="fields" class="edit" border="0" style="width:790px;margin-top:10px">
		<tbody id="contact_fields">
			...
			<tr class="space10">
				<td style="width:140px">{t}Register between{/t}:</td>
				<td> 
		...
		<tbody id="pending_orders_fields" style="display:none">
			...
			<tr class="space10">
				...
				<img id="customer_without_pending_orders" onclick="change_customer_with_pending_orders(false)"  style="cursor:pointer;display:none;height:14px;position:relative;top:2px" src="art/icons/checkbox_checked.png"/>
