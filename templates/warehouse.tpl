	...
	<div style="padding:0 20px">
		...
		<div class="top_page_menu">
			...
			<div class="buttons" style="float:left">
				<span class="main_title no_buttons"><img src="art/icons/warehouse.png" style="height:20px;position:relative;bottom:2px" title="{t}Warehouse{/t}" /> {$warehouse->get('Warehouse Name')} ({$warehouse->get('Warehouse Code')})</span> 
			</div>
