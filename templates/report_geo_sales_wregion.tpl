...
<div class="branch" style="width:300px;padding-top:5px"> 
   <span ><a  href="report_geo_sales.php?world=1">{t}World{/t}</a> &rarr; <a  href="report_geo_sales.php?continent={$continent_code}">{$continent_name}</a> &rarr; <a  href="report_geo_sales.php?continent={$wregion_code}">{$wregion_name}</a></span>
