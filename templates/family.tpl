...
<div id="bd" class="no_padding">
	...
	<div id="overview_top" style="padding:10px 20px">
		...
		<div id="photo_container" style="margin-top:0px;float:left">
			...
			<div style="width:350px;float:left">
				...
				<table border=0 >
					<tr>
						<td colspan=2 class="aright" style="font-size:90%">{$family->get_formated_discounts()}</td>
					</tr>
				</table>
	...
	<div style="clear:both;">
		...
		<div class="elements_chooser">
			<span style="float:right;margin-left:20px;" class=" table_type transaction_type state_details {if $elements_family_history.Changes}selected{/if} label_family_history_changes" id="elements_family_history_changes" table_type="elements_changes">{t}Changes History{/t} (<span id="elements_history_Changes_number">{$elements_family_history_number.Changes}</span>)</span> <span style="float:right;margin-left:20px" class=" table_type transaction_type state_details {if $elements_family_history.Notes}selected{/if} label_family_history_notes" id="elements_family_history_notes" table_type="elements_notes">{t}Staff Notes{/t} (<span id="elements_history_Notes_number">{$elements_family_history_number.Notes}</span>)</span> <span style="float:right;margin-left:20px" class=" table_type transaction_type state_details {if $elements_family_history.Attachments}selected{/if} label_family_history_attachments" id="elements_family_history_attachments" table_type="elements_attachments">{t}Attachments{/t} (<span id="elements_history_Attachments_number">{$elements_family_history_number.Attachments}</span>)</span> 
		</div>
		<div class="table_top_bar space">
		</div>
