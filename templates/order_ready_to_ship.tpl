...
<div style="text-align:right">
	...
	<span class="state_details" onClick="create_invoice(this)" style="margin-left:20px">Create Invoice</span>
    {/if}
      </div>
	...
	<div style="clear:both"></div>
	 ...
	 <table border=0  style="border-top:1px solid #333;border-bottom:1px solid #333;width:100%,padding-right:0px;margin-right:30px;float:right" >
	   ...
	   <tr><td>{t}Invoices{/t}:</td><td class="aright">{if $order->get('Order XHTML Invoices')!=''}{$order->get('Order XHTML Invoices')}{else}<span style="color:red;cursor:pointer" onClick="create_invoice(this)">Create Invoice</span>{/if}</td></tr>
