...
<table class="edit" border="0" style="width:100%">
	...
	<tr class="top">
		...
		<div class="buttons " id="site_email_providers">
			<button id="gmail_btn" class="site_email_provider {if $email_credentials.Email_Provider=='Gmail' or $email_credentials.Email_Provider=='Gmail'}selected{/if}"><img src="art/icons/email.png" alt="" /> {t}Gmail{/t}</button> <button id="inikoo_btn" class="site_email_provider {if $email_credentials.Email_Provider=='Inikoo'}selected{/if}"><img src="art/icons/email.png" alt="" /> {t}Inikoo Mail{/t}</button> <button id="php_mail_btn" class="site_email_provider {if $email_credentials.Email_Provider=='PHPMail'}selected{/if}"><img src="art/icons/email.png" alt="" /> {t}PHP Mail{/t}</button> <button id="other_btn" class="site_email_provider {if $email_credentials.Email_Provider=='Other'}selected{/if}"><img src="art/icons/email.png" alt="" /> {t}Other{/t}</button> <button id="madmimi_btn" class="site_email_provider {if $email_credentials.Email_Provider=='MadMimi'}selected{/if}"><img src="art/icons/email.png" alt="" /> {t}Mad Mimi{/t}</button> 
		</div>
		</td>
	</tr>
	<tbody id="block_gmail" style="{if $email_credentials.Email_Provider!='Gmail'}display:none;{/if}">
		<tr class="title">
			...
			<td> 
			<div class="buttons">
				<button style="{if $site->get_email_credential_key() and $site->get_credential_type()=='Gmail'}display:block{else}display:none{/if}" onclick="show_dialog_test_email_credentials(this)" id="test_email_credentials" class="positive">{t}Test{/t}</button> <button style="{if $site->get_email_credential_key() and $site->get_credential_type()=='Gmail'}display:block{else}display:none{/if}" id="delete_email_credentials" class="negative">{t}Delete{/t}</button> <button id="save_edit_email_credentials" class="positive disabled">{t}Save{/t}</button> <button id="reset_edit_email_credentials" class="negative">{t}Reset{/t}</button> 
			</div>
			</td>
		</tr>
		<tr class="top">
	...
	<tbody id="block_MadMimi" style="{if $email_credentials.Email_Provider!='MadMimi'}display:none;{/if}">
		...
		<tr>
			...
			<td> 
			<div class="buttons">
				<button style="{if $site->get_email_credential_key() and $site->get_credential_type()=='MadMimi'}display:block{else}display:none{/if}" onclick="show_dialog_test_email_credentials(this)" id="test_email_credentials" class="positive">{t}Test{/t}</button> <button style="{if $site->get_email_credential_key() and $site->get_credential_type()=='MadMimi'}display:block{else}display:none{/if}" id="delete_email_credentials_MadMimi" class="negative">{t}Delete{/t}</button> <button id="save_edit_email_credentials_MadMimi" class="positive disabled">{t}Save{/t}</button> <button id="reset_edit_email_credentials_MadMimi" class="negative">{t}Reset{/t}</button> 
			</div>
			</td>
		</tr>
	</tbody>
	<tbody id="block_other" style="{if $email_credentials.Email_Provider!='Other'}display:none;{/if}">
		<tr class="title">
			...
			<td> 
			<div class="buttons">
				<button style="{if $site->get_email_credential_key() and $site->get_credential_type()=='Other'}display:block{else}display:none{/if}" onclick="show_dialog_test_email_credentials(this)" id="test_email_credentials_other" class="positive">{t}Test{/t}</button> <button style="{if $site->get_email_credential_key() and $site->get_credential_type()=='Other'}display:block{else}display:none{/if}" id="delete_email_credentials_other" class="negative">{t}Delete{/t}</button> <button id="save_edit_email_credentials_other" class="positive disabled">{t}Save{/t}</button> <button id="reset_edit_email_credentials_other" class="negative">{t}Reset{/t}</button> 
			</div>
			</td>
		</tr>
		<tr class="top">
	...
	<tbody id="block_direct" style="{if $email_credentials.Email_Provider!='PHPMail'}display:none;{/if}">
		...
		<tr class="top">
			...
			<div class="buttons small left">
				<button style="{if $site->get_email_credential_key() and $site->get_credential_type()=='PHPMail'}display:block{else}display:none{/if}" id="delete_email_credentials_direct_mail" class="negative">{t}Delete{/t}</button> <button style="{if $site->get_email_credential_key() and $site->get_credential_type()=='PHPMail'}display:block{else}display:none{/if}" onclick="show_dialog_test_email_credentials(this)" id="test_email_credentials_direct_mail">{t}Test{/t}</button> 
			</div>
			<span id="Email_Address_direct_mail_msg" class="edit_td_alert"></span> </td>
		</tr>
		<tr>
			<td></td>
			<td> 
			<div class="buttons">
				<button id="save_edit_email_credentials_direct_mail" class="disabled positive">{t}Save{/t}</button> <button id="reset_edit_email_credentials_direct_mail" class="negative">{t}Reset{/t}</button> 
			</div>
			</td>
			<td></td>
		</tr>
	...
	<tbody id="block_inikoo" style="{if $email_credentials.Email_Provider!='Inikoo'}display:none;{/if}">
		<tr class="title">
			...
			<td> 
			<div class="buttons">
				<button style="{if $site->get_email_credential_key() and $site->get_credential_type()=='Inikoo'}display:block{else}display:none{/if}" onclick="show_dialog_test_email_credentials(this)" id="test_email_credentials_direct_mail" class="positive">{t}Test{/t}</button> <button style="{if $site->get_email_credential_key() and $site->get_credential_type()=='Inikoo'}display:block{else}display:none{/if}" id="delete_email_credentials_direct_mail" class="negative">{t}Delete{/t}</button> <button id="save_edit_email_credentials_inikoo_mail" class="positive disabled">{t}Save{/t}</button> <button id="reset_edit_email_credentials_inikoo_mail" class="negative">{t}Reset{/t}</button> 
			</div>
			</td>
		</tr>
...
<div id="dialog_test_email_credentials" style="padding:30px 10px 10px 10px;width:320px">
	...
	<table style="margin:0 auto">
		...
		<tr class="buttons small" id="site_email_types">
			<td colspan="2"> <button class="site_email_type" id="btn_plain">Plain</button> <button class="site_email_type" id="btn_html">HTML</button> </td>
		</tr>
		<tr style="height:5px">
			<td colspan="2"></td>
		</tr>
