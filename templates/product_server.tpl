...
<div  id="doc3" style="clear:both;" class="yui-g yui-t4" >
  ...
  <div  id="block_customers" class="data_table" style="{if $display.customers==0}display:none;{/if}clear:both;margin:25px 0px">
    ...
    <div  class="clean_table_caption"  style="clear:both;">
      ...
      <div class="clean_table_filter"  id="clean_table_filter1"><div class="clean_table_info"><span id="filter_name1" class="filter_name" >{$filter_name1}</span>: <input style="border-bottom:none" id='f_input1' value="{$filter_value0}" size=10/><div id='f_container1'></div></div></div>
