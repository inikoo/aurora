...
<input type="hidden" id="store_id" value="{$store->id}"/>
      ...
      <h2 style="clear:left">{t}New Orders List{/t} ({$store->get('Store Code')})</h2>
...
<span id="error_no_name" style="display:none">{t}Please specify a name{/t}.</span>
      <table >
	<form>
		<tr><td colspan="2"><b>{t}Orders ...{/t}</b></td></tr>
      <tr>
        <td>{t}created between{/t}:</td>
        <td>
            <input id="v_calpop3" type="text" class="text" size="11" maxlength="10" name="from" value=""/><img   id="order_created_from" class="calpop" src="art/icons/calendar_view_month.png" align="absbottom" alt=""   /> <span class="calpop">&rarr;</span> 
            <input id="v_calpop4" class="calpop"  size="11" maxlength="10"   type="text" class="text" size="8" name="to" value=""/><img   id="order_created_to" class="calpop_to" src="art/icons/calendar_view_month.png" align="absbottom" alt=""   />
            <div id="order_created_from_Container" style="position:absolute;display:none; z-index:2"></div>
            <div id="order_created_to_Container" style="display:none; z-index:2;position:absolute"></div>
        </td>        
      </tr>
     <tr>
