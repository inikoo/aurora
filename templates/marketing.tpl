...
<button  id="new_email_campaign"><img src="art/icons/add.png" alt=""> {t}Mailshot{/t}</button>
<button  id="new_newsletter"><img src="art/icons/add.png" alt=""> {t}Newsletter{/t}</button>
<button  id="new_campaign"><img src="art/icons/add.png" alt=""> {t}Campaign{/t}</button>
{/if}
</div>
...
<div id="block_campaigns" style="{if $view!='campaigns'}display:none;{/if}clear:both;margin:20px 0 40px 0;padding:0 20px"></div>
...
<td><input style="width:100%" id="email_campaign_name" value=""/></td>
</tr>
<tr>
<tr>
<td colspan="2">
