...
<div  id="title" class="title" style="height:22px">
 ...
 <div class="home_splinter_options" style="font-size:80%;">
            <span id="top_parts_categories" type="parts_categories" {if $conf_data.top_products.type=='parts_categories'}class="selected"{/if} style="float:right;margin-left:5px">{t}Part Groups{/t}</span>

  <span id="top_parts" type="parts" {if $conf_data.top_products.type=='parts'}class="selected"{/if} style="float:right;margin-left:5px">{t}Parts{/t}</span>
   ...
   <h1 id="title_parts" style="{if $conf_data.top_products.type!='parts'}display:none{/if}">{t}Top Parts{/t}</h1>     
   <h1 id="title_parts_categories" style="{if $conf_data.top_products.type!='parts_categories'}display:none{/if}">{t}Top Parts Groups{/t}</h1>     
