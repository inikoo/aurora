...
<input type="hidden" id="Custom_Field_Table" value="Part"> 
		...
		<div class="top_page_menu">
			...
			<div class="buttons" style="float:left">
				<span class="main_title"><img src="art/icons/warehouse.png" style="height:18px;position:relative;bottom:2px" /> <span class="id">{$warehouse->get('Warehouse Name')}</span> {t}Inventory Configuration{/t} 
			</span> 
			</div>
	...
	<ul class="tabs" id="chooser_ul">
		...
		<li><span class="item {if $edit=='parts'}selected{/if}" id="products"> <span>{t}Parts{/t}</span></span></li>
