...
<h2>{t}Email already in our Database{/t}</h2>
...
<img id="captcha3" src="art/x.png" alt="CAPTCHA Image" /> <br>
<a class="captcha_show_other"  href="#" onclick="onclick="{literal}document.getElementById('captcha3').src = '{/literal}{literal}securimage_show.php?' + Math.random(); return false{/literal}">{t}Different Image{/t}</a>

</td>
<td style="vertical-align:top">
<span class="captcha_instructions">{t}input the letters shown on the left{/t}</span><br/>
...
<td colspan=2>
<div class="buttons">
<button id="submit_forgot_password_from_email_in_db" class="positive">{t}Send Instructions{/t}</button> 
<button id="hide_email_in_db_dialog" class="negative">{t}Cancel{/t}</button>
</div>
</td>

</tr>

<tr id="tr_forgot_password_wait2"  style="display:none" class="button" ><td colspan=2><img style="weight:24px" src="art/loading.gif"> <span style="position:relative;top:-5px">processing request</span></td></tr>
...
<tbody >
<tr class="title" ><td colspan="3">{t}Login info{/t}: </td>
</tr>

<tr>
<td class="label" >{t}Email{/t}: </td><td id="confirmed_register_email"></td><td style="width:40px"></td>
</tr>
<tr>
<td class="label">{t}Password{/t}: </td><td><input type="password" id="register_password1"></td>
</tr>
<tr>
<td class="label">{t}Confirm pwd{/t}: </td><td><input type="password" id="register_password2"></td>
</tr>
</tbody>
<tr class="title" >
...
<tr>
<td class="label">{t}Company{/t}: </td><td><input id="register_company_name"></td>
</tr>
<tr>
<td class="label">{t}Telephone{/t}: </td><td><input id="register_telephone"></td>
</tr>
<tr class="title" >
<td colspan="3">{t}Address{/t}: </td>
</tr>
<tr>
<td  class="label">{t}Line 1{/t}: </td><td><input id="register_address_line1"/></td>
</tr>
<tr>
<td class="label">{t}Line 2{/t}: </td><td><input id="register_address_line2"/></td>
</tr>
<tr>
<td class="label">{t}Town{/t}: </td><td><input id="register_address_town"/></td>
</tr>
<tr>
<td class="label">{t}Postal Code{/t}: </td><td><input id="register_address_postcode"/></td>
</tr>
<tr><td class="label">{t}Country{/t}: </td><td><select size="1" id="register_address_country_2alpha_code" >
...
{if isset($categories)}
{foreach from=$categories  key=cat_key item=cat }
	
<tr>
<td class="label">{$cat->get('Category Label')}:</td>
<td>
<select id="{$cat_key}" cat_key="{$cat_key}"  onChange="update_category(this)">
  
  {foreach from=$cat->get_children_objects()  key=sub_cat_key item=sub_cat}
  {if $count==1}
...
<tr>
<td  class="label">{t}Offers by email & e-Newsletter{/t}: </td><td style="vertical-align:top;"><input   checked=checked onChange="change_allow(this)" style="border:none;width:10px" type="radio" name="newsletter" value="Yes"> {t}Yes{/t} <input    onChange="change_allow(this)"  style="width:10px;border:none" type="radio"  name="newsletter" value="No"> {t}No{/t}   </td>
</tr>
...
<tr>
<td class="label">
<img id="captcha" src="art/x.png" /> <br>
<a href="#" style="color:black" onclick="{literal}document.getElementById('captcha').src = '{/literal}{literal}securimage_show.php?' + Math.random(); return false{/literal}">{t}Different Image{/t}</a>
...
<div class="buttons">
<button id="submit_register" class="positive">{t}Register{/t}</button> 
<button id="cancel_register" class="negative">{t}Cancel{/t}</button>
</div>
</td>
</tr>

<tr id="tr_register_part_2_wait"  style="display:none" class="button" ><td colspan=2><img style="weight:24px" src="art/loading.gif"> <span style="position:relative;top:-5px">{t}Creating your account{/t}</span></td>
</tr>
