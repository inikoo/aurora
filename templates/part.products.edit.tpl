...
<div style="padding:10px;border-bottom:1px solid #ccc;text-align:right" class="{if !$products_without_auto_web_configuration}hide{/if}">
<span class="button" data-data='{ "object": "part", "key":"{$part_sku}"}'   onClick="set_all_products_web_configuration('Online Auto',this)"><i class="fa fa-magic " aria-hidden="true"></i>  <span class="padding_left_5">{t}Set all products web configuration as Automatic{/t}</span> </span>
</div>
