	...
	<div style="padding:0px 20px;">
		...
		<div id="top_page_menu" class="top_page_menu">
			...
			<div class="buttons small" style="float:right;position:relative;top:5px">
				...
				<button id="sticky_note_button"><img src="art/icons/note.png" alt=""> {t}Note{/t}</button> <button id="note"><img src="art/icons/add.png" alt=""> {t}History Note{/t}</button> 
				
				<button id="attach"><img src="art/icons/add.png" alt=""> {t}Attachment{/t}</button> <button id="take_order" ><img id="take_order_img" src="art/icons/add.png" alt=""> {t}Order{/t}</button> 
...
<div id="block_deals" style="{if $view!='deals'}display:none;{/if}clear:both;margin:0px 0 40px 0">
