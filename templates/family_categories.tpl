...
<div id="bd" class="no_padding">
	<div style="padding:0px 20px">
		...
		<div class="branch">
			<span><a href="index.php"><img style="vertical-align:0px;margin-right:1px" src="art/icons/home.gif" alt="home" /></a>&rarr; {if $user->get_number_stores()>1}<a href="stores.php">{t}Stores{/t}</a> &rarr; {/if}<a href="store.php?id={$store->id}">{$store->get('Store Name')}</a> &rarr; {t}Family's Categories{/t}</span> 
		
		</div>
		<div class="top_page_menu">
			<div class="buttons" style="float:left">
				<span class="main_title">{t}Family's Categories Home{/t}</span> 
			</div>
			<div class="buttons" style="float:right">
				<button onclick="window.location='edit_family_categories.php?store_id={$store->id}'"><img src="art/icons/table_edit.png" alt=""> {t}Edit Categories{/t}</button>  
			</div>
