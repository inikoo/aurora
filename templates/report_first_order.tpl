...
<input type="hidden" id="calendar_id" value="sales" />
	{include file='reports_navigation.tpl'} 
			{include file='calendar_splinter.tpl' calendar_id='sales' calendar_link='report_first_order.php'} 

	<h1 style="clear:left">
		{t}First Order Analysis{/t} ({$period})
	</h1>
	<table>
		<tr>
			<td>{t}Stores{/t}:</td>
		...
		<tr id="department_choosed_tr" style="display:none">
			<td>{t}Department{/t}:</td>
			<td><span id="choosed_department"></span> <span style="font-size:90%">(<span class="state_details" id="change_department">{t}Change{/t}</span>)</span> </td>
		</tr>
