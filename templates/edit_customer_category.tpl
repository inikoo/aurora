	...
	<div class="tabbed_container">
		<div class="edit_block" style="min-height:300px;{if $edit!='description'   }display:none{/if}" id="d_description">
			...
			<table class="edit" style="width:100%">
				...
				<tbody style="{if $category->get('Category Subject')!='Customer'}display:none{/if}">
					<tr class="title">
					...
					<tr>
						<td class="label" style="width:250px">{t}Show in <b>public</b> registration form{/t}:</td>
						<td style="text-align:left"> 
						<div class="buttons small left">
					...
					<tr>
						<td class="label" style="width:200px">{t}Show in <b>public</b> profile{/t}:</td>
						<td style="text-align:left"> 
						<div class="buttons small left">
...
<div id="dialog_subject_no_assigned_list">
	<div class="splinter_cell" style="padding:10px 15px 10px 0;border:none;width:650px">
		<div class="data_table">
			<span class="clean_table_title">{t}No Assigened Customers{/t}</span> {include file='table_splinter.tpl' table_id=4 filter_name=$filter_name4 filter_value=$filter_value4} 
