...
<div id="bd">
	...
	<h2 style="clear:left">
		{t}New Invoices List{/t} ({$store->get('Store Code')})
	</h2>
	<div style="clear:both;border:1px solid #ccc;padding:20px;width:870px">
		...
		<input type="hidden" id="category_key" value="{$category_key}"> <span id="error_no_name" style="display:none">{t}Please specify a name{/t}.</span> 
		<table>
			<form>
				<tr>
					<td colspan="2"><b>{t}Invoices which...{/t}</b></td>
				</tr>
				<tr>
					<td>{t}Invoice date{/t}:</td>
					<td> 
					<input id="v_calpop1" type="text" class="text" size="11" maxlength="10" name="from" value="" />
					<img id="invoice_date_from" class="calpop" src="art/icons/calendar_view_month.png" align="absbottom" alt="" /> <span class="calpop">&rarr;</span> 
					<input id="v_calpop2" class="calpop" size="11" maxlength="10" type="text" class="text" size="8" name="to" value="" />
					<img id="invoice_date_to" class="calpop_to" src="art/icons/calendar_view_month.png" align="absbottom" alt="" /> 
					<div id="invoice_date_from_Container" style="position:absolute;display:none; z-index:2">
					</div>
					<div id="invoice_date_to_Container" style="display:none; z-index:2;position:absolute">
					</div>
					</td>
				</tr>
				<tr>
					...
					<img id="invoice_paid_date_from" class="calpop" src="art/icons/calendar_view_month.png" align="absbottom" alt="" /> <span class="calpop">&rarr;</span> 
					<input id="v_calpop4" class="calpop" size="11" maxlength="10" type="text" class="text" size="8" name="to" value="" />
					<img id="invoice_paid_date_to" class="calpop_to" src="art/icons/calendar_view_month.png" align="absbottom" alt="" /> 
					<div id="invoice_paid_date_from_Container" style="position:absolute;display:none; z-index:2">
					</div>
					<div id="invoice_paid_date_to_Container" style="display:none; z-index:2;position:absolute">
					</div>
					</td>
				</tr>
				<tr>
					...
					<div class="general_options">
						<span id="postal_code" class="state_details">{t}Postal Code{/t}</span> <span id="city" class="state_details">{t}City{/t}</span> <span id="country" class="state_details">{t}Country{/t}</span> <span id="wregion" class="state_details">{t}World Region{/t}</span> 
					</div>
					</td>
				</tr>
				<tr>
					...
					<div class="general_options">
						<span id="postal_code2" class="state_details">{t}Postal Code{/t}</span> <span id="city2" class="state_details">{t}City{/t}</span> <span id="country2" class="state_details">{t}Country{/t}</span> <span id="wregion2" class="state_details">{t}World Region{/t}</span> 
					</div>
					</td>
				</tr>
				<tr>
					...
					<div id="paid_status_option" default_cat="" class="options" style="margin:5px 0">
						{foreach from=$paid_status item=cat3 key=cat_key name=foo3} <span class="catbox {if $cat3.selected}selected{/if}" onclick="checkbox_changed_paid_status_condition(this)" id="paid_status_condition_{$cat_key}" parent="paid_status_condition_" cat="{$cat_key}">{$cat3.name}</span> {/foreach} 
					</div>
					</td>
				</tr>
				<tr style="display:none" id="tr_not_paid_status">
					...
					<div id="not_paid_status_option" default_cat="" class="options" style="margin:5px 0">
						{foreach from=$paid_status item=cat3 key=cat_key name=foo3} <span class="catbox {if $cat3.selected}selected{/if}" style="{if $cat_key=='no'}display:none{/if}" onclick="checkbox_changed_paid_status_condition(this)" id="not_paid_status_condition_{$cat_key}" parent="not_paid_status_condition_" cat="{$cat_key}">{$cat3.name}</span> {/foreach} 
					</div>
					</td>
				</tr>
				<tr>
					<td colspan="2"><b>{t}Invoices in{/t}</b></td>
				</tr>
				<tr>
					<td>{t}Category{/t}:</td>
					<td> 
					<div id="category_option" default_cat="" class="options" style="margin:5px 0">
						{foreach from=$category item=cat3 key=cat_key name=foo3} <span class="catbox {if $cat3.selected}selected{/if}" onclick="checkbox_changed_category(this)" id="category_{$cat_key}" parent="category_" cat="{$cat_key}">{$cat3.name}</span> {/foreach} 
					</div>
					</td>
				</tr>
				<tr>
					<td colspan="2"><b>{t}Invoices with{/t}...</b></td>
				</tr>
				<tr>
					<td>{t}Total net amount{/t}:</td>
					<td> 
					<input id="total_net_amount_lower" type="text" class="text" size="5" maxlength="10" name="after" value="" />
					...
					<div id="total_net_amount_option" default_cat="" class="options" style="margin:5px 0">
						{foreach from=$condition item=cat3 key=cat_key name=foo3} <span class="catbox {if $cat3.selected}selected{/if}" onclick="checkbox_changed_net_amount_condition(this)" id="net_amount_condition_{$cat_key}" parent="net_amount_condition_" cat="{$cat_key}">{$cat3.name}</span> {/foreach} 
					</div>
					</td>
				</tr>
				<tr>
					...
					<td> 
					<input id="total_tax_amount_lower" type="text" class="text" size="5" maxlength="10" name="after" value="" />
					<span id="b" style="display:none">&rarr;</span> 
					...
					<div id="total_tax_amount_option" default_cat="" class="options" style="margin:5px 0">
						{foreach from=$condition item=cat3 key=cat_key name=foo3} <span class="catbox {if $cat3.selected}selected{/if}" onclick="checkbox_changed_tax_amount_condition(this)" id="tax_amount_condition_{$cat_key}" parent="tax_amount_condition_" cat="{$cat_key}">{$cat3.name}</span> {/foreach} 
					</div>
					</td>
				</tr>
				<tr>
					<td>{t}Profit{/t}:</td>
					<td> 
					<input id="total_profit_lower" type="text" class="text" size="5" maxlength="10" name="after" value="" />
					<span id="c" style="display:none">&rarr;</span> 
					...
					<div id="total_profit_option" default_cat="" class="options" style="margin:5px 0">
						{foreach from=$condition item=cat3 key=cat_key name=foo3} <span class="catbox {if $cat3.selected}selected{/if}" onclick="checkbox_changed_total_profit_condition(this)" id="total_profit_condition_{$cat_key}" parent="total_profit_condition_" cat="{$cat_key}">{$cat3.name}</span> {/foreach} 
					</div>
					</td>
				</tr>
				<tr>
					...
					<td> 
					<input id="total_amount_lower" type="text" class="text" size="5" maxlength="10" name="after" value="" />
					<span id="d" style="display:none">&rarr;</span> 
					...
					<div id="total_amount_option" default_cat="" class="options" style="margin:5px 0">
						{foreach from=$condition item=cat3 key=cat_key name=foo3} <span class="catbox {if $cat3.selected}selected{/if}" onclick="checkbox_changed_total_amount_condition(this)" id="total_amount_condition_{$cat_key}" parent="total_amount_condition_" cat="{$cat_key}">{$cat3.name}</span> {/foreach} 
					</div>
					</td>
				</tr>
				<tr>
...
<div style="padding:20px;width:890px;xtext-align:right">
	...
	<div style="float:left">
		<span style="display:none;margin-left:20px;border:1px solid #ccc;padding:4px 5px;cursor:pointer" id="save_list">{t}Save List{/t}</span> <span style="display:none;margin-left:20px;border:1px solid #ccc;padding:4px 5px;cursor:pointer" id="modify_search">{t}Redo List{/t}</span> <span style="margin-left:20px;border:1px solid #ccc;padding:4px 5px;cursor:pointer" id="submit_search">{t}Create List{/t}</span> 
	</div>
</div>
