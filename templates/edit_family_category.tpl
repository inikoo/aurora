...
<div id="bd">
	...
	<ul class="tabs" id="chooser_ul" style="clear:both">
		...
		<li> <span style="" class="item {if $edit=='parts'}selected{/if}" id="parts"> <span> {t}Families{/t} (<span id="number_category_subjects_assigned" class="number" style="float:none;display:inline;padding:0">{$category->get('Number Subjects')}</span>)</span></span></li>
		<li> <span class="item {if $edit=='no_assigned'}selected{/if}" id="no_assigned"> <span> {t}Families no assigned{/t} (<span id="number_category_subjects_not_assigned" class="number" style="float:none;display:inline;padding:0">{$category->get('Subjects Not Assigned')}</span>)</span></span></li>
	</ul>
	<div class="tabbed_container">
		...
		<div class="edit_block" style="min-height:300px;{if $edit!='parts'}display:none{/if}" id="d_parts">
			...
			<div id="children_table" class="data_table">
				<span class="clean_table_title">{t}Families in this category{/t}</span> 
