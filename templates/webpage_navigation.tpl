...
<div style="border-bottom: 1px solid #ccc;padding:4px 20px">
    ...
    {foreach from=$navigation.breadcrumbs item=$breadcrumb name=breadcrumbs}
        <span class="breadcrumb"><span class="button"  onclick="change_view('website/{$website->id}/webpage/{$breadcrumb.key}')" title="{$breadcrumb.title}">
