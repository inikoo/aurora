...
<tr class="part_tr">
<td><i class="fa fa-trash button" aria-hidden="true" onclick="remove_part(this)" ></i><input type="hidden" class="part_list_value product_part_key"  value="{$part_data['Key']}"  ovalue="{$part_data['Key']}"></td>

<td class="parts_per_products"><input class="part_list_value parts_per_product"  value="{$part_data['Ratio']}"  ovalue="{$part_data['Ratio']}"> x </td>
<td class="parts">
