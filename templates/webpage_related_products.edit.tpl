<table border="0" id="webpage_related_products" class="{if $mode=='edit'}hide{/if}  " style="margin-bottom:20px">
    ...
    <tr class="add_new_webpage_tr">
        <td></td>
        <td class="aright padding_right_20 "><i id="Webpage_Related_Products_save_button"
                                                onclick="save_this_related_products_lists()"
    ...
    <tr id="new_related_products_new_product_clone" class="webpage_tr  hide">
        ...
        <td><i class="fa fa-trash-o button margin_right_10" aria-hidden="true"
            ...
            <input class="Webpage_Code_value" value="" ovalue="" placeholder="{t}Product code{/t}"
                   parent_key="{$data.website_key}" parent="website" scope="product_webpages">
            <div class="search_results_container">
                <table class="results" border="1">
                    <tr class="hide search_result_template" field="" value="" formatted_value=""
                        onclick="select_dropdown_webpage(this)">
                        <td class="code"></td>
    ...
    <tr class="add_new_webpage_tr">
        <td></td>
        <td><span onclick="add_webpage_related_product()" class="button"><i class="fa fa-plus"></i> {t}Add a product{/t} </span>
        </td>
    </tr>
    </tbody>
</table>
