...
<div id="bd" style="padding:0px">
	...
	<input type="hidden" value="{$store_key}" id="store_key"/>
		...
		<div class="branch">
			<span><a href="index.php"><img style="vertical-align:0px;margin-right:1px" src="art/icons/home.gif" alt="home"/></a>&rarr;  {if $user->get_number_stores()>1}<a href="orders_server.php">&#8704; {t}Invoices{/t}</a> &rarr; {/if}{if $store_key>0}<a href="invoices.php?store={$store_key}">{t}Invoices{/t} ({$store->get('Store Code')})</a> &rarr; {/if}{t}Categories{/t}</span> 

		</div>
		<div class="top_page_menu">
			<div class="buttons" style="float:left">
				<span class="main_title">{t}Invoices Categories Home{/t}</span> 
			</div>
			<div class="buttons" style="float:right">
				<button onclick="window.location='edit_invoice_categories.php?store_id={$store_key}'"><img src="art/icons/table_edit.png" alt=""> {t}Edit Categories{/t}</button>  
			</div>
