...
<table>
	...
	<tr>
		...
		<td>{$account->get('Inikoo Public URL')}api/</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><span id="show_key" class="link action" onclick="show_key()">{t}Show key{/t} <i class="fa fa-eye"></i></span><span class="hide" id="api_key">{$api_key->get('API Key Code')}{$api_key->secret_key}</span> <br>
		<span class="warning"><i class="fa fa-exclamation-circle"></i> {t}The API key is a secret information and should be treated as a password{/t}</span></td>
	</tr>
</table>
</div>
