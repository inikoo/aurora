{foreach from=$_content.sections item=section_link }
    <div {if isset($section_link.id) and $section_link.id }id="{$section_link.id}"{/if}
         ...
         title="{if isset($section_link.title)}{$section_link.title}{elseif isset($section_link.label) }{$section_link.label}{/if}">
        ...
        <span class="section_label"> {if isset($section_link.label) }{$section_link.label}{/if}</span>
    </div>
{/foreach}
