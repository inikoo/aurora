...
<div style="border:0px solid #ccc;clear:both;margin-top:20px">
...
<div style="width:130px;float:right;margin:40px 5px 0 0">
<table style="font-size:87%">
<tr><td><h3>Net Sales</h3><td></tr>
...
<div id="xplot0" class="product_plot"  style="width:810px;height:300px;">
