...
<div id="bd" class="no_padding">
	<div style="padding:0 20px">
		...
		<input type="hidden" id="sales_max_sample_domain" value="{$sales_max_sample_domain}"> 
	     <input type="hidden" id="wait_label" value="{t}Processing request{/t}"> 
