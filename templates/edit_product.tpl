...
<textarea id="Product_Health_And_Safety" ovalue="{$product->get('Product Health And Safety')|escape}" rows="20" cols="75">{$product->get('Product Health And Safety')|escape}</textarea> 
			...
			<table id="d_description_block_info" class="edit" border="1" style="width:890px;{if $edit_description_block!='info'}display:none{/if}">
				<tr class="title">
					<td>{t}Attachements{/t}</td>
				</tr>
				<tr class="space5">
					<td class="label" style="width:200px">{t}Info Sheet{/t}:</td>
					<td></td>
				</tr>
				...
				<tr>
					<td style="padding:5px 0 0 0 " colspan="2"> 
					<form onsubmit="return false;">
