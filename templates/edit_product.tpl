...
<button class="{if $sales_type=='Public Sale'}selected{/if}" onClick="change_state('Public Sale', '{$sales_type}')">{t}Public Sale{/t}</button>
<button class="{if $sales_type=='Private Sale'}selected{/if}" onClick="change_state('Private Sale', '{$sales_type}')">{t}Private Sale{/t}</button>
<button class="{if $sales_type=='Not for Sale'}selected{/if}" onClick="change_state('Not For Sale', '{$sales_type}')">{t}Not For Sale{/t}</button>
</td>
</tr>
