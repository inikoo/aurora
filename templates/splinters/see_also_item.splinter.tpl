...
<div class="category_wrap wrap" data-type="{$category_data.type}">
     ...
     <span onclick="$(this).closest('.category_wrap').addClass('sortable-disabled');$(this).closest('.wrap').find('.item_overlay').removeClass('hide');$(this).closest('.wrap').find('.edit').addClass('hide')" class="fa-stack button edit_icon"
    ...
    <div class="category_block" style="position:relative" data-category_key="{$category_data.category_key}" data-category_webpage_key="{$category_data.webpage_key}" data-link="{$category_data.link}"
         data-webpage_code="{$category_data.webpage_code}">
