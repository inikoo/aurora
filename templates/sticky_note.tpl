...
<div id="edit_sticky_note_dialog" class="hide textarea_dialog" object="{$object}" key="{$key}"
     field="{$sticky_note_field}">
    <textarea id="sticky_note_value">{$_object->get('Sticky Note')}</textarea><br>


    <i id="sticky_note_close_button" class="fa fa-sign-out fa-flip-horizontal fw "
       onclick="close_sticky_note_dialog()"></i>
