...
<div id="bd" class="no_padding">
	...
	<div style="padding:0px 20px;">
		<div class="branch">
			<span class="branch"> <span><a href="index.php"><img style="vertical-align:0px;margin-right:1px" src="art/icons/home.gif" alt="home" /></a>&rarr; <a href="suppliers.php">{t}Suppliers{/t}</a> &rarr; {$supplier->get('Supplier Name')}</span> </span> 
		</div>
		...
		<div style="margin-top:20px">
			...
			<div style="float:left;width:800px;">
				...
				<table class="edit" border="0" style="width:100%;margin-bottom:0px">
					...
					<tr>
						<td style="width:200px" class="label">{t}Units per case{/t}:</td>
						<td style="width:370px"> 
						<div>
							<input style="width:100%" id="units_per_case" changed="0" type='text' maxlength="255" class='text' value="" />
					...
					<tr>
						<td style="width:200px" class="label">{t}Case Cost{/t}:</td>
						<td style="width:370px"> 
						<div>
							<input style="width:100%" id="case_cost" changed="0" type='text' maxlength="255" class='text' value="" />
					...
					<tr>
						<td colspan="2"> 
						<div class="buttons">
							<button style="margin-right:10px;visibility:" id="save_new_product" class="positive disabled">{t}Continue{/t}</button> <button style="margin-right:10px;visibility:" id="reset_new_product" class="negative">{t}Cancel{/t}</button> 
						</div>
						</td>
					</tr>
				</table>
				<table class="edit" border="0" style="width:100%;margin-bottom:0px">
					...
					<tr>
						<td style="width:200px" class="label">{t}Part Description{/t}:</td>
						<td style="width:370px"> 
						<div>
							<input style="width:100%" id="part_description" changed="0" type='text' maxlength="255" class='text' value="" />
					...
					<tr>
						<td style="width:200px" class="label">{t}Part Weight{/t}:</td>
						<td style="width:370px"> 
						<div>
							<input style="width:100%" id="gross_weight" changed="0" type='text' maxlength="255" class='text' value="" />
							<div id="gross_weight_Container">
							</div>
						</div>
						</td>
