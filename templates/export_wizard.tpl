...
<tr>
<td colspan="2"><input type="button" name="prev" id="prev" class="prev" onClick=go("customer.php?p=cs&id={$customer_id}"); />&nbsp;<input type="SUBMIT" name="SUBMIT" id="SUBMIT" class="next" value=""></td>
