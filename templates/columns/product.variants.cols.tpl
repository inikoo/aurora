...
grid.columns.findWhere({ name: 'menu_name'} ).set("renderable", false)
...
grid.columns.findWhere({ name: 'units'} ).set("renderable", true)
grid.columns.findWhere({ name: 'menu_name'} ).set("renderable", true)
