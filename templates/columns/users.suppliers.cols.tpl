...
editable: false,
sortType: "toggle",
{if $sort_key=='supplier_link'}direction: '{if $sort_order==1}descending{else}ascending{/if}',{/if}
...
grid.columns.findWhere({ name: 'supplier_link'} ).set("renderable", false)
...
grid.columns.findWhere({ name: 'supplier_link'} ).set("renderable", true)
