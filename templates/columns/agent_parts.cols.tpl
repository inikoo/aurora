...
name: "part_status",
label:'',
html_label: '<i class="fa fa-shopping-basket fa-fw very_discreet" aria-hidden="true"></i>',
editable: false,
...
name: "status",
label:'',
html_label: '<i class="fa fa-retweet fa-fw  very_discreet" aria-hidden="true"></i>',
editable: false,
