...
<div id="pick_it_dialog" style="width:340px;padding:10px 20px 10px 10px">
...
<div>
<table class="edit" border=0  style="margin:auto;padding:0 10px;width:300px">
...
<td><input id="pick_it_password" type="password" /></td>
<td colspan=2></td>
