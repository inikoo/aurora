...
<settings> 
  ...
  <data_labels>
    ...
    <show>
       <![CDATA[{literal}{title}: {percents}%{/literal}]]>                    
    </show>
  ...
  <legend>                                                    <!-- LEGEND -->
    ...
    <margins>false</margins>                                      <!-- [0] (Number) legend margins (space between legend border and legend entries, recommended to use only if legend border is visible or background color is different from chart area background color) -->
