...
<div id="email_campaign" data-object='{$object_data}' data-email_campaign_key="{$email_campaign->id}">
    ...
    <div class="order sent_email_data {if $email_campaign->get('State Index')!=100}hide{/if}">
        ...
        <div>
            ...
            {if isset($second_wave)}
            <div><span class="Second_Wave_Hard_Bounce">{$second_wave->get('Hard Bounces')}</span> <span class="padding_left_10 Second_Wave_Hard_Bounces_Percentage">{$second_wave->get('Hard Bounces Percentage')}</span></div>
            {/if}
        </div>
        <div>
            ...
            {if isset($second_wave)}
            <div><span class="Second_Wave_Soft_Bounce">{$second_wave->get('Soft Bounces')}</span> <span class="padding_left_10 Second_Wave_Soft_Bounces_Percentage">{$second_wave->get('Soft Bounces Percentage')}</span></div>
            {/if}
        </div>
        <div class="hide">
            <label>{t}Delivered{/t}</label>
            ...
            {if isset($second_wave)}
            <div><span class="Second_Wave_Delivered">{$second_wave->get('Delivered')}</span> <span class="padding_left_10 Second_Wave_Delivered_Percentage">{$second_wave->get('Delivered Percentage')}</span></div>
            {/if}
        </div>
        ...
        <div>
            ...
            {if isset($second_wave)}
            <div><span class="Second_Wave_Open">{$second_wave->get('Open')}</span> <span class="padding_left_10 Second_Wave_Open_Percentage">{$second_wave->get('Open Percentage')}</span></div>
            {/if}
        </div>
        <div>
            <label>{t}Clicked{/t}</label>
            ...
            {if isset($second_wave)}
            <div><span class="Second_Wave_Clicked">{$second_wave->get('Clicked')}</span> <span class="padding_left_10 Second_Wave_Clicked_Percentage">{$second_wave->get('Clicked Percentage')}</span></div>
            {/if}
        </div>
        ...
        <div>
            ...
            {if isset($second_wave)}
            <div><span class="Second_Wave_Spams">{$second_wave->get('Spams')}</span> <span class="padding_left_10 Second_Wave_Spams_Percentage">{$second_wave->get('Spams Percentage')}</span></div>
            {/if}
        </div>
        <div>
            ...
            {if isset($second_wave)}
            <div><span class="Second_Wave_Unsubscribed">{$second_wave->get('Unsubscribed')}</span> <span class="padding_left_10 Second_Wave_Unsubscribed_Percentage">{$second_wave->get('Unsubscribed Percentage')}</span></div>
            {/if}
        </div>
    </div>
