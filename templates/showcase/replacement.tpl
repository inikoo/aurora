{*/*
 ...
 Created:20 February 2019 at 16:34:11 GMT+8, Kuala Lumpur, Malaysia
    ...
    <div class="block ">
        <div class="state" style="height:30px;margin-bottom:0px;position:relative;top:-5px;min-width: 250px">
            ...
            <div id="forward_operations" >
                ...
                <div id="dispatch_operations" class="order_operation {if !($delivery_note->get('State Index')==80 or $delivery_note->get('State Index')==90 )   } hide{/if}">
