...
<div class="asset_container">
    ...
    <div class="block sales_data">
        ...
        <table>
            ...
            <tr>
                <td>
                    <span title="{$category->get('Year To Day Acc Dispatched')}">{$category->get('Year To Day Acc Dispatched Minify')}</span>
                    <span title="{$year_data.0.dispatched_delta_title}">{$year_data.0.dispatched_delta}</span></td>
                <td>
                    <span title="{$category->get('1 Year Ago Dispatched')}">{$category->get('1 Year Ago Dispatched Minify')}</span>
                    <span title="{$year_data.1.dispatched_delta_title}">{$year_data.1.dispatched_delta}</span></td>
                <td>
                    <span title="{$category->get('2 Year Ago Dispatched')}">{$category->get('2 Year Ago Dispatched Minify')}</span>
                    <span title="{$year_data.2.dispatched_delta_title}">{$year_data.2.dispatched_delta}</span></td>
                <td>
                    <span title="{$category->get('3 Year Ago Dispatched')}">{$category->get('3 Year Ago Dispatched Minify')}</span>
                    <span title="{$year_data.3.dispatched_delta_title}">{$year_data.3.dispatched_delta}</span></td>
                <td>
                    <span title="{$category->get('4 Year Ago Dispatched')}">{$category->get('4 Year Ago Dispatched Minify')}</span>
            ...
            <tr>
                <td>
                    <span title="{$category->get('Quarter To Day Acc Dispatched')}">{$category->get('Quarter To Day Acc Dispatched Minify')}</span>
                    <span title="{$quarter_data.0.dispatched_delta_title}">{$quarter_data.0.dispatched_delta}</span>
                </td>
                <td>
                    <span title="{$category->get('1 Quarter Ago Dispatched')}">{$category->get('1 Quarter Ago Dispatched Minify')}</span>
                    <span title="{$quarter_data.1.dispatched_delta_title}">{$quarter_data.1.dispatched_delta}</span>
                </td>
                <td>
                    <span title="{$category->get('2 Quarter Ago Dispatched')}">{$category->get('2 Quarter Ago Dispatched Minify')}</span>
                    <span title="{$quarter_data.2.dispatched_delta_title}">{$quarter_data.2.dispatched_delta}</span>
                </td>
                <td>
                    <span title="{$category->get('3 Quarter Ago Dispatched')}">{$category->get('3 Quarter Ago Dispatched Minify')}</span>
                    <span title="{$quarter_data.3.dispatched_delta_title}">{$quarter_data.3.dispatched_delta}</span>
                </td>
                <td>
                    <span title="{$category->get('4 Quarter Ago Dispatched')}">{$category->get('4 Quarter Ago Dispatched Minify')}</span>
                        ...
                        <table style="width:100%">
                            <tr>
                                <td class="super_discreet highlight Current_On_Hand_Stock"
                                    style="font-size:200%">{$category->get('Current On Hand Stock')}</td>
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td id="saving_buttons" class="aright discreet  "><span id="saving_buttons"
