...
<div id="bd" class="no_padding">
	<div style="padding:0px 20px">
		...
		<div class="branch">
			<span><a href="index.php"><img style="vertical-align:0px;margin-right:1px" src="art/icons/home.gif" alt="home" /></a>&rarr; <a href="suppliers.php">{t}Suppliers{/t}</a> &rarr; {t}Suppliers Categories{/t}</span> 
		</div>
