<table border="0" id="webpage_see_also" class="{if $mode=='edit'}hide{/if}  " style="margin-bottom:20px"
       otype="{$data.type}">
    <tr class="add_new_webpage_tr">
        <td><span>{t}Automatic{/t}</span> <i id="see_also_type" onclick="toggle_see_also_type(this)"
                                             oclass="{if $data.type=='Auto'}fa-toggle-on{else}fa-toggle-off{/if}"
                                             class="fa {if $data.type=='Auto'}fa-toggle-on{else}fa-toggle-off{/if} button padding_left_10"
                                             aria-hidden="true"></i></td>
        <td class="aright padding_right_20 "><i id="Webpage_See_Also_save_button" onclick="save_this_see_also_lists()"
    ...
    <tr>
        ...
        <td>
            <input id="see_also_number_links" class="width_100" style="width:50px" value="{$data.number_links}"
                   ovalue="{$data.number_links}">
        </td>
    </tr>
    ...
    <tr id="new_webpage_clone" class="webpage_tr  hide">
        ...
        <td><i class="fa fa-trash-o button margin_right_10" aria-hidden="true" onclick="remove_webpage(this)"></i>
            ...
            <input class="Webpage_Code_value" value="" ovalue="" placeholder="{t}Webpage code{/t}"
                   parent_key="{$data.website_key}" parent="website" scope="webpages">
            <div class="search_results_container">
                <table class="results" border="1">
                    <tr class="hide search_result_template" field="" value="" formatted_value=""
                        onclick="select_dropdown_see_also_webpage(this)">
                        <td class="code"></td>
