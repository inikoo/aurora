...
<div id="bd">
	<span class="nav2 onleft"><a href="contacts.php">{t}Contact's List{/t}</a></span> <span class="nav2 onleft"><a href="customers.php">{t}Customer's List{/t}</a></span> 
	<div>
		...
		<h2 style="margin:10px 20px 0 20px">
			{t}Advanced Search{/t}
		</h2>
		<div id="advanced_search" tipo="1" style="margin:0px 20px ;padding:0 20px;width:700px;border:1px solid #ccc;">
			<table>
				<form>
					<tr>
						<td colspan="2"><b>Customers who..</b></td>
					</tr>
					<tr>
						<td>ordered this product(s)</td>
						<td>
						<input id="product_ordered1" value="" size="40" />
						</td>
						<tr>
							<tr>
								<td>but didn't order this product(s)</td>
								<td>
								<input id="product_not_ordered1" value="" size="40" />
								</td>
								<tr>
									<tr>
										<td>and did't receive this product(s)</td>
										<td>
										...
										<tr>
											<tr>
												...
												<img id="calpop1" class="calpop" src="art/icons/calendar_view_month.png" align="absbottom" alt="" /> <span class="calpop">&rarr;</span> 
												<input class="calpop" id="v_calpop2" size="11" maxlength="10" type="text" class="text" size="8" name="to" value="{$to}" />
												<img id="calpop2" class="calpop_to" src="art/icons/calendar_view_month.png" align="absbottom" alt="" /> </td>
												<td style="text-align:right;vertical-align:middle"><span style="margin-left:20px;border:1px solid #ccc;padding:4px 5px;cursor:pointer" id="submit_advanced_search">Start Search <img style="vertical-align:bottom" src="art/icons/zoom.png" /></span> </td>
											</tr>
										</table>
									</form>
								</div>
