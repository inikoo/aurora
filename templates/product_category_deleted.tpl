...
<div id="bd">
	<div id="content">
		...
		<div class="branch">
			<span> <a href="index.php"> <img style="vertical-align:0px;margin-right:1px" src="art/icons/home.gif" alt="home" /> </a> &rarr; {if $user->get_number_stores()>1}<a href="stores.php">{t}Stores{/t} </a> &rarr; {/if}<a href="inventory.php?store_id={$store->id}">{t}Inventory{/t} </a> &rarr; <a href="product_categories.php?&store_id={$store->id}"> {t}Products Categories{/t} </a> &rarr; {t}Deleted Category{/t} ({$category_data.CategoryDeletedCode})</span> 
		</div>
