...
<span style="margin-right:20px" class="hide">
    ...
    <i class="fa fa-mobile" aria-hidden="true"></i>
                ...
                <span id="publish" webpage_key="{$webpage->id}" class="button save {if $webpage->get('Publish')}changed valid{/if}" style="float:right" onclick="publish(this,'publish_webpage')"><span
  ...
  <i class="fa fa-close fa-stack-2x very_discreet error"></i>
            ...
            <div id="page_content" style="position:relative">
                ...
                <div id="description_block" class="section description_block {$content.description_block.class} ">
                    ...
                    {foreach from=$content.description_block.blocks key=id item=data}
                        {if $data.type=='text'}
                ...
                <div id="items_container" class="product_blocks">
                    ...
                    <div id="products_helper">
                        {include file="theme_1/products_showcase.products.theme_1.tpl" }
                    </div>
                    <div style="clear:both"></div>
                </div>
                ...
                <div id="related_products" class="product_blocks {if $related_products|@count eq 0}hide{/if}">
                    ...
                    {foreach from=$related_products item=product_data key=stack_index}
                        ...
                        <div class="product_wrap">
                            ...
                            <div id="product_target_div_{$stack_index}" index_key="{$product_data.index_key}" stack_index="{$stack_index}" xdraggable="true" xondragstart="drag(event)"
                                 product_code="{$product->get('Code')}" product_id="{$product->id}" xondrop="drop(event)" xondragover="allowDrop(event)" class="product_block product_showcase "
