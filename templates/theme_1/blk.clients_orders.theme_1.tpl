...
<!--
 ...
 Created: Sat 26 Oct 2019 00:50:45 +0800 MYT, Kuala Lumpur, Malaysia
...
<div id="block_{$key}" data-block_key="{$key}" block="{$data.type}" class="_block {if !$data.show}hide{/if}"  top_margin="{$top_margin}" bottom_margin="{$bottom_margin}"
    ...
    <h1 id="title" contenteditable="true">{if !empty($data.labels.title)}{$data.labels.title}{else}{t}Orders{/t}{/if}</h1>
