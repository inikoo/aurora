...
<div id="edit_item_container" class="hide" style="clear:both;width:100%;min-height: 200px;background: #fff;padding:0px 20px 20px 20px; position:fixed;top:0px">
    ...
    <div class="container">
        ...
        <div style="float:right;width: 700px;margin-right:20px">
            ...
            <h4 style="padding:0px;margin:0px"><span style="color:#777">{t}Category{/t}:</span> <span id="catalogue_code"></span> <i id="catalogue_webpage_link" class="fal fa-file-alt like_button" style="color:#777;font-size:60%;position: relative;top:-2px" aria-hidden="true"></i></h4>
