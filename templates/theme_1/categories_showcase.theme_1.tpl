...
<div class="wrapper_boxed">
                    ...
                    <tr>
                        <td>
                            ...
                            <input id="add_item_dropdown_select_label" field="add_item" style="width:200px" scope="category_webpages" parent="store"
                                   ...
                                   parent_key="{$webpage->get('Webpage Store Key')}" class=" dropdown_select" value="" has_been_valid="0" placeholder="{t}Family / category code{/t}" action="add_category_to_webpage"

                            />
                            <span id="add_item_msg" class="msg"></span>
                            <i id="add_item_save_button" class="fa fa-cloud save dropdown_select hide" onclick="save_this_field(this)"></i>
    ...
    <span style="margin-right:20px" class="hide">
        ...
        <i class="fa fa-mobile" aria-hidden="true"></i>
                    ...
                    <span id="publish" class="button save {if $webpage->get('Publish') or $webpage->get('Webpage State')=='Offline'  }changed valid{/if}" webpage_key="{$webpage->id}" style="float:right"
                          onclick="publish(this,'publish_webpage')"><span class="unselectable preview_publish_label">
                ...
                <div id="page_content" style="position:relative">
                    ...
                    <div style="position:relative;" id="items_views">
                        <div id="overview_container" class="hide product_blocks" style="margin-bottom:80px;">
                            ...
                            {foreach from=$content.sections item=section_data}
