...
<td class="refunds aright {if $type!='invoices'}hide{/if}" title="{t}Refunds{/t}">{t}Refunds{/t}</td>
<td class="refunds aright {if $type!='invoices'}hide{/if}" title="{t}Change compared with last year{/t}">&Delta; {t}Last Y{/t}</td>
...
<td id="orders_overview_refunds_delta_{$record.id}" class="refunds width_100 aright {if $type!='invoices'}hide{/if}" title="{$record.refunds_1yb}" >{$record.refunds_delta}</td>
...
<td id="orders_overview_invoices_delta_{$record.id}" class="invoices width_100 aright {if $type!='invoices'}hide{/if}" title="{$record.invoices_1yb}">{$record.invoices_delta}</td>


<td id="orders_overview_sales_{$record.id}" class="sales width_200 aright {if $type!='invoices'}hide{/if}">{$record.sales}</td>
<td id="orders_overview_sales_delta_{$record.id}" class="last sales width_100 aright {if $type!='invoices'}hide{/if}" title="{$record.sales_1yb}">{$record.sales_delta}</td>
