...
<div style="padding:10px">
    ...
    <div id="dashboard_sales_overview" style="margin-top:20px;padding:0px" class="dashboard hide">
        ...
        <table border="0" style="width:100%">
            <tr class="main_title small_row">
                <td colspan="9">
                    ...
                    <div id="sales_overview_orders_view_type_container" class="button  {if $type!='orders'}hide{/if} " onclick="toggle_sales_overview_orders_view_type()"
                    ...
                    <div id="sales_overview_currency_container" class="button  {if $type=='delivery_notes' or ($type=='orders' and $orders_view_type=='numbers')  }hide{/if} " onclick="toggle_sales_overview_currency()"
            ...
            {foreach from=$sales_overview item=record}
                <tbody class="data">
                <tr class="{$record.class} small_row">
                    <td class="label {if isset($record.label.view) and $record.label.view!='' }link{/if}" {if isset($record.label.view) and $record.label.view!='' }onclick="change_view('{$record.label.view}')" {/if}
                    ...
                    <td id="orders_overview_refunds_delta_{$record.id}" class="refunds width_100 aright {if !($type=='invoices' or  $type=='invoice_categories')}hide{/if}"
                    ...
                    <td id="orders_overview_delivery_notes_delta_{$record.id}" class="delivery_notes width_100 aright {if $type!='delivery_notes'}hide{/if}"
                    ...
                    <td id="orders_overview_replacements_percentage_1yb_{$record.id}" class="last replacements width_100 aright {if $type!='delivery_notes'}hide{/if}"
                    ...
                    <td id="orders_overview_invoices_delta_{$record.id}" class="invoices width_100 aright {if !($type=='invoices' or  $type=='invoice_categories')}hide{/if}"
