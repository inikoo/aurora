...
<ul class="flex-container">
    ...
    <li class="flex-item">
        ...
        <div class="title"><span class="formatted_sitting_time_avg "   title="{t}Average sitting time{/t}: {$object->get('formatted_bis_sitting_time_avg')}" >{$object->get('formatted_sitting_time_avg')}</span></div>
        <div ><span class="sitting_time_samples" title="{t}Orders sitting in the warehouse{/t}">{$object->get('sitting_time_samples')}</span> <i class="fal fa-truck"></i></div>
    ...
    <li class="flex-item">
        ...
        <div class="title"><span class="formatted_dispatch_time_avg "   title="{t}Average dispatch time (last 30 days){/t}: {$object->get('formatted_bis_dispatch_time_avg','1 Month')}" >{$object->get('formatted_dispatch_time_avg','1 Month')}</span></div>
