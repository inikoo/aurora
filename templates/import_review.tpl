...
<div id="bd">
	...
	<div id="top_page_menu" class="top_page_menu">
		...
		<div class="buttons" style="float:right">
			<button class="positive" id="insert_data"><img src="art/icons/database_add.png" alt=""> {t}Insert data{/t}</button> <button id="cancel_import" class="negative">
			<img id="cancel_img" src="art/icons/cross.png" alt=""> {t}Cancel{/t}</button> <button id="browse_maps"><img src="art/icons/text_list_bullets.png" alt=""> {t}Pick a Field Map{/t}</button> 
		</div>
