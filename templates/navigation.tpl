 <div id="navigation">
	<div id="section_links">
		...
		<div {if isset($section_link.id) and $button.id }id="{$button.id}"{/if} class="text_button right" {if isset($section_link.url)}onclick="location.href='{$section_link.url}'"{/if} title="{$section_link.title}">
