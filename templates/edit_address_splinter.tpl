...
<tbody id="{$address_identifier}address_form" style="display:none">
	<tr id="{$address_identifier}tr_address_type" {if $hide_type}style="display:none" {/if}>
		...
		<td style="text-align:left" id="{$address_identifier}address_type" value="" ovalue=""> <span id="{$address_identifier}address_type_Office" label="Office" onclick="toggle_address_type(this)" class="small_button address_type {if $address_type=='Office'}selected{/if}" style="margin:0">{t}Office{/t}</span> <span id="{$address_identifier}address_type_Shop" label="Shop" onclick="toggle_address_type(this)" class="small_button  address_type {if $address_type=='Shop'}selected{/if}" style="margin-left:3px">{t}Shop{/t}</span> <span id="{$address_identifier}address_type_Warehouse" label="Warehouse" onclick="toggle_address_type(this)" class="small_button  address_type {if $address_type=='Warehouse'}selected{/if}" style="margin-left:3px">{t}Warehouse{/t}</span> <span id="{$address_identifier}address_type_Other" label="Other" onclick="toggle_address_type(this)" class="small_button  address_type {if $address_type=='Other'}selected{/if}" style="margin-left:3px">{t}Other{/t}</span> </td>
	</tr>
...
<tr class="buttons" style="{if $hide_buttons==true}display:none{/if}">
	...
	<div class="buttons" style="margin-top:10px">
		<img style="float:right;visibility:hidden;opacity:1" src="art/icons/accept.png"> <button address_key="" class="positive disabled" style="margin-right:10px" id="{$address_identifier}save_address_button">{t}Save{/t}</button> <button class="negative {if !$close_if_reset}disabled{/if}" close_if_reset="{if $close_if_reset}Yes{else}No{/if}" address_key="" style="{if !$close_if_reset}xvisibility:hidden{/if}" id="{$address_identifier}reset_address_button">{t}Cancel{/t}</button> 
	</div>
	</td>
</tr>
