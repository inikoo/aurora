	...
	<tr class="first"><td style="width:11em" class="label">Position Code:</td>
	  <td  style="text-align:left;width:19em">
	    <div  style="width:15em;position:relative;top:00px" >
	      ...
	      <div id="Company_Position_Code_Container" style="" ></div>
	    </div>
	  </td>
	...
	<tr class="first"><td style="" class="label">{t}Position Name{/t}:</td>
	  <td  style="text-align:left">
	    <div  style="width:15em;position:relative;top:00px" >
	      ...
	      <div id="Company_Position_Name_Container" style="" ></div>
	    </div>
	  </td>
        ...
        <tr class="first"><td style="" class="label">{t}Position Description{/t}:</td>
	  <td  style="text-align:left">
	    <div  style="width:15em;position:relative;top:00px" >
	      ...
	      <div id="Company_Position_Description_Container" style="" ></div>
	    </div>
	  </td>
