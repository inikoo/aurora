...
<div style="padding:0px 20px">
 ...
 <div  class="branch"> 
  <span> <a href="hr.php">{t}Staff{/t} </a>  &rarr; {$staff->get('Staff Name')} </span>
</div>
...
<div id="top_page_menu" class="top_page_menu">
    ...
    <div class="buttons" style="float:left">
        <button  onclick="window.location='hr.php'" ><img src="art/icons/house.png" alt=""> {t}HR{/t}</button>
    </div>
...
{if $staff->get('Staff Alias')}<tr><td valign="top" class="aleft">{t}Alias{/t}:</td><td valign="top"colspan=2  class="aleft">{$staff->get('Staff Alias')}</td></tr>{/if}
