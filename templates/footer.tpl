...
<a style="margin-left:10px" target="blank" href="report_issue.php?t=bug">{t}Report a problem{/t}</a>
<a style="margin-left:10px" target="blank" href="report_issue.php?t=feature">{t}Request a feature{/t}</a>
