...
<script>
    ...
    function change_customer(element){
        $(element).html('')
        $(element).closest('td').find('.Customer_Key').val('')

        $(element).closest('td').find('.search_results_container').removeClass('hide')
        $(element).closest('td').find('.Customer_Select_value').removeClass('hide').val('')
    ...
    function select_dropdown_customer(element) {
        ...
        $(element).closest('td').find('.Customer_Key').val($(element).attr('value'))


        $(element).closest('td').find('.search_results_container').addClass('hide')
        $(element).closest('td').find('.Customer_Select_value').addClass('hide')
    ...
    $("#Customer_container").on("input.Customer_Select_value propertychange", function (evt) {
    ...
    function save_this_customer_lists() {
        save_field($('#fields').attr('object'), $('#fields').attr('key'), 'Product_Customers')
    }
