...
<div id="bd" >
 ...
 <div style="text-align:right">
	<span class="state_details" id="continue_later" style="{if $packed}display:none{/if}"><a href="warehouse_orders.php">{t}Continue Later{/t}</a></span>
	<span class="state_details" id="finish" style="{if !$packed}display:none;{/if}margin-left:20px"><a href="warehouse_orders.php">{t}Close{/t}</a></span>
...
<tbody id="resend" >	   
	...
	<div id="table_type">
	  <span id="set_as_all_packed" style="float:right;color:brown" class="table_type state_details ">{t}Set as all Picked{/t}</span>
...
<div id="no_dispatchable_editor_dialog" style="width:200px" xstyle="position:fixed;top:-200px">
  <div style="display:none" class="hd"></div>
    ...
    {t}Error, the sum of out of stock and not found units are greater than the number of not packed units{/t}
	    ...
	    <td><input id="no_packed_other_units" type="text" style="width:20px;"></td><td>{t}Other Reason{/t}</td>
	    </tr>	   
