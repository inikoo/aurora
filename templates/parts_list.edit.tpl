<table border=0 id="parts_list" class="{if $mode=='edit'}hide{/if}  ">
    ...
    <tr id="new_part_clone" class="part_tr new in_process hide">
        ...
        <td class="parts">
            ...
            <input class="Part_Reference_value" value="" ovalue="" placeholder="{t}Part reference{/t}" parent_key="1"
                   parent="account" scope="parts">
            <div class="search_results_container">
                <table class="results" border="1">
                    <tr class="hide search_result_template" field="" value="" formatted_value=""
                        onclick="select_dropdown_part(this)">
                        <td class="code"></td>
        ...
        <td class="notes"><input class="part_list_value note" value="" ovalue="" placeholder="{t}Note for pickers{/t}">
        </td>

    </tr>
    <tr class="add_new_part_tr">
        <td colspan=3><span onclick="add_part()" class="button">{t}Add a part{/t} <i class="fa fa-plus"></i></span></td>
        <td class="aright padding_right_20"><i id="Product_Parts_save_button" onclick="save_this_part_lists()"
