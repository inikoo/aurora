	...
	<div class="tabbed_container">
	    ...
	    {/foreach}
				...
				<tr style="display:none">
					<td class="label">{t}Shape{/t}:</td>
					<td> 
					<div id="location_shape_type" class="buttons" style="margin:0">
						{foreach from=$shape_type_list item=cat key=cat_id name=foo} <button class="{if $location->get('Location Shape Type')==$cat.name}selected{/if}" onclick="save_location('shape','{$cat.name}')" id="shape_{$cat.name}">{$cat.name}</button> {/foreach} 
					</div>
					</td>
				</tr>
				<tr style="display:none">
					<td style="width:180px" class="label">{t}Location Radius{/t}:</td>
					...
					<div>
						...
						<div id="Location_Radius_Container">
						</div>
					</div>
					</td>
				...
				<tr style="display:none">
					<td style="width:180px" class="label">{t}Location Height{/t}:</td>
					<td style="text-align:left"> 
					<div>
						...
						<div id="Location_Height_Container">
						</div>
					</div>
					</td>
				...
				<tr style="display:none">
					<td style="width:180px" class="label">{t}Location Width{/t}:</td>
					<td style="text-align:left"> 
					<div>
						...
						<div id="Location_Width_Container">
						</div>
					</div>
					</td>
				...
				<tr>
					<td style="width:180px" class="label">{t}Location Max Weight{/t}:</td>
					<td style="text-align:left"> 
					<div>
						...
						<div id="Location_Max_Weight_Container">
						</div>
					</div>
					</td>
				...
				<tr>
					<td style="width:180px" class="label">{t}Location Max Volume{/t}:</td>
					<td style="text-align:left"> 
					<div>
						...
						<div id="Location_Max_Volume_Container">
						</div>
					</div>
					</td>
				...
				<tr style="display:none">
					<td style="width:180px" class="label">{t}Location Max Slots{/t}:</td>
					<td style="text-align:left"> 
					<div>
						...
						<div id="Location_Max_Slots_Container">
						</div>
					</div>
					</td>
		...
		<div id="parts_block" style="{if $edit!='parts'}display:none{/if}">
			<span class="clean_table_title">{t}Parts{/t}</span> {include file='table_splinter.tpl' table_id=0 filter_name=$filter_name0 filter_value=$filter_value0} 
...
<div id="dialog_area_list">
	<div class="splinter_cell" style="padding:10px 15px 10px 0;border:none">
		<div id="the_table" class="data_table">
			<span class="clean_table_title">{t}Area List{/t}</span> {include file='table_splinter.tpl' table_id=2 filter_name=$filter_name2 filter_value=$filter_value2} 
	...
	<table style="margin:10px">
		...
		<tr>
			...
			<div class="buttons" style="margin-top:10px">
				<button class="negative" id="delete_location">{t}Delete{/t}</button> <button class="positive" id="close_dialog_delete_location">{t}Cancel{/t}</button> 
			</div>
			</td>
		</tr>
	</table>
