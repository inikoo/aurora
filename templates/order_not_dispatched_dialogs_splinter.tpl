...
<div id="dialog_check_tax_number" style="position:absolute;left:-1000px;padding:10px 20px 10px 10px">
...
<div id="dialog_quick_edit_Customer_Tax_Number" style="position:absolute;left:-1000px;padding:10px">
