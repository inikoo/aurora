...
<div id="dialog_add_voucher" style="position:absolute;left:-1000px;padding:10px;width:320px">
	<table style="margin:10px" border="0">
		<tr>
			<td>{t}Voucher{/t}:</td>
			<td style="width:220px"> 
			<div>
				<input style="width:100%" type="text" id="Order_Voucher" value="" ovalue="" valid="0"> 
				<div id="Order_Voucher_Container">
				</div>
			</div>
			</td>
		</tr>
		<tr>
			<td colspan="2"> 
			<div class="buttons" style="margin-top:10px">
				<div style="max-width:140px;float:left" id="Order_Voucher_msg" class="edit_td_alert"></div> <button class="positive" onclick="save_add_voucher()">{t}Add{/t}</button> <button class="negative" onclick="close_dialog_add_voucher()">{t}Cancel{/t}</button> 
			</div>
			</td>
		</tr>
	</table>
