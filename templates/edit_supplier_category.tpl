...
<div id="bd">
	...
	<div class="branch">
			<span><a href="index.php"><img style="vertical-align:0px;margin-right:1px" src="art/icons/home.gif" alt="home" /></a>&rarr; <a href="suppliers.php">{t}Suppliers{/t}</a> &rarr; <a href="supplier_categories.php">{t}Suppliers Categories{/t}</a>  &rarr; {$category->get('Category XHTML Branch Tree')} ({t}Editing{/t})</span> 
	...
	<div class="tabbed_container">
		...
		<div class="buttons small left" style="border:1px solid white;margin-bottom:10px">
				...
				<span id="checked_assigned_subjects_dialog" style="display:none;float:left;margin-right:5px;margin-left:20px">{t}With seleced suppliers{/t} (<span id="number_checked_assigned_subjects"></span>): </span> 
		...
		<div class="edit_block" id="d_no_assigned" style="min-height:300px;{if $edit!='no_assigned'}display:none;{/if}">
			<div class="buttons small left" style="border:1px solid white;margin-bottom:0px">
				...
				<span id="checked_no_assigned_subjects_dialog" style="display:none;float:left;margin-right:5px;margin-left:20px">{t}With seleced suppliers{/t} (<span id="number_checked_no_assigned_subjects"></span>): </span> 
...
<div id="dialog_subject_no_assigned_list">
    <div class="splinter_cell" style="padding:10px 15px 10px 0;border:none;width:650px">
        <div class="data_table" >
            <span class="clean_table_title">{t}No Assigened Suppliers{/t}</span>
