...
<div id="bd">
	...
	<div class="branch">
		<span><a href="index.php"><img style="vertical-align:0px;margin-right:1px" src="art/icons/home.gif" alt="home" /></a>&rarr; <a href="suppliers.php">{t}Suppliers{/t}</a> &rarr; <a href="supplier_categories.php">{t}Suppliers Categories{/t}</a> &rarr; <span id="branch_tree">{$category->get('Category XHTML Branch Tree')}</span> ({t}Editing{/t})</span> 
	</div>
	...
	<div class="tabbed_container">
		...
		<div class="edit_block" style="min-height:300px;{if $edit!='suppliers'}display:none{/if}" id="d_suppliers">
			<div class="buttons small left" style="border:1px solid white;margin-bottom:10px">
				<button id="check_all_assigned_subjects" onclick="check_all_assigned_subject()">{t}Check All{/t}</button> <button style="display:none" id="uncheck_all_assigned_subjects" onclick="uncheck_all_assigned_subject()">{t}Uncheck All{/t}</button> <span id="checked_assigned_subjects_dialog" style="display:none;float:left;margin-right:5px;margin-left:20px">{t}With seleced suppliers{/t} (<span id="number_checked_assigned_subjects"></span>): </span> <button style="display:none" id="checked_assigned_subjects_assign_to_category_button" onclick="assign_to_category_checked_assigned_subject()">{t}Move to other Category{/t}</button> <button style="display:none" id="checked_assigned_subjects_remove_from_category_button" onclick="remove_from_category_checked_assigned_subject()">{t}Remove from Category{/t}</button> <span id="wait_checked_assigned_subjects_assign_to_category" style="display:none;float:left;margin-right:5px;margin-left:20px"><img src="art/loading.gif" /> {t}Processing Request{/t}</span> 
				<div style="clear:both">
				</div>
			</div>
...
<div id="dialog_subject_no_assigned_list">
	<div class="splinter_cell" style="padding:10px 15px 10px 0;border:none;width:650px">
		<div class="data_table">
			<span class="clean_table_title">{t}No Assigened Suppliers{/t}</span> {include file='table_splinter.tpl' table_id=4 filter_name=$filter_name4 filter_value=$filter_value4} 
