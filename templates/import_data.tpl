...
<div class="ImportSection" style="float:left;width:410px;cursor:pointer;margin-right:40px" onClick="location.href='import_csv.php?tipo=customers_store&store_key={$store_key}'">
