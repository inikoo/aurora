...
function display_database_image($db, $image_key, $size='small') {
	...
	$sql=sprintf('select `Image Original Filename`,`Image Data`,`Image Small Data`,`Image Large Data`,`Image Thumbnail Data` from `Image Dimension` where `Image Key`=%d', $image_key);
	if ($result=$db->query($sql)) {
