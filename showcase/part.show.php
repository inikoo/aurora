	...
	$smarty->assign('quarter_data',
		array(
			array('header'=>get_quarter_label(strtotime('now')),
				'invoiced_amount_delta_title'=>delta($part->get('Part Quarter To Day Acc Invoiced Amount'), $part->get('Part Quarter To Day Acc 1YB Invoiced Amount')),
				...
				'dispatched_delta_title'=>delta($part->get('Part Quarter To Day Acc Dispatched'), $part->get('Part Quarter To Day Acc 1YB Dispatched')),
				'dispatched_delta'=>
				(
			...
			array('header'=>get_quarter_label(strtotime('now -3 months')),
				'invoiced_amount_delta_title'=>delta($part->get('Part 1 Quarter Ago Invoiced Amount'), $part->get('Part 1 Quarter Ago 1YB Invoiced Amount')),
				'invoiced_amount_delta'=>
				(
				...
				'dispatched_delta_title'=>delta($part->get('Part 1 Quarter Ago Dispatched'), $part->get('Part 1 Quarter Ago 1YB Dispatched')),
				'dispatched_delta'=>
				(
			...
			array('header'=>get_quarter_label(strtotime('now -6 months')),
				'invoiced_amount_delta_title'=>delta($part->get('Part 2 Quarter Ago Invoiced Amount'), $part->get('Part 2 Quarter Ago 1YB Invoiced Amount')),
				'invoiced_amount_delta'=>
				(
				...
				'dispatched_delta_title'=>delta($part->get('Part 2 Quarter Ago Dispatched'), $part->get('Part 2 Quarter Ago 1YB Dispatched')),
				'dispatched_delta'=>
				(
			...
			array('header'=>get_quarter_label(strtotime('now -9 months')),
				'invoiced_amount_delta_title'=>delta($part->get('Part 3 Quarter Ago Invoiced Amount'), $part->get('Part 3 Quarter Ago 1YB Invoiced Amount')),
				'invoiced_amount_delta'=>
				(
				...
				'dispatched_delta_title'=>delta($part->get('Part 3 Quarter Ago Dispatched'), $part->get('Part 3 Quarter Ago 1YB Dispatched')),
				'dispatched_delta'=>
				(
			...
			array('header'=>get_quarter_label(strtotime('now -12 months')),
				...
				'dispatched_delta_title'=>delta($part->get('Part 4 Quarter Ago Dispatched'), $part->get('Part 4 Quarter Ago 1YB Dispatched')),
				'dispatched_delta'=>
				(
	...
	$smarty->assign('year_data',
		array(
			array('header'=>date('Y', strtotime('now')) ,
				'invoiced_amount_delta_title'=>delta($part->get('Part Year To Day Acc Invoiced Amount'), $part->get('Part Year To Day Acc 1YB Invoiced Amount')),
				'invoiced_amount_delta'=>
				(
				...
				'dispatched_delta_title'=>delta($part->get('Part Year To Day Acc Dispatched'), $part->get('Part Year To Day Acc 1YB Dispatched')),
				'dispatched_delta'=>
				(
			...
			array('header'=>date('Y', strtotime('now -1 year')),
				'invoiced_amount_delta_title'=>delta($part->get('Part 1 Year Ago Invoiced Amount'), $part->get('Part 2 Year Ago Invoiced Amount')),
				'invoiced_amount_delta'=>
				(
				...
				'dispatched_delta_title'=>delta($part->get('Part 1 Year Ago Dispatched'), $part->get('Part 2 Year Ago Dispatched')),
				'dispatched_delta'=>
				(
			...
			array('header'=>date('Y', strtotime('now -2 year')),
				'invoiced_amount_delta_title'=>delta($part->get('Part 2 Year Ago Invoiced Amount'), $part->get('Part 3 Year Ago Invoiced Amount')),
				'invoiced_amount_delta'=>
				(
				...
				'dispatched_delta_title'=>delta($part->get('Part 2 Year Ago Dispatched'), $part->get('Part 3 Year Ago Dispatched')),
				'dispatched_delta'=>
				(
			...
			array('header'=>date('Y', strtotime('now -3 year')),
				'invoiced_amount_delta_title'=>delta($part->get('Part 3 Year Ago Invoiced Amount'), $part->get('Part 4 Year Ago Invoiced Amount')),
				'invoiced_amount_delta'=>
				(
					$part->get('Part 3 Year Ago Invoiced Amoun')>$part->get('Part 4 Year Ago Invoiced Amount')
					?'<i class="fa fa-fw fa-play fa-rotate-270 success" aria-hidden="true"></i>':
					($part->get('Part 3 Year Ago Invoiced Amount')<$part->get('Part 4 Year Ago Invoiced Amount')?
						'<i class="fa fa-fw fa-play fa-rotate-90 error" aria-hidden="true"></i>':''
					)
				),
				'dispatched_delta_title'=>delta($part->get('Part 3 Year Ago Dispatched'), $part->get('Part 4 Year Ago Dispatched')),
				'dispatched_delta'=>
				(
					$part->get('Part 3 Year Ago Invoiced Amoun')>$part->get('Part 4 Year Ago Dispatched')
					?'<i class="fa fa-fw fa-play fa-rotate-270 success" aria-hidden="true"></i>':
			...
			array('header'=>date('Y', strtotime('now -4 year')),
				'invoiced_amount_delta_title'=>delta($part->get('Part 4 Year Ago Invoiced Amount'), $part->get('Part 5 Year Ago Invoiced Amount')),
				'invoiced_amount_delta'=>
				(
				...
				'dispatched_delta_title'=>delta($part->get('Part 4 Year Ago Dispatched'), $part->get('Part 5 Year Ago Dispatched')),
				'dispatched_delta'=>
				(
