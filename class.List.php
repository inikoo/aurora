...
class SubjectList extends DB_Table {
    ...
    function find($raw_data, $options) {
        ...
        $sql = sprintf(
            "SELECT `List Key` FROM `List Dimension` WHERE `List Name`=%s AND  `List Scope`=%s AND `List Parent Key`=%d", prepare_mysql($data['List Name']), prepare_mysql($data['List Scope']),
