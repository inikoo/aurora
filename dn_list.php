...
$general_options_list[]=array('tipo'=>'url','url'=>'orders_lists.php?store='.$store->id,'label'=>_('Delivery Notes Lists'));
$general_options_list[]=array('tipo'=>'url','url'=>'orders.php?store='.$store->id,'label'=>_('Delivery Notes'));
