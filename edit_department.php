...
if (isset($_REQUEST['id']) and is_numeric($_REQUEST['id']) )
	...
	exit('no department id');

}


if (!$department->id) {
	exit('Department can not be found');
}
...
if (isset($_REQUEST['edit_details_subtab']) and in_array($_REQUEST['edit_details_subtab'],array('code'))) {
	$edit_details_subtab=$_REQUEST['edit_details_subtab'];
	$_SESSION['state']['department']['edit_details_subtab']=$edit;
} else {
	$edit_details_subtab=$_SESSION['state']['department']['edit_details_subtab'];
}

$smarty->assign('edit_details_subtab',$edit_details_subtab);
