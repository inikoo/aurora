...
YAHOO.util.Event.addListener(window, "load", function() {
    tables = new function() {
	    ...
	    var OrdersColumnDefs = [ 
				    ...
				    ,{key:"delete", label:"", width:170,sortable:false,className:"aleft",action:'delete',object:'company_area'}
				    ,{key:"delete_type", label:"",hidden:true,isTypeKey:true}
				     ];

	    this.dataSource0 = new YAHOO.util.DataSource("ar_edit_contacts.php?tipo=edit_company_areas&parent=corporation");
...
function init(){
 ...
 YAHOO.util.Event.addListener('add_area', "click", show_add_area_dialog);
    ...
    var store_code_oAutoComp = new YAHOO.widget.AutoComplete("Company_Area_Code","Company_Area_Code_Container", store_code_oACDS);
    ...
    var store_name_oAutoComp = new YAHOO.widget.AutoComplete("Company_Area_Name","Company_Area_Name_Container", store_name_oACDS);
