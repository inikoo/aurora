...
<tr><td  class="label">{t}Email{/t}: </td><td><input id="login_handle"></td></tr>
<tr><td  class="label">{t}Password{/t}: </td><td><input type="password"  id="login_password"></td></tr>
<tr><td  class="label">{t}Remember Me{/t}: </td><td style="text-align:left;"><input style="width:20px;border:none" type="checkbox" name="remember_me" id="remember_me" value="0"/></td></tr>
...
<table style="margin-top:20px;clear:left;float;left">
<tr class="link space"><td colspan=2>{t}Don't know your password?{/t} <span  class="link"  id="link_forgot_password_from_login" >{t}Click Here{/t}</span></td></tr>
<tr id="tr_link_register_from_login" class="link" ><td colspan=2>{t}First visit?{/t} <span class="link" onClick='window.location="registration.php"' id="link_register_from_login">{t}Register Here{/t}</span></td></tr>
<tr style="display:none" id="tr_link_register_from_login2" class="link"><td colspan=2>{t}Use another email{/t}, <span class="link" id="link_register_from_login2">{t}Register Here{/t}</span></td></tr>
</table>
</div>
{/if}

<div id="dialog_forgot_password" style="display:none;float:left" >
<h2>{t}Forgotten password{/t}</h2>
<div style="border:1px solid #ccc;padding:20px;width:400px;float:left">
...
<tr><td  class="label" style="text-align:right;width:120px">{t}Email{/t}: </td><td><input id="forgot_password_handle"></td></tr>


<tr >
<td class="label" style="text-align:left;width:120px">
<img id="captcha2"  src="art/x.png" style="height:40px;width:115px"  alt="CAPTCHA Image" />
<span class="captcha_change_image" onclick="document.getElementById('captcha2').src = 'securimage_show.php?' + Math.random(); return false">{t}Change Image{/t}</span>

</td>
<td style="vertical-align:top">
<span style="font-size:10px">{t}input the letters shown on the left{/t}</span><br/>
...
<div class="buttons">
<button id="submit_forgot_password" class="positive">{t}Send Email{/t}</button> 
<button id="cancel_forgot_password" class="negative">{t}Cancel{/t}</button>
</div>
</td>
</tr>
</table>
...
<table style="margin-top:20px;clear:left">
<tr class="link space"><td colspan=2>{t}Want to try to login again?{/t} <span  class="link"  id="show_login_dialog2" >{t}Click Here{/t}</span></td></tr>
<tr id="tr_link_register_from_login" class="link" ><td colspan=2>{t}First visit?{/t} <span class="link" onClick='window.location="registration.php"' id="link_register_from_login">{t}Register Here{/t}</span></td></tr>
</table>
</div>
