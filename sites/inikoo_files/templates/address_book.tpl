...
<tr>
<td><div class="buttons" style="float:left"><button type="submit" ><img src="art/icons/chart_pie.png" alt="">Edit</button></div></td>
<td><div class="buttons" style="float:left"><button type="submit" ><img src="art/icons/chart_pie.png" alt="">Add</button><button type="submit" ><img src="art/icons/chart_pie.png" alt="">Edit</button></div></td>
<td><div class="buttons" style="float:left"><button type="submit" ><img src="art/icons/chart_pie.png" alt="">Add</button><button type="submit" ><img src="art/icons/chart_pie.png" alt="">Edit</button></div></td>
</tr>
<tr>
<td>
