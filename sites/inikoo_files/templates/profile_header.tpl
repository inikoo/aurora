<div class="top_page_menu" style="padding:10px 20px 5px 20px;width:920px">
	<div class="buttons" style="float:left">
		<button  {if $select == 'address_book'}class="selected"{/if} onclick="window.location='profile.php?view=address_book'"><img src="art/icons/book_addresses.png" alt=""> {t}Address Book{/t}</button> 
