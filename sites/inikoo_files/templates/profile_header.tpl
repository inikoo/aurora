<div class="top_page_menu" style="padding:10px 20px 5px 20px;width:920px">
	<div class="buttons" style="float:left">
		...
		<button style="display:none"  {if  $select == 'products'}class="selected"{/if} onclick="window.location='profile.php?view=orders'"><img src="art/icons/bricks.png" alt=""> {t}Products Ordered{/t}</button> 
