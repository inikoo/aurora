...
<option value="PF">Polynesien</option>
...
<option value="GS">S. Georgia- und S. Sandwich-Inseln</option>
...
<option value="VI">US-Jungferninseln</option>
...
<option value="US">Vereinigte Sataten von Amerika</option>
