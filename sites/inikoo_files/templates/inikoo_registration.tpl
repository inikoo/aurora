...
<div id="dialog_register"  class="dialog_inikoo"   border=style="z-index:20000; position:relative;">
<h2>Registration</h2>
<table>
...
<div id="dialog_register_part_2"   class="dialog_inikoo"    style="position:relative; z-index:20000;"  >
...
<tr><td class="label">{$cat->get('Category Label')}:</td><td><select id="{$cat_key}" cat_key="{$cat_key}"  onChange="update_category(this)">;
...
<img id="captcha" src="{$path}inikoo_files/art/x.png" /> <br>
<i><a href="#" style="color:black" onclick="{literal}document.getElementById('captcha').src = '{/literal}{$path}{literal}inikoo_files/securimage_show.php?' + Math.random(); return false{/literal}">Different Image</a></i>
...
<tr id="tr_register_part_2_wait"  style="display:none" class="button" ><td colspan=2><img style="weight:24px" src="{$path}inikoo_files/art/loading.gif"> <span style="position:relative;top:-5px">Creating your account</span></td>
</tr>
...
<div id="dialog_email_in_db"    class="dialog_inikoo"    style="xdisplay:block">
...
<img id="captcha3" src="{$path}inikoo_files/art/x.png" alt="CAPTCHA Image" /> <br>
<i><a style="font-size:10px" href="#" onclick="onclick="{literal}document.getElementById('captcha3').src = '{/literal}{$path}{literal}inikoo_files/securimage_show.php?' + Math.random(); return false{/literal}">Different Image</a></i>
...
<tr id="tr_forgot_password_wait2"  style="display:none" class="button" ><td colspan=2><img style="weight:24px" src="{$path}inikoo_files/art/loading.gif"> <span style="position:relative;top:-5px">processing request</span></td></tr>
...
<div id="dialog_login"    class="dialog_inikoo"   >
...
<div id="dialog_change_password"    class="dialog_inikoo logged" style="{if $authentication_type=='masterkey'}display:block{/if}"  >
<h2>{if $authentication_type=='masterkey'}{t}Reset your password{/t}{else}{t}Change Password{/t}{/if}</h2>
...
<tr id="tr_change_password_wait"  style="display:none" class="button" ><td colspan=2><img style="weight:24px" src="{$path}inikoo_files/art/wait.gif"> <span style="position:relative;top:-5px">Submitting changes</span></td></tr>
...
<div id="dialog_forgot_password"    class="dialog_inikoo" >
...
<img id="captcha2"  src="{$path}inikoo_files/art/x.png" alt="CAPTCHA Image" />
<i><a style="color:#000" href="#" onclick="{literal}document.getElementById('captcha2').src = '{/literal}{$path}{literal}inikoo_files/securimage_show.php?' + Math.random(); return false{/literal}">Change&nbsp;Image</a></i>
...
<tr id="tr_forgot_password_wait"  style="display:none" class="button" ><td colspan=2><img style="weight:24px" src="{$path}inikoo_files/art/wait.gif"> <span style="position:relative;top:-5px">processing request</span></td></tr>
