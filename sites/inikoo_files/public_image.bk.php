...
if(isset($_SERVER['HTTP_IF_MODIFIED_SINCE'])){
	$sapi=$_SERVER['HTTP_IF_MODIFIED_SINCE'];
}

	$sql=sprintf("select $image_data ,`Image Original Filename`,`Image File Format`,`Image Key` from `Image Dimension` where `Image Key`=%d",$id);
