...
$_SESSION['state']['world']['countries']['order']='name';
$_SESSION['state']['world']['countries']['order_dir']='asc';
$_SESSION['state']['world']['countries']['f_field']='country_code';
$_SESSION['state']['world']['countries']['f_value']='';
...
$general_options_list[]=array('class'=>'return','tipo'=>'url','url'=>'profile.php?id='.$customer->id,'label'=>_('Customer').' &#8617;');
...
if(!isset($_SESSION['state']['customer']['edit']))
	$_SESSION['state']['customer']['edit']='details';
...
$js_files[]=sprintf('client.js.php?id=%d&forgot_count=%d&register_count=%d',$customer->id,count($registered_email),count($unregistered_email));
