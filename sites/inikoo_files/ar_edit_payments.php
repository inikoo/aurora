...
function create_payment($data) {
	...
	$payment_data=array(
		...
		'Payment_Account_Return_Link_Good'=>$site->data['Site URL']."/thanks.php?id=".$order->id,
		'Payment_Account_Return_Link_Bad'=>$site->data['Site URL']."/return_cancelled_Paypal.php?payment_key=".$payment->id,
