...
function create_payment($data) {
	...
	$payment_data=array(
		...
		'Payment_Account_Return_Link_Good'=>'https://'.$site->data['Site URL']."/thanks.php?id=".$order->id,
		'Payment_Account_Return_Link_Bad'=>'https://'.$site->data['Site URL']."/return_cancelled_Paypal.php?payment_key=".$payment->id,
		'Paypal_Callback_URL'=>'https://'.$site->data['Site URL']."/callback_payment_Paypal.php",
		'Worldpay_Callback_URL'=>'https://'.$site->data['Site URL']."/callback_payment_Worldpay.php",
