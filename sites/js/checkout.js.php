	...
	YAHOO.util.Connect.asyncRequest(
					...
					success:function(o) {
					   // alert(o.responseText);
						...
						Dom.get('order_items_gross').innerHTML=r.data.amount_items;
						Dom.get('order_items_discount').innerHTML=r.data.amount_discounts;

						Dom.get('order_shipping').innerHTML=r.data.amount_shipping;
												Dom.get('order_charges').innerHTML=r.data.amount_charges;

						Dom.get('order_net').innerHTML=r.data.amount_total_net;
						Dom.get('order_tax').innerHTML=r.data.amount_tax;
						Dom.get('order_total').innerHTML=r.data.amount_total;
								   ...
								   this.dataSource0, {
								      renderLoopSize: 50,generateRequest : myRequestBuilder
								       ,paginator : new YAHOO.widget.Paginator({
									      rowsPerPage:250,containers : 'paginator0', 
