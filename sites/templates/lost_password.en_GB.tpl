...
<div id="page_content" >
	 ...
	 <div id="email_send" style="margin-top:15px;display:none"><p>An email has been send to you, please follow the instructions on it.</p><p class="verysmall">Remember that you can always call us if you have any trouble at <br/>{$tel}</p></div>
	 <div id="error" style="margin-top:15px;display:none"><p>An error has occurred.</p><p class="verysmall">Please try again, if you still has troubles call us at <br/>{$tel}</p></div>
