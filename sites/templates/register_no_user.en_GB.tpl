{include  file="$head_template"}
 <body>
   <div id="container" >
	...
	<div id="page_content" style="{$page_data.content_style}" >
		...
		<div id="central_content" style="min-height:600px;width:600px">
 {include file="templates/search_input.tpl"}
	   ...
	   <p id="email_error_msg_1" style="display:none">Hey, you forgot to write the email, <b>please write your email address</b>.</p>
	     ...
	     <p id="customer_details_msg3" style="display:none">Please fill the requered field</p>
			...
			<table>
	     		<tr ><td id="company_label" style="width:160px">Company:</td><td><input id="company_name" style="width:240px" type="text"></td><td></td></tr>
	     			     	<tr><td colspan=2 style="color:red;font-size:90%" id="customer_details_instructions"></td></tr>

	     		<tr ><td id="company_label">Name:</td><td><input id="person_contact" style="width:240px" type="text"></td><td></td></tr>
	     	</table>
	     	<table style="margin-top:0px">
	     	<tr><td colspan=2 style="color:red;font-size:90%" id="email_instructions"></td></tr>
	     	<tr ><td id="email_label"  style="width:160px">Email:</td><td><input id="email" style="width:240px" type="text"></td>
	     	<td >
    ...
    <option value="Zimbabwe">Zimbabwe</option>
		 ...
		 <table border=0 style="margin-top:10px">
	     	...
	     	<tr ><td id="cat_type_label"  style="width:160px">Type of Business:</td><td><select name="Senders_Business">
    ...
    <option value="Other">Other Business</option>
		 ...
		 <tr ><td id="cat_how_label" style="font-size:80%" >How did you heard of us?:</td><td><select name="Advertising">
      <option value="">Select</option>
      ...
      <option value="Giftware Index Website">Giftware Index Website</option>
    ...
    <option value="Market Trader Magazine">Market Trader Magazine</option>
 ...
 <option value="The Wholesaler Website">The Wholesaler Website</option>
 <option value="The Wholesale Pages">The Wholesale Pages</option>
        <option value="Other">Other</option>
	     		...
	     		<table border=0 style="margin-top:20px;width:480px">
	       <tr>
		 <td style="" style="text-align:center" align='center' >
		  
		 
		   <span class="button disabled" id="submit" ">Submit</span>
		 </td>
	     </table>
