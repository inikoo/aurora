<?php /* Smarty version 2.6.22, created on 2010-10-19 11:30:38
         compiled from ../templates/family.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 't', '../templates/family.tpl', 10, false),)), $this); ?>
...
unset($_smarty_tpl_vars);
 ...
 <div class="branch"> 
 <span ><a  href="store.php?id=<?php echo $this->_tpl_vars['store']->id; ?>
"><?php echo $this->_tpl_vars['store']->get('Store Name'); ?>
</a> &rarr; <a  href="department.php?id=<?php echo $this->_tpl_vars['department']->id; ?>
"><?php echo $this->_tpl_vars['department']->get('Product Department Name'); ?>
</a> &rarr; <?php echo $this->_tpl_vars['family']->get('Product Family Name'); ?>
  (<?php echo $this->_tpl_vars['family']->get('Product Family Code'); ?>
)</span>
 </div>

  <div id="no_details_title" style="clear:right;<?php if ($this->_tpl_vars['show_details']): ?>display:none;<?php endif; ?>">
    <h1><?php $this->_tag_stack[] = array('t', array()); $_block_repeat=true;smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Family<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>: <?php echo $this->_tpl_vars['family']->get('Product Family Name'); ?>
 (<?php echo $this->_tpl_vars['family']->get('Product Family Code'); ?>
)</h1>
  </div>
...
<div style="width:300px;float:left;margin-left:20px">
  <table    class="show_info_product">
      <tr >
<td colspan="2" class="aright" style="padding-right:10px"> <span class="product_info_sales_options" id="info_period"><span id="info_title"><?php echo $this->_tpl_vars['department_period_title']; ?>
</span></span>
	...
	<tr >
      ...
      <tbody id="info_year"  style="<?php if ($this->_tpl_vars['department_period'] != 'year'): ?>display:none<?php endif; ?>">
      	<tr >
	  <td><?php $this->_tag_stack[] = array('t', array()); $_block_repeat=true;smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Customers<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>:</td><td class="aright"><?php echo $this->_tpl_vars['family']->get('1 Year Acc Customers'); ?>
</td>
	</tr>
		<tr >
	  <td><?php $this->_tag_stack[] = array('t', array()); $_block_repeat=true;smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Invoices<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>:</td><td class="aright"><?php echo $this->_tpl_vars['family']->get('1 Year Acc Invoices'); ?>
</td>
	</tr>

	<tr >
	  <td><?php $this->_tag_stack[] = array('t', array()); $_block_repeat=true;smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Sales<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>:</td><td class=" aright"><?php echo $this->_tpl_vars['family']->get('1 Year Acc Invoiced Amount'); ?>
</td>
	</tr>
	<tr >
	  <td><?php $this->_tag_stack[] = array('t', array()); $_block_repeat=true;smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Profit<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>:</td><td class=" aright"><?php echo $this->_tpl_vars['family']->get('1 Year Acc Profit'); ?>
</td>
	</tr>
	<tr >
	  <td><?php $this->_tag_stack[] = array('t', array()); $_block_repeat=true;smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Outers<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>:</td><td class="aright"><?php echo $this->_tpl_vars['family']->get('1 Year Acc Quantity Delivered'); ?>
</td>
	</tr>

      </tbody>
        <tbody id="info_quarter" style="<?php if ($this->_tpl_vars['department_period'] != 'quarter'): ?>display:none<?php endif; ?>"  >
        <tr >
	     <td><?php $this->_tag_stack[] = array('t', array()); $_block_repeat=true;smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Orders<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>:</td><td class="aright"><?php echo $this->_tpl_vars['family']->get('1 Quarter Acc Invoices'); ?>
</td>
	    </tr>
        <tr >
	  <td><?php $this->_tag_stack[] = array('t', array()); $_block_repeat=true;smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Customers<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>:</td><td class="aright"><?php echo $this->_tpl_vars['family']->get('1 Quarter Acc Customers'); ?>
</td>
	</tr>
	<tr >
	  <td><?php $this->_tag_stack[] = array('t', array()); $_block_repeat=true;smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Sales<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>:</td><td class=" aright"><?php echo $this->_tpl_vars['family']->get('1 Quarter Acc Invoiced Amount'); ?>
</td>
	</tr>
	<tr >
	  <td><?php $this->_tag_stack[] = array('t', array()); $_block_repeat=true;smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Profit<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>:</td><td class=" aright"><?php echo $this->_tpl_vars['family']->get('1 Quarter Acc Profit'); ?>
</td>
	</tr>
	<tr >
	  <td><?php $this->_tag_stack[] = array('t', array()); $_block_repeat=true;smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Outers<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>:</td><td class="aright"><?php echo $this->_tpl_vars['family']->get('1 Quarter Acc Quantity Delivered'); ?>
</td>
	</tr>	
      </tbody>
        <tbody id="info_month" style="<?php if ($this->_tpl_vars['department_period'] != 'month'): ?>display:none<?php endif; ?>"  >
        <tr >
	     <td><?php $this->_tag_stack[] = array('t', array()); $_block_repeat=true;smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Orders<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>:</td><td class="aright"><?php echo $this->_tpl_vars['family']->get('1 Month Acc Invoices'); ?>
</td>
	    </tr>
        <tr >
	  <td><?php $this->_tag_stack[] = array('t', array()); $_block_repeat=true;smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Customers<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>:</td><td class="aright"><?php echo $this->_tpl_vars['family']->get('1 Month Acc Customers'); ?>
</td>
	</tr>
	<tr >
	  <td><?php $this->_tag_stack[] = array('t', array()); $_block_repeat=true;smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Sales<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>:</td><td class=" aright"><?php echo $this->_tpl_vars['family']->get('1 Month Acc Invoiced Amount'); ?>
</td>
	</tr>
	<tr >
	  <td><?php $this->_tag_stack[] = array('t', array()); $_block_repeat=true;smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Profit<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>:</td><td class=" aright"><?php echo $this->_tpl_vars['family']->get('1 Month Acc Profit'); ?>
</td>
	</tr>
	<tr >
	  <td><?php $this->_tag_stack[] = array('t', array()); $_block_repeat=true;smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Outers<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>:</td><td class="aright"><?php echo $this->_tpl_vars['family']->get('1 Month Acc Quantity Delivered'); ?>
</td>
	</tr>	
      </tbody>
       <tbody id="info_week" style="<?php if ($this->_tpl_vars['department_period'] != 'week'): ?>display:none<?php endif; ?>"  >
        <tr >
	     <td><?php $this->_tag_stack[] = array('t', array()); $_block_repeat=true;smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Orders<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>:</td><td class="aright"><?php echo $this->_tpl_vars['family']->get('1 Week Acc Invoices'); ?>
</td>
	    </tr>
        <tr >
	  <td><?php $this->_tag_stack[] = array('t', array()); $_block_repeat=true;smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Customers<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>:</td><td class="aright"><?php echo $this->_tpl_vars['family']->get('1 Week Acc Customers'); ?>
</td>
	</tr>
	<tr >
	  <td><?php $this->_tag_stack[] = array('t', array()); $_block_repeat=true;smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Sales<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>:</td><td class=" aright"><?php echo $this->_tpl_vars['family']->get('1 Week Acc Invoiced Amount'); ?>
</td>
	</tr>
	<tr >
	  <td><?php $this->_tag_stack[] = array('t', array()); $_block_repeat=true;smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Profit<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>:</td><td class=" aright"><?php echo $this->_tpl_vars['family']->get('1 Week Acc Profit'); ?>
</td>
	</tr>
	<tr >
	  <td><?php $this->_tag_stack[] = array('t', array()); $_block_repeat=true;smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Outers<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>:</td><td class="aright"><?php echo $this->_tpl_vars['family']->get('1 Week Acc Quantity Delivered'); ?>
</td>
	</tr>	
      </tbody>
...
<div id="plot" class="top_bar" style="position:relative;left:-20px;clear:both;padding:0;margin:0;<?php if (! $this->_tpl_vars['show_details']): ?>display:none;<?php endif; ?>">
      ...
      <div display="none" id="plot_info" keys="<?php echo $this->_tpl_vars['store']->id; ?>
" ></div>
      <ul id="plot_chooser" class="tabs" style="margin:0 20px;padding:0 20px "  >
	<li>
	  <span class="item <?php if ($this->_tpl_vars['plot_tipo'] == 'store'): ?>selected<?php endif; ?>" onClick="change_plot(this)" id="plot_store" tipo="store" category="<?php echo $this->_tpl_vars['plot_data']['store']['category']; ?>
" period="<?php echo $this->_tpl_vars['plot_data']['store']['period']; ?>
" >
	    <span><?php echo $this->_tpl_vars['family']->get('Product Family Code'); ?>
 <?php $this->_tag_stack[] = array('t', array()); $_block_repeat=true;smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Family<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></span>
	  </span>
	</li>
	<li>
	  <span class="item <?php if ($this->_tpl_vars['plot_tipo'] == 'top_departments'): ?>selected<?php endif; ?>"  id="plot_top_departments" onClick="change_plot(this)" tipo="top_departments" category="<?php echo $this->_tpl_vars['plot_data']['top_departments']['category']; ?>
" period="<?php echo $this->_tpl_vars['plot_data']['top_departments']['period']; ?>
" name=""  >
	    <span><?php $this->_tag_stack[] = array('t', array()); $_block_repeat=true;smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Top Products<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></span>
	  </span>
	</li>
	<li>
...
<div class="data_table"  style="clear:both">
    ...
    <div id="list_options0"> 
      ...
      <span   style="float:right;margin-left:20px" class="state_details" state="<?php echo $this->_tpl_vars['show_percentages']; ?>
"  id="show_percentages"  atitle="<?php if ($this->_tpl_vars['show_percentages']): ?><?php $this->_tag_stack[] = array('t', array()); $_block_repeat=true;smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Normal Mode<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?><?php else: ?><?php $this->_tag_stack[] = array('t', array()); $_block_repeat=true;smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Comparison Mode<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?><?php endif; ?>"  ><?php if ($this->_tpl_vars['show_percentages']): ?><?php $this->_tag_stack[] = array('t', array()); $_block_repeat=true;smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Comparison Mode<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?><?php else: ?><?php $this->_tag_stack[] = array('t', array()); $_block_repeat=true;smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Normal Mode<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?><?php endif; ?></span>     
      <span   style="float:right;margin-left:80px" class="state_details" state="<?php echo $this->_tpl_vars['show_only']; ?>
"  id="show_only"    ><?php echo $this->_tpl_vars['show_only_label']; ?>
</span>   
    ...
    <table style="float:left;margin:0 0 5px 0px ;padding:0"  class="options" >
	  ...
	  <td  <?php if ($this->_tpl_vars['view'] == 'parts'): ?>class="selected"<?php endif; ?>  id="parts"  ><?php $this->_tag_stack[] = array('t', array()); $_block_repeat=true;smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Parts<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></td>
	  <td  <?php if ($this->_tpl_vars['view'] == 'cats'): ?>class="selected"<?php endif; ?>  id="cats"  ><?php $this->_tag_stack[] = array('t', array()); $_block_repeat=true;smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Groups<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></td>
    ...
    <table  id="avg_options" style="float:left;margin:0 0 0 20px ;padding:0<?php if ($this->_tpl_vars['view'] != 'sales'): ?>;display:none<?php endif; ?>"  class="options_mini" >
	<tr>
	  ...
	  <td <?php if ($this->_tpl_vars['avg'] == 'month_eff'): ?>class="selected"<?php endif; ?> style="display:none" avg="month_eff"  id="avg_month_eff"  ><?php $this->_tag_stack[] = array('t', array()); $_block_repeat=true;smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>M EAVG<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></td>
	  <td <?php if ($this->_tpl_vars['avg'] == 'week_eff'): ?>class="selected"<?php endif; ?> style="display:none"  avg="week_eff"  id="avg_week_eff"  ><?php $this->_tag_stack[] = array('t', array()); $_block_repeat=true;smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>W EAVG<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></td>
	</tr>
      </table>
    </div>
...
unset($_smarty_tpl_vars);
 ?>
    ...
    <div  id="table0"   class="data_table_container dtable btable with_total"  style="<?php if ($this->_tpl_vars['table_type'] == 'thumbnails'): ?>display:none<?php endif; ?>"   > </div>
