...
$general_options_list[]=array('tipo'=>'url','url'=>'orders_lists.php?store='.$store->id,'label'=>_('Orders Lists'));
$general_options_list[]=array('tipo'=>'url','url'=>'orders.php?store='.$store->id,'label'=>_('Orders'));
...
$smarty->display('orders_list.tpl');
?>
