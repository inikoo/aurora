...
/*
 ...
 Created: 21 November 2018 at 02:12:09 GMT+8, Kuala Lumpur, Malaysia
...
$editor = array(
    ...
    'Subject'      => 'System',
    'Subject Key'  => 0,
    'Author Name'  => 'System (Stack supplier category sales)',
    'Author Alias' => 'System (Stack supplier category sales)',
    'v'            => 3
...
$sql = sprintf("SELECT count(*) AS num FROM `Stack Dimension`  where `Stack Operation` in ('supplier_category_sales')");
