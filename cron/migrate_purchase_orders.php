...
$sql=sprintf('update  `Purchase Order Dimension` set `Part Package Description`=`Part Unit Description`;  ');
$db->exec($sql);
...
if ($result=$db->query($sql)) {
	foreach ($result as $row) {
		...
		$currency_exchange = new CurrencyExchange($row['Purchase Order Currency Code'].$account->get('Account Currency'));
