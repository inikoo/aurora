...
/*
 ...
 Created: Fri 12 April  2019 10:58:26 MYT , Kuala Lumpur, Malaysia
...
if ($result = $db->query($sql)) {
    foreach ($result as $row) {
        ...
        if (isset($content_data['blocks']) and is_array($content_data['blocks'])) {
            foreach ($content_data['blocks'] as $block_id => $block) {
                ...
                if ($block['type'] == 'image'   ) {
                   ...
                   // print_r($block);
                    ...
                    $content_data['blocks'][$block_id]=$new_block;
                    $changed=true;
        ...
        if($changed){
            ...
            print $webpage->get('Code').' '.$webpage->get('URL')."\n";
