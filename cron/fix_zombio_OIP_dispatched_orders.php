...
while ($row = $stmt->fetch()) {
   ...
   // print_r($row);
    ...
    print $counter.' '.$row['Delivery Note ID'].' '.$row['Required'].' '.$part->get('Reference')."\n";
