...
if (isset($_REQUEST['tipo'])) {
	$tipo=$_REQUEST['tipo'];
	$_SESSION['state']['store']['period']=$tipo;
}else {
	$tipo=$_SESSION['state']['store']['period'];
}
...
$smarty->assign('report_url','store.php');
...
$smarty->assign('store_sales_history_type',$_SESSION['state']['store']['sales_history']['type']);
