...
//	   	alert(request)
   ...
   var tableid=7;
		    ...
		    request="ar_reports.php?tipo=inventory_assets_sales_history&parent=supplier_categories&parent_key="+Dom.get('category_key').value+"&tableid="+tableid+'&from='+Dom.get('from').value+'&to='+Dom.get('to').value;
