...
YAHOO.util.Event.addListener(window, "load", function() {
    tables = new function() {
		...
		metaFields: {
								 ...
								 formatRow: myRowFormatter,
								     renderLoopSize: 0,generateRequest : myRequestBuilder
								       ,paginator : new YAHOO.widget.Paginator({
									      rowsPerPage    : <?php echo$_SESSION['state']['hq']['history']['nr']?>,containers : 'paginator0', 
								     ...
								     ,sortedBy : {
									 key: "<?php echo$_SESSION['state']['hq']['history']['order']?>",
									 dir: "<?php echo$_SESSION['state']['hq']['history']['order_dir']?>"
								     },
								     dynamicData : true
		    ...
		    this.table0.filter={key:'<?php echo$_SESSION['state']['hq']['history']['f_field']?>',value:'<?php echo$_SESSION['state']['hq']['history']['f_value']?>'};
