...
if (isset($_REQUEST['edit_details_subtab']) and in_array($_REQUEST['edit_details_subtab'],array('code'))) {
	...
	$_SESSION['state']['family']['edit_details_subtab']=$edit;
} else {
	$edit_details_subtab=$_SESSION['state']['family']['edit_details_subtab'];
}
...
$tipo_filter=$_SESSION['state']['family']['edit_offers']['f_field'];
$smarty->assign('filter4',$tipo_filter);
$smarty->assign('filter_value4',$_SESSION['state']['family']['edit_offers']['f_value']);
$filter_menu=array(
	'name'=>array('db_key'=>'name','menu_label'=>_('Name'),'label'=>_('Name')),
