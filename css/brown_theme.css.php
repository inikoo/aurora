...
html{background-color:#fff;background-image:url('<?php if(isset($_GET["c"])) {echo "../uploads/".isset($_GET["c"]);} else echo "../art/bg/theme_bg.jpg"; ?>');
background-repeat:repeat-x;}


#hd{height:3.46em;background:#3b5998 url("../art/2.png") bottom left repeat-x;color:#fff;}
#hd #navsite li {
		float: right;
		background: transparent url("../art/brown_bg_side.png") 100%  no-repeat!important;
	...
	#hd #navsite ul a {
		...
		background: transparent url("../art/brown_header_menu.png") 0%  no-repeat!important;
		background:none;
		font-weight: bold;
		outline: none;
		text-decoration: none;
	}
	#hd #navsite ul li:hover {background: transparent url("../art/brown_header_menu2h.png") 100%  no-repeat!important;background:none }
	#hd #navsite ul li:hover a { text-decoration:none;background: transparent url("../art/brown_header_menu_hover.png") 0%  no-repeat!important;background:none}
...
.table_manager div.centre_block {height:10px;border-top:1px solid .table_manager div.centre_block {height:10px;border-top:1px solid  #F2B037;background:Lavender;};background:Lavender;}
table.show_info_product {border-top:1px solid #F2B037;border-bottom:1px solid #F2B037;width:100%}



.options td.selected,.options span.selected{background:#F2AF32;border:1px solid #BD6A14;color:#f6f6f6;text-decoration:none}

span.nav2 {float:left;background:#F2Af32;padding:0 10px;position:relative;bottom:6px;color:#fff;font-size:85%;margin:0 2px}
.options_mini td.selected {
  background: none repeat scroll 0 0 #F2AF32;
    border: 1px solid #BD6A14;
    color: #F6F6F6;
}
...
.data_table_container {width:100%;clear:both;border-top:1px solid #F2B037;border-bottom:1px solid #F2B037;margin-bottom:2px;padding-bottom:1px;}
