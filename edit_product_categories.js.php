...
request="ar_edit_categories.php?tipo=edit_product_category_list&parent=store&parent_key="+Dom.get('store_key').value
//alert(request)
							 ...
							 //draggableColumns:true,
							   renderLoopSize: 50,generateRequest : myRequestBuilder
								       ,paginator : new YAHOO.widget.Paginator({
									      rowsPerPage:<?php echo$_SESSION['state']['product_categories']['edit_categories']['nr']?>,containers : 'paginator', 
							   ...
							   ,sortedBy : {
							    Key: "<?php echo$_SESSION['state']['product_categories']['edit_categories']['order']?>",
							     dir: "<?php echo$_SESSION['state']['product_categories']['edit_categories']['order_dir']?>"
								     }
							   ,dynamicData : true
...
this.table0.table_id=tableid;
	    ...
	    this.table0.filter={key:'<?php echo$_SESSION['state']['product_categories']['edit_categories']['f_field']?>',value:'<?php echo$_SESSION['state']['product_categories']['edit_categories']['f_value']?>'};
 ...
 var tableid=1; // Change if you have more the 1 table
		...
		request="ar_history.php?tipo=product_categories&parent=store&parent_key="+Dom.get('store_id').value+"&tableid=1";
	   ...
	   this.dataSource1.responseType = YAHOO.util.DataSource.TYPE_JSON;
	    ...
	    this.table1 = new YAHOO.widget.DataTable(tableDivEL, CustomersColumnDefs,
							 ...
							 renderLoopSize: 50,generateRequest : myRequestBuilder
							 ,paginator : new YAHOO.widget.Paginator({
								 rowsPerPage    : <?php echo$_SESSION['state']['product_categories']['history']['nr']?>,containers : 'paginator1', alwaysVisible:false,
								 pageReportTemplate : '(<?php echo _('Page')?> {currentPage} <?php echo _('of')?> {totalPages})',
								 previousPageLinkLabel : "<",
								 nextPageLinkLabel : ">",
								 firstPageLinkLabel :"<<",
	    ...
	    this.table1.filter={key:'<?php echo$_SESSION['state']['product_categories']['history']['f_field']?>',value:'<?php echo$_SESSION['state']['product_categories']['history']['f_value']?>'};
...
function update_category_history_elements() {
    ...
    var request = 'tipo=get_category_history_elements&subject=Product&parent=store&parent_key=' + Dom.get('store_key').value;
    YAHOO.util.Connect.asyncRequest('POST', ar_file, {
        success: function(o) {
