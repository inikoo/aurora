...
html{background-color:#fff;background-image:url('<?php if(isset($_GET["c"])) echo "../uploads/".isset($_GET["c"]); else echo "../art/bg/bg4.jpg"; ?>');
...
.options_mini td.selected{background:#F2AF32;border:1px solid #BD6A14;color:#f6f6f6}
