...
function get_navigation($user, $smarty, $data, $db, $account) {
    ...
    switch ($data['module']) {
        ...
        case ('products_server'):
            require_once 'helpers/view/navigation/get_navigation_products.php';
            return get_navigation_products_server($data, $smarty, $user, $db, $account);
        case ('products'):
            require_once 'helpers/view/navigation/get_navigation_products.php';
            return get_navigation_products($data, $smarty, $user, $db, $account);
        ...
        case ('mailroom'):
            ...
            break;
        case ('customers'):
            require_once 'helpers/view/navigation/get_navigation_customers.php';
            return get_navigation_customers($data, $smarty, $user, $db, $account);
        case ('customers_server'):
            require_once 'helpers/view/navigation/get_navigation_customers.php';
            return get_navigation_customers_server($data, $smarty);
        case ('orders_server'):
