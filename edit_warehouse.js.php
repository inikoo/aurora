...
YAHOO.util.Event.addListener(window, "load", function() {
    tables = new function() {
	    ...
	    {key:"wa_key", label:"", hidden:true,action:"none",isPrimaryKey:true}
				       ...
				       ,{key:"description", label:"<?php echo _('Description')?>",width:260,sortable:true,className:"aleft",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_ASC},editor: new YAHOO.widget.TextboxCellEditor({asyncSubmitter: CellEdit}),object:'warehouse_areas'}
