...
validate_scope_data=
{
	...
	'gross_weight':{'changed':true,'validated':true,'required':false,'dbname':'Part Package Weight','group':1,'type':'item','name':'gross_weight','ar':false,'validation':[{'regexp':"[\\d]+",'invalid_msg':'Invalid Weight'}]}
