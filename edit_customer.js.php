...
function send_reset_password(o,user_key,site_key,site_url){
...
Dom.get('user_key').value=user_key;
...
region1 = Dom.getRegion(o); 
	...
	Dom.get('dialog_set_password').focus();
    ...
    YAHOO.util.Connect.asyncRequest('POST', request, {
        success: function(o) {
           ...
           // alert(o.responseText)
			...
			if(r.date==''){
				Dom.setStyle('tax_number_validation_date_tr','display','none')
			}else{
				Dom.setStyle('tax_number_validation_date_tr','display','')

			}
			if(r.name==''){
				Dom.setStyle('tax_number_registered_name_tr','display','none')
			}else{
				Dom.setStyle('tax_number_registered_name_tr','display','')

			}
			
			if(r.address==''){
				Dom.setStyle('tax_number_registered_address_tr','display','none')
			}else{
				Dom.setStyle('tax_number_registered_address_tr','display','')

			}
			
							Dom.get('tax_number_registered_name').innerHTML=r.name
				Dom.get('tax_number_registered_address').innerHTML=r.address

			
				Dom.get('tax_number_validated_date').innerHTML=r.formated_date
    ...
    YAHOO.util.Connect.asyncRequest('POST', request, {
        success: function(o) {
            ...
            if (r.state == '200') {
             			...
             			Dom.get('tax_number_details_match').innerHTML=r.tax_number_details_match
...
//Event.addListener("submit_change_password", "click",submit_change_password);
//Event.addListener("submit_change_password", "click",submit_change_password, true);
