...
function change_sales_sub_block(o) {
    ...
    Dom.removeClass(['plot_parts_sales',  'parts_sales_timeseries'], 'selected')
    Dom.addClass(o, 'selected')
    Dom.setStyle(['sub_block_plot_parts_sales',  'sub_block_parts_sales_timeseries'], 'display', 'none')

    Dom.setStyle('sub_block_' + o.id, 'display', '')
    YAHOO.util.Connect.asyncRequest('POST', 'ar_sessions.php?tipo=update&keys=part_categories-sales_sub_block_tipo&value=' + o.id, {});
}
...
YAHOO.util.Event.addListener(window, "load", function() {
    tables = new function() {
	    ...
	    var ColumnDefs = [ 
				    ...
				    ,{key:"reference", label:"<?php echo _('Reference')?>",width:100,<?php echo($_SESSION['state']['part_categories']['parts']['view']=='general'?'':'hidden:true,')?> sortable:true,className:"aleft",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_ASC}}
				    ...
				    ,{key:"used_in", label:"<?php echo _('Used In')?>",width:300,<?php echo($_SESSION['state']['part_categories']['parts']['view']=='general'?'':'hidden:true,')?>sortable:true,className:"aleft",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_ASC}}
				  //  ,{key:"supplied_by", label:"<?php echo _('Supplied By')?>",width:200,<?php echo($_SESSION['state']['part_categories']['parts']['view']=='general'?'':'hidden:true,')?>sortable:true,className:"aleft",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_ASC}}
				    ...
				    ,{key:"stock_value", label:"<?php echo _('Stk Value')?>", width:100,sortable:true,className:"aright",<?php echo(($_SESSION['state']['part_categories']['parts']['view']=='stock' or $_SESSION['state']['part_categories']['parts']['view']=='locations')?'':'hidden:true,')?>sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_DESC}}
				   ,{key:"stock", label:"<?php echo _('Stock')?>", width:80,sortable:true,className:"aright",<?php echo(($_SESSION['state']['part_categories']['parts']['view']=='stock' or $_SESSION['state']['part_categories']['parts']['view']=='locations' )  ?'':'hidden:true,')?>sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_DESC}}
				    ,{key:"stock_days", label:"<?php echo _('Stk Days')?>", width:100,sortable:true,className:"aright",<?php echo(($_SESSION['state']['part_categories']['parts']['view']=='stock' )?'':'hidden:true,')?>sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_DESC}}
				    ,{key:"stock_state", label:"<?php echo _('Stk State')?>", width:100,sortable:true,className:"aright",<?php echo(($_SESSION['state']['part_categories']['parts']['view']=='stock' )?'':'hidden:true,')?>sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_DESC}}
				...
				// ,{key:"avg_stock", label:"<?php echo _('AS')?>", width:70,sortable:true,className:"aright",<?php echo($_SESSION['state']['part_categories']['parts']['view']=='stock'?'':'hidden:true,')?>sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_DESC}}
				   ...
				   // ,{key:"outstock_days", label:"<?php echo _('OofS')?>", width:70,sortable:true,className:"aright",<?php echo($_SESSION['state']['part_categories']['parts']['view']=='stock'?'':'hidden:true,')?>sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_DESC}}
				    ...
				    ,{key:"margin", label:"<?php echo _('Margin')?>", width:100,sortable:true,className:"aright",<?php echo($_SESSION['state']['part_categories']['parts']['view']=='forecast'?'':'hidden:true,')?>sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_DESC}}
				   				  	,{key:"gmroi", label:"<?php echo _('GMROI')?>", width:70,sortable:true,className:"aright",<?php echo($_SESSION['state']['part_categories']['parts']['view']=='forecast'   ?'':'hidden:true,')?>sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_DESC}}
...
//alert("ar_parts.php?tipo=part_categories&sf=0&tableid=1&parent_key="+Dom.get('category_key').value)
 ...
 var tableid=2; // Change if you have more the 1 table
	...
	fields: [
	    ...
	    this.table4 = new YAHOO.widget.DataTable(tableDivEL, ColumnDefs,
							 ...
							 formatRow: myRowFormatter,
							   renderLoopSize: 50,generateRequest : myRequestBuilder
								     ...
								     ,sortedBy : {
									 key: "<?php echo$_SESSION['state']['part_categories']['sales_history']['order']?>",
									 dir: "<?php echo$_SESSION['state']['part_categories']['sales_history']['order_dir']?>"
								     }
							   ,dynamicData : true  
		...
		this.table4.filter={key:'<?php echo$_SESSION['state']['part_categories']['sales_history']['f_field']?>',value:'<?php echo$_SESSION['state']['part_categories']['sales_history']['f_value']?>'};
...
/*
    ...
    Event.addListener(ids, "click", change_part_category_elements, {
        table_id: 1,
        tipo: 'use',
        click_type: 'click'
    });
