...
header("Content-Security-Policy-Report-Only: default-src 'self'; script-src 'self' 'nonce-$nonce' https://www.google-analytics.com; style-src 'self' 'unsafe-inline'; report-uri /csp_log.php");
