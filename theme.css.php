...
if($row=mysql_fetch_assoc($res)){
    print $row['Theme CSS Buttons']; print $row['Theme CSS Header']; print $row['Theme CSS Tables'];; print $row['Theme CSS Top Navigation'];
}
...
$res=mysql_query($sql);
if($row=mysql_fetch_assoc($res)){
    print $row['Header CSS']; print $row['Background CSS']; print $row['Footer CSS'];
}
