...
function update_stockhistory($product_id,$qty,$op_tipo,$op_id,$op_date,$value,$update_line=true,$umbral=true){
  ...
  $sql="insert into stock_history (stock,op_value,product_id,available,value,op_qty, op_date,op_tipo,op_id) values ($new_s,$value,$product_id,$new_a,$new_v,$qty,'$op_date',$op_tipo,$op_id)";
  //print "$new_s $qty  ----\n ";
  //  print "$sql\n";
