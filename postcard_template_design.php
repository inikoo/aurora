...
<tr>
<td style="background-color:#FFFFFF;border-top:0px solid #FFFFFF;border-bottom:0px solid #333333;"><center><a href=""><IMG id=editableImg1 SRC="img/postcard_logo.gif" BORDER="0" title=""  alt="" align="center"></a><h1><?php echo $_SESSION['header']; ?></h1></center></td>
</tr>
</table>
<table width="550" cellpadding="20" cellspacing="0" bgcolor="#FFFFFF">
<tr>
<td bgcolor="#FFFFFF" valign="top" style="font-size:12px;color:#000000;line-height:150%;font-family:trebuchet ms;">
<p class="basic_template_img"><img height="220" width="500" src="<?php echo $_SESSION['postcard_image']; ?>"></p>
<p>
