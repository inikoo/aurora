...
function change_pic(pos){
	...
	function plot_weeksales_getDataTipText( item, index, series )
	{
		var toolTipText = series.displayName + " for " + item.fweek;
...
YAHOO.util.Event.addListener(window, "load", function() {
	YAHOO.product.XHR_JSON = new function() {
		...
		var ProductsColumnDefs = [
					  ...
					  ,{key:"customer", label:"<?=_('Customer')?>", width:200,sortable:true,className:"aleft",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_ASC}}
					  ...
					  ,{key:"undispached", label:"<?=_('Undispached')?>", width:80, sortable:true,className:"aright",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_DESC}}
		...
		this.ProductsDataSource.responseSchema = {
		    ...
		    fields: [
			 "id","public_id","customer","tipo","date_index","date","dispached","undispached"
			     ]};
...
// 	     }
 ...
 var handleSuccess_details = function(o) {
	...
	YAHOO.widget.Chart.SWFURL = "yui/2.5.1/build//charts/assets/charts.swf";




	YAHOO.product.show_plot_monthsales	=function(){

	    var plot_monthsalesData = new YAHOO.util.DataSource( "ar_assets.php?tipo=plot_monthsales"  );
	    ...
	    var seriesDef = [{ displayName: "<?=_('Sales')?>", yField: "asales" }];
	    ...
	    var  plot_monthsales = new YAHOO.widget.LineChart( "plot3",plot_monthsalesData ,{
		    series: seriesDef,
		    xField: "date",
		    wmode: "opaque",
		    yAxis: plot_monthsales_currencyAxis,
		    //dataTipFunction: "plot_monthsales_getDataTipText",
	...
	YAHOO.product.show_plot_weeksales	=function(){

	    var plot_weeksalesData = new YAHOO.util.DataSource( "ar_assets.php?tipo=plot_weeksales"  );
	    
	    
	    plot_weeksalesData.connMethodPost = true;
	    plot_weeksalesData.responseType = YAHOO.util.DataSource.TYPE_JSON;
	    plot_weeksalesData.responseSchema =
	    {
		resultsList: "resultset.data",
		fields: ["weekyear","asales","fweek","date"]
	    };
	    
	    var seriesDef = [{ displayName: "Sales", yField: "asales" }];
	    
	    var plot_weeksales_currencyAxis = new YAHOO.widget.NumericAxis();
	    plot_weeksales_currencyAxis.labelFunction = "formatCurrencyAxisLabel";
	    
	    

	    var  plot_weeksales = new YAHOO.widget.LineChart( "plot0",plot_weeksalesData ,{
		    wmode: "opaque",
		    series: seriesDef,
		    xField: "date",
		    //    xAxis: plot_weeksales_dateAxis,

		    yAxis: plot_weeksales_currencyAxis,
		    dataTipFunction: "plot_weeksales_getDataTipText",
		    expressInstall: "assets/expressinstall.swf"
	...
	YAHOO.product.show_plot_weeksalesperorder	=function(){

	    var plot_weeksalesperorderData = new YAHOO.util.DataSource( "ar_assets.php?tipo=plot_weeksalesperorder"  );
	    
	    
	    plot_weeksalesperorderData.connMethodPost = true;
	    plot_weeksalesperorderData.responseType = YAHOO.util.DataSource.TYPE_JSON;
	    plot_weeksalesperorderData.responseSchema =
	    {
		resultsList: "resultset.data",
		fields: ["weekyear","asalesperorder","fweek"]
	    };
	    
	    var seriesDef = [{ displayName: "Sales", yField: "asalesperorder" }];
	    
	    var plot_weeksalesperorder_currencyAxis = new YAHOO.widget.NumericAxis();
	    plot_weeksalesperorder_currencyAxis.labelFunction = "formatCurrencyAxisLabel";
	    ...
	    var  plot_weeksalesperorder = new YAHOO.widget.LineChart( "plot2",plot_weeksalesperorderData ,{
		    series: seriesDef,
		    xField: "weekyear",
		     wmode: "opaque",
		    yAxis: plot_weeksalesperorder_currencyAxis,
		    dataTipFunction: "plot_weeksalesperorder_getDataTipText",
		    expressInstall: "assets/expressinstall.swf",
		    dataTipFunction:getDataTipTex
		});
	...
	YAHOO.product.show_plot_weekorders=function(){
	 


	    var plot_weekordersData = new YAHOO.util.DataSource( "ar_assets.php?tipo=plot_weekorders" );
	    
	    
	    plot_weekordersData.connMethodPost = true;
	    plot_weekordersData.responseType = YAHOO.util.DataSource.TYPE_JSON;
	    plot_weekordersData.responseSchema =
	    {
		resultsList: "resultset.data",
		fields: ["weekyear","aorders","fweek","acustomers"]
	    };
	    
	    var xseriesDef = [{ displayName: "<?=_('Orders')?>", yField: "aorders" },{ displayName: "<?=_('Customers')?>", yField: "acustomers" },];
	    
	    var plot_weekorders_currencyAxis = new YAHOO.widget.NumericAxis();
	    plot_weekorders_currencyAxis.labelFunction = "formatCurrencyAxisLabel";
	    
	    
	    var  plot_weekorders = new YAHOO.widget.LineChart( "plot1",plot_weekordersData ,{
		    series: xseriesDef,
		    xField: "weekyear",
		     wmode: "opaque",
		    //	    yAxis: plot_weekorders_currencyAxis,
		    //  dataTipFunction: "plot_weekorders_getDataTipText",
		    expressInstall: "assets/expressinstall.swf"
		});
	...
	YAHOO.product.changeplot = function(e,new_plot) {
