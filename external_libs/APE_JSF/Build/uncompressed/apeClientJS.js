 ...
 */
/*
APE.Config.baseUrl = 'http://local.ape-project.org/kaktus/external_libs/APE_JSF'; //APE JSF 
APE.Config.domain = 'ape-project.org/kaktus/external_libs'; 
APE.Config.server = 'ape.local.ape-project.org:7050'; //APE server URL
*/
APE.Config.baseUrl = 'http://ape.hola/kaktus/external_libs/APE_JSF'; //APE JSF 
APE.Config.domain = 'ape.hola/kaktus/external_libs'; 
APE.Config.server = 'ape.hola:7050'; //APE server URL
