...
class Barcode128 {
    static private $encoding
        = array(
            ...
            '11011001100',
            //  0	Space	Space	00	0032 or 0212	Space or O	11011001100
            '11001101100',
            ...
            '10110010000',
            //  69	eno	e	69	0101	e	10110010000
            '10110000100',
            ...
            '11000010100',
            //  78	s0	n	78	0110	n	11000010100
            '10001111010',
            //  79	s1	o	79	0111	o	10001111010
            '10100111100',
            ...
            '10111101000',
            //  95	us	del	95	0200	E	10111101000
            '10111100010',
            //  96	Fnc 3	Fnc 3	96	0201	E	10111100010
            '11110101000',
            //  97	Fnc 2	Fnc2	97	0202	E	11110101000
            '11110100010',
            //  98	Shift	Shift	98	0203	E	11110100010
            '10111011110',
            //  99	Code C	Code C	99	0204	I	10111011110
            '10111101110',
            //  100	Code B	Fnc 4	Code B	0205	I	10111101110
            '11101011110',
            //  101	Fnc 4	Code A	Code A	0206	I	11101011110
            '11110101110',
            //  102	Fnc 1	Fnc 1	Fnc 1	0207	I	11110101110
            '11010000100',
            //  103	Start A	Start A	Start A	0208	D	11010000100
            '11010010000',
            //  104	Start B	Start B	Start B	0209	N	11010010000
            '11010011100',
            //  105	Start C	Start C	Start C	0210	O	11010011100
            '11000111010'
            //  106	Stop	Stop	Stop	0211	O	1100011101011
        );
    ...
    static public function getDigit($code) {
        ...
        while ($i < $len) {
            if (!$tableCActivated) {
                ...
                if (($i == $len - 1) || (preg_match('`[^0-9]`', $code[$i])) || (preg_match('`[^0-9]`', $code[$i + 1]))) { //todo : verifier le JS : len - 1!!! XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
