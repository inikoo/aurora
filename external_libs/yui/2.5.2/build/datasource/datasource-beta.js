...
YAHOO.util.DataSource.prototype.handleResponse = function(oRequest, oRawResponse, oCallback, oCaller, tId) {
    ...
    if(oParsedResponse && !oParsedResponse.error) {
        ...
        oParsedResponse = this.doBeforeCallback(oRequest, oFullResponse, oParsedResponse,oCallback.scope);
 ...
 */
YAHOO.util.DataSource.prototype.doBeforeCallback = function(oRequest, oFullResponse, oParsedResponse,scope) {
