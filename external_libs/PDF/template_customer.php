...
<table width="100%" border="0"  bgcolor="#FFFFFF" style="font:'Lucida Sans Unicode', 'Lucida Grande', sans-serif; font-size:25px;">
	 <tr>
    <td colspan="3" align="center" style="font-size:48px;font-weight:bold;">CUSTOMER ADDRESS<hr></td>
  </tr>

  <tr>
    <td align="left" style="border: 1px solid #000;margin:10px;">
