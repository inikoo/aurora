...
$urgent_message->smtp_exclude_address
...
$urgent_message->timeout
                                      = 15;               /* Adjust the SMTP connection timeout according to what you think it is reasonable to wait before it falls back to normal mail function delivery */
/*
