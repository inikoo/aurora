<?php
  ...
  if ($type=="bar" or $type=="baraccumulate") {
	require_once(INCLUDE_PATH."/BarPlot.class.php");
	...
	require_once(INCLUDE_PATH."/Pie.class.php");
	...
	require_once(INCLUDE_PATH."/LinePlot.class.php");
	...
	require_once(INCLUDE_PATH."/ScatterPlot.class.php");
	$graph = new Graph($width,$height);
	$graph->title->set($title);
	$graph->title->setFont(new Tuffy(11));
