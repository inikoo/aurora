...
//alert("ar_parts.php?tipo=parts&tableid=0&where=&parent=category&sf=0&parent_key="+Dom.get('category_key').value)
	    ...
	    var OrdersColumnDefs = [ 
				    ...
				    {key:"name", label:"<?php echo _('Code')?>", width:90,sortable:true,className:"aleft",sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_ASC}}
	    ...
	    this.dataSource1 = new YAHOO.util.DataSource("ar_parts.php?tipo=part_categories&sf=0&tableid=1");
		...
		fields: [
			"name","subjects","sold","sales","label"
			 ]};
