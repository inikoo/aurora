...
YAHOO.util.Event.addListener(window, "load", function() {
  ...
  var ColumnDefs = [
   ...
   var ColumnDefs = [
		    ...
		    request="ar_parts.php?tipo=part_transactions&from="+Dom.get('from').value+"&to="+Dom.get('to').value+"&parent=part&parent_key="+Dom.get('part_sku').value+"&sf=0&tableid="+tableid
		   // alert(request)
