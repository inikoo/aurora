...
function  list_world_region(){
 ...
 $order_direction=(preg_match('/desc/',$order_dir)?'desc':'');
  ...
  $_order=$order;
   ...
   $adata=array();
 $sql="select distinct `World Region` from kbase.`Country Dimension` order by $order $order_direction  limit $start_from,$number_results;";
...
function list_continent_list(){
 ...
 $order_direction=(preg_match('/desc/',$order_dir)?'desc':'');
  ...
  $_order=$order;
   ...
   $adata=array();
 $sql="select distinct `Continent` from kbase.`Country Dimension` order by $order $order_direction  limit $start_from,$number_results;";
