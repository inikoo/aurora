...
YAHOO.util.Event.addListener(window, "load", function() {
	...
	//	alert("ar_assets.php?tipo=part_transactions&parent=warehouse&parent_key="+Dom.get('warehouse_id').value+"&sf=0&tableid="+tableid);
								 ...
								 , {
								     renderLoopSize: 50,generateRequest : myRequestBuilder
								       ,paginator : new YAHOO.widget.Paginator({
									      rowsPerPage    : <?php echo$_SESSION['state']['warehouse']['transactions']['nr']?>,containers : 'paginator0', 
	    ...
	    this.table0.filter={key:'<?php echo$_SESSION['state']['warehouse']['transactions']['f_field']?>',value:'<?php echo$_SESSION['state']['warehouse']['transactions']['f_value']?>'};
...
//alert("ar_assets.php?tipo=parts&parent=warehouse&parent_key="+Dom.get('warehouse_id').value+"&tableid=2&where=&sf=0")
request="ar_assets.php?tipo=parts&parent=warehouse&parent_key="+Dom.get('warehouse_id').value+"&tableid=2&where=&sf=0";
