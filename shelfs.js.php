...
YAHOO.util.Event.addListener(window, "load", function() {
    tables = new function() {
	    ...
	    //?tipo=shelfs&tid=0"
	    this.dataSource0 = new YAHOO.util.DataSource("ar_warehouse.php?tipo=shelfs&parent=none");
	   ...
	   this.table0 = new YAHOO.widget.DataTable(tableDivEL, LocationsColumnDefs,
								 ...
								 , {
								     renderLoopSize: 50,generateRequest : myRequestBuilder
								       ,paginator : new YAHOO.widget.Paginator({
									      rowsPerPage    : <?php echo$_SESSION['state']['shelfs']['table']['nr']?>,containers : 'paginator', 
								     ...
								     ,sortedBy : {
									 key: "<?php echo$_SESSION['state']['shelfs']['table']['order']?>",
									 dir: "<?php echo$_SESSION['state']['shelfs']['table']['order_dir']?>"
								     },
								     dynamicData : true
								  }
								 );
	    ...
	    this.table0.filter={key:'<?php echo$_SESSION['state']['shelfs']['table']['f_field']?>',value:'<?php echo$_SESSION['state']['shelfs']['table']['f_value']?>'};
...
YAHOO.util.Event.addListener('but_show_details', "click",show_details,'shelfs');
