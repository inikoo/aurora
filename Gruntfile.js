            ...
            ecom_desktop_in: {
              ...
              //  src: ['js_libs/autobahn.v1.js','EcomB2B/js/aurora/web_sockets.js','EcomB2B/js/libs/jquery.hoverIntent.js', 'EcomB2B/js/au_header/menu.js', 'EcomB2B/js/au_header/search.js'],
                ...
                options: {
                    ...
                    'js/order.common.js', 'js/order_collection.js', 'js/location_parts.js','js/dropshipping.js','js/attendance.js',
                    ...
                    'js/add_item_to_order.js','js/upload.js','js/islands.js','js/orders_control_panel.js','js/production.js'
