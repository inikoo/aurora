module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        terser: {
            ecom_desktop_in: {
                ...
                options: {
                    ...
                    sourceMap: true,
                }, src: [  'EcomB2B/js/au_header/search.js'],
                ...
                options: {
                    ...
                    'js/supplier.order.js', 'js/supplier.delivery.js','js/supplier.delivery.costing.js','js/locations.js',
                    'js/part_locations.edit.js', 'js/part_locations.edit_locations.js', 'js/part_locations.stock_check.js', 'js/part_locations.move_stock.js', 'js/fast_track_packing.js', 'js/sticky_notes.js', 'js/picking_and_packing.js', 'js/app.js', 'js/real_time.js', 'js/customers.js','js/suppliers.js', 'js/customer_orders.js', 'js/customer_client.js', 'js/customer_client_orders.js',
                    'js/add_item_to_order.js','js/upload.js','js/islands.js','js/orders_control_panel.js','js/production.js','js/inventory.js','js/edit_categories.js','js/fulfilment.js',
                    'js/inventory.parts_no_sko_barcode.js','js/product.js'
        ...
        cssmin: {
            ...
            ecom_css: {
                files: {
                    'EcomB2B/assets/desktop.min.css': [
                        'css/all.css', 'EcomB2B/css/staging/style.theme_1.EcomB2B.desktop.css'],
                    ...
                    'EcomB2B/assets/mobile.min.css': [
                        'css/all.css', 'EcomB2B/css/mobile_style.css', 'EcomB2B/css/mobile_skin.css', 'EcomB2B/css/mobile_framework.css', 'EcomB2B/css/staging/style.theme_1.EcomB2B.mobile.css'],
                    'EcomB2B/assets/tablet.min.css': [
                        'css/all.css', 'EcomB2B/css/mobile_style.css', 'EcomB2B/css/mobile_skin.css', 'EcomB2B/css/mobile_framework.css', 'EcomB2B/css/staging/style.theme_1.EcomB2B.tablet.css'],
            ...
            au_login: {
                files: {
                    'assets/login.min.css': ['css/all.css', 'css/staging/login.css']
        ...
        copy: {
            ...
            ecom_catalogue: {
                files: [{
                    expand: true, dot: true, cwd: 'EcomB2B/assets', dest: 'EcomB2B/assets/', src: ['catalogue.min.js'], rename: function (dest, src) {
                        return dest + src.replace('.min', '.' + grunt.option('au_version_major') + '.' + grunt.option('au_version_minor') + '.' + grunt.option('au_version_patch') + '.min');
                    }
                }]
            },
        ...
        replace: {
            ...
            , ecom_desktop_in: {
                ...
                src: ['EcomB2B/templates/theme_1/scripts_webpage_blocks.theme_1.EcomB2B.*tpl'], overwrite: true, replacements: [{
                    from: /catalogue.\.*min.js"/g, to: 'catalogue.' + grunt.option('au_version_major') + '.' + grunt.option('au_version_minor') + '.' + grunt.option('au_version_patch') + '.min.js"'
                }]
            },ecom_dropshipping_logged_in: {
                src: ['EcomB2B/templates/theme_1/_head.theme_1.EcomB2B.tpl', 'EcomB2B/templates/theme_1/scripts_webpage_blocks.theme_1.EcomB2B.tpl'], overwrite: true, replacements: [{
    ...
    grunt.registerTask('ecom_desktop_client_basket', ['terser:ecom_desktop_client_basket','copy:ecom_desktop_client_basket', 'replace:ecom_desktop_client_basket'
    ...
    grunt.registerTask('pweb', ['copy:fa_webfonts', 'sass:ecom_css', 'cssmin:ecom_css',
            'terser:ecom_desktop_in','terser:ecom_desktop_out','terser:ecom_desktop_forms','terser:ecom_mobile_forms','terser:ecom_mobile','terser:ecom_mobile_custom','terser:ecom_datatables','terser:ecom_catalogue',
